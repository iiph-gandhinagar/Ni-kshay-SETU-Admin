...
@section('title', trans('admin.t-module-master.actions.index'))

@section('body')

    <t-module-master-listing :data="{{ $data->toJson() }}" :url="'{{ url('admin/t-module-masters') }}'" inline-template>

        <div class="row">
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> {{ trans('admin.t-module-master.actions.index') }}
                        <a class="btn btn-primary btn-spinner btn-sm pull-right m-b-0"
                            href="{{ url('admin/t-module-masters/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp;
                            {{ trans('admin.t-module-master.actions.create') }}</a>
                    </div>
                    <div class="card-body" v-cloak>
                        <div class="card-block">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' data-title="id" :column="'id'">
                                            {{ trans('admin.t-module-master.columns.id') }}</th>
                                        <th is='sortable' data-title="name" :column="'name'">
                                            {{ trans('admin.t-module-master.columns.name') }}</th>
                                        ...
                                        <td class="bg-bulk-info d-table-cell text-center" colspan="4">
                                            <span
                                                ...
                                                @{{ clickedBulkItemsCount }}. <a href="#" class="text-primary"
                                                    @click="onBulkItemsClickedAll('/admin/t-module-masters')"
                                            ...
                                            <span class="pull-right pr-2">
                                                <button class="btn btn-sm btn-danger pr-3 pl-3"
                                                    @click="bulkDelete('/admin/t-module-masters/bulk-destroy')">{{ trans('brackets/admin-ui::admin.btn.delete') }}</button>
                                            </span>
                            ...
                            <div class="no-items-found" v-if="!collection.length > 0">
                                ...
                                <a class="btn btn-primary btn-spinner" href="{{ url('admin/t-module-masters/create') }}"
