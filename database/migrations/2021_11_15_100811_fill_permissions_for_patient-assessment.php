...
class FillPermissionsForPatientAssessment extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPatientAssessment constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.patient-assessment',
            'admin.patient-assessment.index',
            'admin.patient-assessment.create',
            'admin.patient-assessment.show',
            'admin.patient-assessment.edit',
            'admin.patient-assessment.delete',
            'admin.patient-assessment.bulk-delete',
        ]);
