...
@section('title', trans('admin.t-sub-module-master.actions.index'))

@section('body')

    <t-sub-module-master-listing :data="{{ $data->toJson() }}" :url="'{{ url('admin/t-sub-module-masters') }}'"
        inline-template>
            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> {{ trans('admin.t-sub-module-master.actions.index') }}
                        <a class="btn btn-primary btn-spinner btn-sm pull-right m-b-0"
                            href="{{ url('admin/t-sub-module-masters/create') }}" role="button"><i
                                class="fa fa-plus"></i>&nbsp; {{ trans('admin.t-sub-module-master.actions.create') }}</a>
                    </div>
                        ...
                        <div class="card-block">
                            ...
                            <table class="table table-hover ">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' data-title="id" :column="'id'">
                                            {{ trans('admin.t-sub-module-master.columns.id') }}</th>
                                        <th is='sortable' data-title="name" :column="'name'">
                                            {{ trans('admin.t-sub-module-master.columns.name') }}</th>
                                        <th is='sortable' data-title="module_id" :column="'module_id'">
                                            {{ trans('admin.t-sub-module-master.columns.module_id') }}</th>
                                        <th is='sortable' data-title="existing_module_ref" :column="'existing_module_ref'">
                                            {{ trans('admin.t-sub-module-master.columns.existing_module_ref') }}</th>
                                        ...
                                        <td class="bg-bulk-info d-table-cell text-center" colspan="6">
                                            <span
                                                ...
                                                @{{ clickedBulkItemsCount }}. <a href="#" class="text-primary"
                                                    @click="onBulkItemsClickedAll('/admin/t-sub-module-masters')"
                                            ...
                                            <span class="pull-right pr-2">
                                                <button class="btn btn-sm btn-danger pr-3 pl-3"
                                                    @click="bulkDelete('/admin/t-sub-module-masters/bulk-destroy')">{{ trans('brackets/admin-ui::admin.btn.delete') }}</button>
                                            </span>
                                ...
                                <tbody>
                                    <tr v-for="(item, index) in collection" :key="item.id"
                                        ...
                                        <td data-title="module_id">@{{ item.modules.name }}</td>
                                        <td data-title="existing_module_ref">@{{ item.existing_module_ref }}</td>
                            ...
                            <div class="no-items-found" v-if="!collection.length > 0">
                                ...
                                <a class="btn btn-primary btn-spinner"
                                    href="{{ url('admin/t-sub-module-masters/create') }}" role="button"><i
                                        class="fa fa-plus"></i>&nbsp;
                                    {{ trans('admin.t-sub-module-master.actions.create') }}</a>
                            </div>
                        </div>
                    </div>
                </div>
