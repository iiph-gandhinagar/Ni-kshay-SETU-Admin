...
class FillPermissionsForChatQuestion extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForChatQuestion constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.chat-question',
            'admin.chat-question.index',
            'admin.chat-question.create',
            'admin.chat-question.show',
            'admin.chat-question.edit',
            'admin.chat-question.delete',
            'admin.chat-question.bulk-delete',
        ]);
