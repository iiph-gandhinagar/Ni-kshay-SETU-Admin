...
class FillPermissionsForDynamicAlgoMaster extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForDynamicAlgoMaster constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.dynamic-algo-master',
            'admin.dynamic-algo-master.index',
            'admin.dynamic-algo-master.create',
            'admin.dynamic-algo-master.show',
            'admin.dynamic-algo-master.edit',
            'admin.dynamic-algo-master.delete',
            'admin.dynamic-algo-master.bulk-delete',
        ]);
