...
class FillPermissionsForLbSubscriberRanking extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForLbSubscriberRanking constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.lb-subscriber-ranking',
            'admin.lb-subscriber-ranking.index',
            'admin.lb-subscriber-ranking.create',
            'admin.lb-subscriber-ranking.show',
            'admin.lb-subscriber-ranking.edit',
            'admin.lb-subscriber-ranking.delete',
            'admin.lb-subscriber-ranking.bulk-delete',
        ]);
