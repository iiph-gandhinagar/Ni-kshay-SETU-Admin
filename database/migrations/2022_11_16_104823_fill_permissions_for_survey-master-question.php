...
class FillPermissionsForSurveyMasterQuestion extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForSurveyMasterQuestion constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.survey-master-question',
            'admin.survey-master-question.index',
            'admin.survey-master-question.create',
            'admin.survey-master-question.show',
            'admin.survey-master-question.edit',
            'admin.survey-master-question.delete',
            'admin.survey-master-question.bulk-delete',
        ]);
