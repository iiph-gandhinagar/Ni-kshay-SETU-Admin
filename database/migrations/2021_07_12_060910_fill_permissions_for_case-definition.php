...
class FillPermissionsForCaseDefinition extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCaseDefinition constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.case-definition',
            'admin.case-definition.index',
            'admin.case-definition.create',
            'admin.case-definition.show',
            'admin.case-definition.edit',
            'admin.case-definition.delete',
            'admin.case-definition.bulk-delete',
        ]);
