...
class FillPermissionsForUserFeedbackHistory extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForUserFeedbackHistory constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.user-feedback-history',
            'admin.user-feedback-history.index',
            'admin.user-feedback-history.create',
            'admin.user-feedback-history.show',
            'admin.user-feedback-history.edit',
            'admin.user-feedback-history.delete',
            'admin.user-feedback-history.bulk-delete',
        ]);
