...
@section('title', trans('admin.dynamic-algo-master.actions.index'))

@section('body')

    <dynamic-algo-master-listing :data="{{ $data->toJson() }}" :url="'{{ url('admin/dynamic-algo-masters') }}'"
        inline-template>
            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> {{ trans('admin.dynamic-algo-master.actions.index') }}
                        <a class="btn btn-primary btn-spinner btn-sm pull-right m-b-0"
                            href="{{ url('admin/dynamic-algo-masters/create') }}" role="button"><i
                                class="fa fa-plus"></i>&nbsp; {{ trans('admin.dynamic-algo-master.actions.create') }}</a>
                    </div>
                        ...
                        <div class="card-block">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' data-title="id" :column="'id'">
                                            {{ trans('admin.dynamic-algo-master.columns.id') }}</th>
                                        <th is='sortable' data-title="name" :column="'name'">
                                            {{ trans('admin.dynamic-algo-master.columns.name') }}</th>
                                        <th is='sortable' data-title="section" :column="'section'">
                                            {{ trans('admin.dynamic-algo-master.columns.section') }}</th>
                                        <th is='sortable' data-title="active" :column="'active'">
                                            {{ trans('admin.dynamic-algo-master.columns.active') }}</th>
                                        ...
                                        <td class="bg-bulk-info d-table-cell text-center" colspan="6">
                                            <span
                                                ...
                                                @{{ clickedBulkItemsCount }}. <a href="#" class="text-primary"
                                                    @click="onBulkItemsClickedAll('/admin/dynamic-algo-masters')"
                                            ...
                                            <span class="pull-right pr-2">
                                                <button class="btn btn-sm btn-danger pr-3 pl-3"
                                                    @click="bulkDelete('/admin/dynamic-algo-masters/bulk-destroy')">{{ trans('brackets/admin-ui::admin.btn.delete') }}</button>
                                            </span>
                            ...
                            <div class="no-items-found" v-if="!collection.length > 0">
                                ...
                                <a class="btn btn-primary btn-spinner"
                                    href="{{ url('admin/dynamic-algo-masters/create') }}" role="button"><i
                                        class="fa fa-plus"></i>&nbsp;
                                    {{ trans('admin.dynamic-algo-master.actions.create') }}</a>
                            </div>
                        </div>
                    </div>
                </div>
