...
class FillPermissionsForStaticRelease extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForStaticRelease constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.static-release',
            'admin.static-release.index',
            'admin.static-release.create',
            'admin.static-release.show',
            'admin.static-release.edit',
            'admin.static-release.delete',
            'admin.static-release.bulk-delete',
        ]);
