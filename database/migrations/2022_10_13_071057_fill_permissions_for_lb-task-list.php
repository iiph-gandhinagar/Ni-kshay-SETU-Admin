...
class FillPermissionsForLbTaskList extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForLbTaskList constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.lb-task-list.create',
            'admin.lb-task-list.show',
            'admin.lb-task-list.edit',
            'admin.lb-task-list.delete',
            'admin.lb-task-list.bulk-delete',
        ]);
