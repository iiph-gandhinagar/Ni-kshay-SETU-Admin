...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('node_type'), 'has-success': fields.node_type && fields.node_type.valid }">
    <label for="node_type" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.case-definition.columns.node_type') }}</label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
            <select class="form-control" v-model="form.node_type" v-validate="'required'" @input="validate($event)" :class="{'form-control-danger': errors.has('node_type'), 'form-control-success': fields.node_type && fields.node_type.valid}" id="node_type" name="node_type" placeholder="{{ trans('admin.case-definition.columns.node_type') }}">
...
<div class="form-check row" :class="{'has-danger': errors.has('is_expandable'), 'has-success': fields.is_expandable && fields.is_expandable.valid }">
    <div class="ml-md-auto" :class="isFormLocalized ? 'col-md-8' : 'col-md-10'">
        ...
        <label class="form-check-label" for="is_expandable">
            {{ trans('admin.case-definition.columns.is_expandable') }}
        </label>
...
<div class="form-check row" :class="{'has-danger': errors.has('has_options'), 'has-success': fields.has_options && fields.has_options.valid }">
    <div class="ml-md-auto" :class="isFormLocalized ? 'col-md-8' : 'col-md-10'">
        ...
        <label class="form-check-label" for="has_options">
            {{ trans('admin.case-definition.columns.has_options') }}
        </label>
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('parent_id'), 'has-success': fields.parent_id && fields.parent_id.valid }">
    <label for="parent_id" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.case-definition.columns.parent_id') }}</label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.parent_id" v-validate="'required'" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('parent_id'), 'form-control-success': fields.parent_id && fields.parent_id.valid}" id="parent_id" name="parent_id" placeholder="{{ trans('admin.case-definition.columns.parent_id') }}">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('index'), 'has-success': fields.index && fields.index.valid }">
    <label for="index" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.case-definition.columns.index') }}</label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.index" v-validate="'required|integer'" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('index'), 'form-control-success': fields.index && fields.index.valid}" id="index" name="index" placeholder="{{ trans('admin.case-definition.columns.index') }}">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('redirect_algo_type'), 'has-success': fields.redirect_algo_type && fields.redirect_algo_type.valid }">
    <label for="redirect_algo_type" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.case-definition.columns.redirect_algo_type') }}</label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
            <select class="form-control" onchange="getMasterNodes()" v-model="form.redirect_algo_type" @input="validate($event)" :class="{'form-control-danger': errors.has('redirect_algo_type'), 'form-control-success': fields.redirect_algo_type && fields.redirect_algo_type.valid}" id="redirect_algo_type" name="redirect_algo_type" placeholder="{{ trans('admin.case-definition.columns.redirect_algo_type') }}">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('redirect_node_id'), 'has-success': fields.redirect_node_id && fields.redirect_node_id.valid }">
    <label for="redirect_node_id" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.case-definition.columns.redirect_node_id') }}</label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
            <select class="form-control" v-model="form.redirect_node_id" @input="validate($event)" :class="{'form-control-danger': errors.has('redirect_node_id'), 'form-control-success': fields.redirect_node_id && fields.redirect_node_id.valid}" id="redirect_node_id" name="redirect_node_id" placeholder="{{ trans('admin.case-definition.columns.redirect_node_id') }}">
...
<div class="form-group row align-items-center" >
    <label for="node_icon" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.case-definition.columns.node_icon') }}</label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <div v-if="errors.has('')" class="form-control-feedback form-text" v-cloak>@{{ errors.first('node_icon') }}</div>
        @if(isset($caseDefinition))
            @include('brackets/admin-ui::admin.includes.avatar-uploader', [
                'mediaCollection' => app(App\Models\CaseDefinition::class)->getMediaCollection('node_icon'),
                'media' => $caseDefinition->getThumbs200ForCollection('node_icon'),
                'Label' => "node_icon"
            ])
        @else
        @include('brackets/admin-ui::admin.includes.avatar-uploader', [
    ...
    @foreach($locales as $locale)
        <div class="col-md" v-show="shouldShowLangGroup('{{ $locale }}')" v-cloak>
            <div class="form-group row align-items-center" :class="{'has-danger': errors.has('title{{ $locale }}'), 'has-success': fields.title{{ $locale }} && fields.title{{ $locale }}.valid }">
                <label for="title{{ $locale }}" class="col-md-2 col-form-label text-md-right">{{ trans('admin.case-definition.columns.title') }}</label>
                <div class="col-md-9" :class="{'col-xl-8': !isFormLocalized }">
                    <input type="text" v-model="form.title.{{ $locale }}" v-validate="''" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('title{{ $locale }}'), 'form-control-success': fields.title{{ $locale }} && fields.title{{ $locale }}.valid }" id="title{{ $locale }}" name="title{{ $locale }}" placeholder="{{ trans('admin.case-definition.columns.title') }}">
    ...
    @foreach($locales as $locale)
        <div class="col-md" v-show="shouldShowLangGroup('{{ $locale }}')" v-cloak>
            <div class="form-group row align-items-center" :class="{'has-danger': errors.has('description{{ $locale }}'), 'has-success': fields.description{{ $locale }} && fields.description{{ $locale }}.valid }">
                <label for="description{{ $locale }}" class="col-md-2 col-form-label text-md-right">{{ trans('admin.case-definition.columns.description') }}</label>
                <div class="col-md-9" :class="{'col-xl-8': !isFormLocalized }">
                    {{-- <input type="text" v-model="form.description.{{ $locale }}" v-validate="'required'" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('description{{ $locale }}'), 'form-control-success': fields.description{{ $locale }} && fields.description{{ $locale }}.valid }" id="description{{ $locale }}" name="description{{ $locale }}" placeholder="{{ trans('admin.case-definition.columns.description') }}"> --}}
    ...
    @foreach($locales as $locale)
        <div class="col-md" v-show="shouldShowLangGroup('{{ $locale }}')" v-cloak>
            <div class="form-group row align-items-center" :class="{'has-danger': errors.has('header{{ $locale }}'), 'has-success': fields.header{{ $locale }} && fields.header{{ $locale }}.valid }">
                <label for="header{{ $locale }}" class="col-md-2 col-form-label text-md-right">{{ trans('admin.case-definition.columns.header') }}</label>
                <div class="col-md-9" :class="{'col-xl-8': !isFormLocalized }">
                    <input type="text" v-model="form.header.{{ $locale }}" v-validate="''" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('header{{ $locale }}'), 'form-control-success': fields.header{{ $locale }} && fields.header{{ $locale }}.valid }" id="header{{ $locale }}" name="header{{ $locale }}" placeholder="{{ trans('admin.case-definition.columns.header') }}">
    ...
    @foreach($locales as $locale)
        <div class="col-md" v-show="shouldShowLangGroup('{{ $locale }}')" v-cloak>
            <div class="form-group row align-items-center" :class="{'has-danger': errors.has('sub_header{{ $locale }}'), 'has-success': fields.sub_header{{ $locale }} && fields.sub_header{{ $locale }}.valid }">
                <label for="sub_header{{ $locale }}" class="col-md-2 col-form-label text-md-right">{{ trans('admin.case-definition.columns.sub_header') }}</label>
                <div class="col-md-9" :class="{'col-xl-8': !isFormLocalized }">
                    <input type="text" v-model="form.sub_header.{{ $locale }}" v-validate="''" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('sub_header{{ $locale }}'), 'form-control-success': fields.sub_header{{ $locale }} && fields.sub_header{{ $locale }}.valid }" id="sub_header{{ $locale }}" name="sub_header{{ $locale }}" placeholder="{{ trans('admin.case-definition.columns.sub_header') }}">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('time_spent'), 'has-success': fields.time_spent && fields.time_spent.valid }">
    <label for="time_spent" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.case-definition.columns.time_spent') }}</label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.time_spent" v-validate="''" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('time_spent'), 'form-control-success': fields.time_spent && fields.time_spent.valid}" id="time_spent" name="time_spent" placeholder="{{ trans('admin.case-definition.columns.time_spent') }}">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('master_node_id'), 'has-success': fields.master_node_id && fields.master_node_id.valid }">
    <label for="master_node_id" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.case-definition.columns.master_node_id') }}</label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.master_node_id" v-validate="'required'" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('master_node_id'), 'form-control-success': fields.master_node_id && fields.master_node_id.valid}" id="master_node_id" name="master_node_id" placeholder="{{ trans('admin.case-definition.columns.master_node_id') }}">
...
<div class="form-check row" :class="{'has-danger': errors.has('activated'), 'has-success': fields.activated && fields.activated.valid }">
    <div class="ml-md-auto" :class="isFormLocalized ? 'col-md-8' : 'col-md-10'">
        ...
        <label class="form-check-label" for="activated">
            {{ trans('admin.case-definition.columns.activated') }}
        </label>
