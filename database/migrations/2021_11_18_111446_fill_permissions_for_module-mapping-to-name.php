...
class FillPermissionsForModuleMappingToName extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForModuleMappingToName constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.module-mapping-to-name',
            'admin.module-mapping-to-name.index',
            'admin.module-mapping-to-name.create',
            'admin.module-mapping-to-name.show',
            'admin.module-mapping-to-name.edit',
            'admin.module-mapping-to-name.delete',
            'admin.module-mapping-to-name.bulk-delete',
        ]);
