...
class FillPermissionsForAssessmentEnrollment extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAssessmentEnrollment constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.assessment-enrollment.index',
            'admin.assessment-enrollment.create',
            'admin.assessment-enrollment.show',
            'admin.assessment-enrollment.edit',
            'admin.assessment-enrollment.delete',
            'admin.assessment-enrollment.bulk-delete',
        ]);
