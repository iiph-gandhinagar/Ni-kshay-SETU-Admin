...
class FillPermissionsForHealthFacility extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForHealthFacility constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.health-facility',
            'admin.health-facility.index',
            'admin.health-facility.create',
            'admin.health-facility.show',
            'admin.health-facility.edit',
            'admin.health-facility.delete',
            'admin.health-facility.bulk-delete',
        ]);
