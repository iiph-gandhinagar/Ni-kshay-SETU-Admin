...
class FillPermissionsForStaticAppConfig extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForStaticAppConfig constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.static-app-config',
            'admin.static-app-config.index',
            'admin.static-app-config.create',
            'admin.static-app-config.show',
            'admin.static-app-config.edit',
            'admin.static-app-config.delete',
            'admin.static-app-config.bulk-delete',
        ]);
