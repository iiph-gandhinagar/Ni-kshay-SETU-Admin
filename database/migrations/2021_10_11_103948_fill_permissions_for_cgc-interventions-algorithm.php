...
class FillPermissionsForCgcInterventionsAlgorithm extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCgcInterventionsAlgorithm constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.cgc-interventions-algorithm',
            'admin.cgc-interventions-algorithm.index',
            'admin.cgc-interventions-algorithm.create',
            'admin.cgc-interventions-algorithm.show',
            'admin.cgc-interventions-algorithm.edit',
            'admin.cgc-interventions-algorithm.delete',
            'admin.cgc-interventions-algorithm.bulk-delete',
        ]);
