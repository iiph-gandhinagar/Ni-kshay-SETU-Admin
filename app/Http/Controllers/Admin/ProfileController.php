...
class ProfileController extends Controller
{
    ...
    public function editProfile(Request $request)
    {
        ...
        if(isset($this->adminUser['state']) && $this->adminUser['state'] != ""){
            $this->adminUser['state'] = explode(',',$this->adminUser['state']);
            $this->adminUser['state'] = State::whereIn('id',$this->adminUser['state'])->get(['id','title']);
        }
