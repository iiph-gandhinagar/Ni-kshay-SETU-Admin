...
class UpdateCgcInterventionsAlgorithm extends TranslatableFormRequest
{
    /**
    ...
    {
        return Gate::allows('admin.cgc-interventions-algorithm.edit', $this->cgcInterventionsAlgorithm);
    }
