...
class FillPermissionsForSubscriberActivity extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForSubscriberActivity constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.subscriber-activity.create',
            'admin.subscriber-activity.show',
            'admin.subscriber-activity.edit',
            'admin.subscriber-activity.delete',
            'admin.subscriber-activity.bulk-delete',
        ]);
