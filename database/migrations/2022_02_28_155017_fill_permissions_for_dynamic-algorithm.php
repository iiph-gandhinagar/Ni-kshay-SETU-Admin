...
class FillPermissionsForDynamicAlgorithm extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForDynamicAlgorithm constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.dynamic-algorithm.index',
            'admin.dynamic-algorithm.create',
            'admin.dynamic-algorithm.show',
            'admin.dynamic-algorithm.edit',
            'admin.dynamic-algorithm.delete',
            'admin.dynamic-algorithm.bulk-delete',
        ]);
