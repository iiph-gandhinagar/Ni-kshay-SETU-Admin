...
class FillPermissionsForMessageNotification extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForMessageNotification constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.message-notification.create',
            'admin.message-notification.show',
            'admin.message-notification.edit',
            'admin.message-notification.delete',
            'admin.message-notification.bulk-delete',
        ]);
