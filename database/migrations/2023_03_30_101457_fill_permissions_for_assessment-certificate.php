...
class FillPermissionsForAssessmentCertificate extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAssessmentCertificate constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.assessment-certificate',
            'admin.assessment-certificate.index',
            'admin.assessment-certificate.create',
            'admin.assessment-certificate.show',
            'admin.assessment-certificate.edit',
            'admin.assessment-certificate.delete',
            'admin.assessment-certificate.bulk-delete',
        ]);
