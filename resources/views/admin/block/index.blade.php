...
@section('body')
    ...
    <block-listing :data="{{ $data->toJson() }}" :url="'{{ url('admin/blocks') }}'" :session_search="'{{ $search }}'"
        inline-template>
            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        ...
                        @can('admin.block.create')
                            <a class="btn btn-primary btn-spinner btn-sm pull-right m-b-0" href="{{ url('admin/blocks/create') }}"
                                role="button"><i class="fa fa-plus"></i>&nbsp; {{ trans('admin.block.actions.create') }}</a>
                        @endcan
                    </div>
                    <div class="card-body" v-cloak>
                        <div class="card-block">
                                        ...
                                        <td class="bg-bulk-info d-table-cell text-center" colspan="6">
                                            <span
                                                ...
                                                @{{ clickedBulkItemsCount }}. <a href="#" class="text-primary"
                                                    @click="onBulkItemsClickedAll('/admin/blocks')"
                                            ...
                                            <span class="pull-right pr-2">
                                                <button class="btn btn-sm btn-danger pr-3 pl-3"
                                                    @click="bulkDelete('/admin/blocks/bulk-destroy')">{{ trans('brackets/admin-ui::admin.btn.delete') }}</button>
                                            </span>
                            ...
                            <div class="no-items-found" v-if="!collection.length > 0">
                                ...
                                @can('admin.block.create')
                                    <a class="btn btn-primary btn-spinner" href="{{ url('admin/blocks/create') }}"
                                        role="button"><i class="fa fa-plus"></i>&nbsp;
                                        {{ trans('admin.block.actions.create') }}</a>
                                @endcan
                            </div>
                        </div>
                    </div>
