...
class FillPermissionsForTTrainingTag extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTTrainingTag constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.t-training-tag',
            'admin.t-training-tag.index',
            'admin.t-training-tag.create',
            'admin.t-training-tag.show',
            'admin.t-training-tag.edit',
            'admin.t-training-tag.delete',
            'admin.t-training-tag.bulk-delete',
        ]);
