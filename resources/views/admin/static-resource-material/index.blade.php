...
@section('title', trans('admin.static-resource-material.actions.index'))

@section('body')

    <static-resource-material-listing :data="{{ $data->toJson() }}" :url="'{{ url('admin/static-resource-materials') }}'"
            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> {{ trans('admin.static-resource-material.actions.index') }}
                        <a class="btn btn-primary btn-spinner btn-sm pull-right m-b-0"
                            href="{{ url('admin/static-resource-materials/create') }}" role="button"><i
                                class="fa fa-plus"></i>&nbsp;
                            {{ trans('admin.static-resource-material.actions.create') }}</a>
                    </div>
                            ...
                            <table class="table table-hover ">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' width="5%" data-title="id" :column="'id'">
                                            {{ trans('admin.static-resource-material.columns.id') }}</th>
                                        <th is='sortable' width="15%" data-title="title" :column="'title'">
                                            {{ trans('admin.static-resource-material.columns.title') }}</th>
                                        <th is='sortable' width="15%" data-title="type_of_materials"
                                            :column="'type_of_materials'">
                                            {{ trans('admin.static-resource-material.columns.type_of_materials') }}</th>
                                        <th is='sortable' width="15%" data-title="order_index" :column="'order_index'">
                                            {{ trans('admin.static-resource-material.columns.order_index') }}</th>
                                        <th is='sortable' width="5%" data-title="active" :column="'active'">
                                            {{ trans('admin.static-resource-material.columns.active') }}</th>
                                        <th is='sortable' width="15%" data-title="created_at" :column="'created_at'">
                                            {{ trans('admin.static-resource-material.columns.created_at') }}</th>
                                        ...
                                        <td class="bg-bulk-info d-table-cell text-center" colspan="7">
                                            <span
                                                ...
                                                @{{ clickedBulkItemsCount }}. <a href="#" class="text-primary"
                                                    @click="onBulkItemsClickedAll('/admin/static-resource-materials')"
                                            ...
                                            <span class="pull-right pr-2">
                                                <button class="btn btn-sm btn-danger pr-3 pl-3"
                                                    @click="bulkDelete('/admin/static-resource-materials/bulk-destroy')">{{ trans('brackets/admin-ui::admin.btn.delete') }}</button>
                                            </span>
                                ...
                                <tbody>
                                    <tr v-for="(item, index) in collection" :key="item.id"
                                        ...
                                        <td data-title="type_of_materials">@{{ item.type_of_materials }}</td>
    ...
    </static-resource-material-listing>
