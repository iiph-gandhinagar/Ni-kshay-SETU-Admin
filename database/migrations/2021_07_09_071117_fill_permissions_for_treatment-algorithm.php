...
class FillPermissionsForTreatmentAlgorithm extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTreatmentAlgorithm constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.treatment-algorithm',
            'admin.treatment-algorithm.index',
            'admin.treatment-algorithm.create',
            'admin.treatment-algorithm.show',
            'admin.treatment-algorithm.edit',
            'admin.treatment-algorithm.delete',
            'admin.treatment-algorithm.bulk-delete',
        ]);
