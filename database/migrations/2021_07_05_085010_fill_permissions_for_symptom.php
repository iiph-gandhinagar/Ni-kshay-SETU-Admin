...
class FillPermissionsForSymptom extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForSymptom constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.symptom',
            'admin.symptom.index',
            'admin.symptom.create',
            'admin.symptom.show',
            'admin.symptom.edit',
            'admin.symptom.delete',
            'admin.symptom.bulk-delete',
        ]);
