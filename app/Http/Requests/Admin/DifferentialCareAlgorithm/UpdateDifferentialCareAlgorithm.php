...
class UpdateDifferentialCareAlgorithm extends TranslatableFormRequest
{
    /**
    ...
    {
        return Gate::allows('admin.differential-care-algorithm.edit', $this->differentialCareAlgorithm);
    }
