...
class FillPermissionsForStaticTestimonial extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForStaticTestimonial constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.static-testimonial',
            'admin.static-testimonial.index',
            'admin.static-testimonial.create',
            'admin.static-testimonial.show',
            'admin.static-testimonial.edit',
            'admin.static-testimonial.delete',
            'admin.static-testimonial.bulk-delete',
        ]);
