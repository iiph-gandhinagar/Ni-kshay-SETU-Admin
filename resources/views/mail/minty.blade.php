							...
							<table width="280" cellpadding="0" cellspacing="0" border="0" align="left" class="devicewidth">
								...
								<tr>
									<td valign="middle" width="270" style="padding: 10px 0 10px 20px;" class="logo">
										<div class="imgpop">
											@if(array_key_exists('path', $logo) && $logo['path'] != '')
											...
											@else 
												<a href="https://igbalearning.com/" style="color: white;font-size: 25px; text-decoration:none;"><b>{{ Config::get('beautymail.logo-title', 'Admin') }}</b></a>
											@endif
										</div>
									</td>
								</tr>
