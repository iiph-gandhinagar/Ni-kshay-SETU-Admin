...
class FillPermissionsForChatQuestionHit extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForChatQuestionHit constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.chat-question-hit',
            'admin.chat-question-hit.index',
            'admin.chat-question-hit.create',
            'admin.chat-question-hit.show',
            'admin.chat-question-hit.edit',
            'admin.chat-question-hit.delete',
            'admin.chat-question-hit.bulk-delete',
        ]);
