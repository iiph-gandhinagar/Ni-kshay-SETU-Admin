...
class FillPermissionsForMasterCm extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForMasterCm constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.master-cm.create',
            'admin.master-cm.show',
            'admin.master-cm.edit',
            'admin.master-cm.delete',
            'admin.master-cm.bulk-delete',
        ]);
