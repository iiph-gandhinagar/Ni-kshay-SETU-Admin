...
class FillPermissionsForAppManagementFlag extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAppManagementFlag constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.app-management-flag',
            'admin.app-management-flag.index',
            'admin.app-management-flag.create',
            'admin.app-management-flag.show',
            'admin.app-management-flag.edit',
            'admin.app-management-flag.delete',
            'admin.app-management-flag.bulk-delete',
        ]);
