...
class FillPermissionsForFlashNews extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForFlashNews constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.flash-news',
            'admin.flash-news.index',
            'admin.flash-news.create',
            'admin.flash-news.show',
            'admin.flash-news.edit',
            'admin.flash-news.delete',
            'admin.flash-news.bulk-delete',
        ]);
