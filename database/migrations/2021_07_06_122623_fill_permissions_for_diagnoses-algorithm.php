...
class FillPermissionsForDiagnosesAlgorithm extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForDiagnosesAlgorithm constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.diagnoses-algorithm',
            'admin.diagnoses-algorithm.index',
            'admin.diagnoses-algorithm.create',
            'admin.diagnoses-algorithm.show',
            'admin.diagnoses-algorithm.edit',
            'admin.diagnoses-algorithm.delete',
            'admin.diagnoses-algorithm.bulk-delete',
        ]);
