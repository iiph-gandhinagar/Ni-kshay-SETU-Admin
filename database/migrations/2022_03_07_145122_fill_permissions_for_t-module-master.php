...
class FillPermissionsForTModuleMaster extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTModuleMaster constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.t-module-master',
            'admin.t-module-master.index',
            'admin.t-module-master.create',
            'admin.t-module-master.show',
            'admin.t-module-master.edit',
            'admin.t-module-master.delete',
            'admin.t-module-master.bulk-delete',
        ]);
