...
class FillPermissionsForGuidanceOnAdverseDrugReaction extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForGuidanceOnAdverseDrugReaction constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.guidance-on-adverse-drug-reaction',
            'admin.guidance-on-adverse-drug-reaction.index',
            'admin.guidance-on-adverse-drug-reaction.create',
            'admin.guidance-on-adverse-drug-reaction.show',
            'admin.guidance-on-adverse-drug-reaction.edit',
            'admin.guidance-on-adverse-drug-reaction.delete',
            'admin.guidance-on-adverse-drug-reaction.bulk-delete',
        ]);
