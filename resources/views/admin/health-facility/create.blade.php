...
@section('title', trans('admin.health-facility.actions.create'))
...
@section('body')
    ...
    <div class="container-xl">
        ...
        <health-facility-form
            :action="'{{ url('admin/health-facilities') }}'"
            ...
            <form class="form-horizontal form-create" method="post" @submit.prevent="onSubmit" :action="action" novalidate>
                ...
                <div class="card-header">
                    <i class="fa fa-plus"></i> {{ trans('admin.health-facility.actions.create') }}
                </div>
