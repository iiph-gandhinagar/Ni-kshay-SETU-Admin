...
class FillPermissionsForStaticWhatWeDo extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForStaticWhatWeDo constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.static-what-we-do',
            'admin.static-what-we-do.index',
            'admin.static-what-we-do.create',
            'admin.static-what-we-do.show',
            'admin.static-what-we-do.edit',
            'admin.static-what-we-do.delete',
            'admin.static-what-we-do.bulk-delete',
        ]);
