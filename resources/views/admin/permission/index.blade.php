                            ...
                            <table class="table table-hover ">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' data-title="id" :column="'id'">{{ trans('admin.permission.columns.id') }}</th>
                                        <th is='sortable' data-title="name" :column="'name'">{{ trans('admin.permission.columns.name') }}</th>
                                        <th is='sortable' data-title="guard_name" :column="'guard_name'">{{ trans('admin.permission.columns.guard_name') }}</th>
                                ...
                                <tbody>
                                    <tr v-for="(item, index) in collection" :key="item.id" :class="bulkItems[item.id] ? 'bg-bulk' : ''">
                                        ...
                                        <td data-title="guard_name" >@{{ item.guard_name }}</td>
