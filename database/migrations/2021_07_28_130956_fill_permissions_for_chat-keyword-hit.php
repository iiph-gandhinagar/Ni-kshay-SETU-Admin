...
class FillPermissionsForChatKeywordHit extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForChatKeywordHit constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.chat-keyword-hit',
            'admin.chat-keyword-hit.index',
            'admin.chat-keyword-hit.create',
            'admin.chat-keyword-hit.show',
            'admin.chat-keyword-hit.edit',
            'admin.chat-keyword-hit.delete',
            'admin.chat-keyword-hit.bulk-delete',
        ]);
