...
class FillPermissionsForAutomaticNotification extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAutomaticNotification constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.automatic-notification.create',
            'admin.automatic-notification.show',
            'admin.automatic-notification.edit',
            'admin.automatic-notification.delete',
            'admin.automatic-notification.bulk-delete',
        ]);
