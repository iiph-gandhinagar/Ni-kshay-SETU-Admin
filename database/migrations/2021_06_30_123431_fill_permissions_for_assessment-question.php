...
class FillPermissionsForAssessmentQuestion extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAssessmentQuestion constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.assessment-question',
            'admin.assessment-question.index',
            'admin.assessment-question.create',
            'admin.assessment-question.show',
            'admin.assessment-question.edit',
            'admin.assessment-question.delete',
            'admin.assessment-question.bulk-delete',
        ]);
