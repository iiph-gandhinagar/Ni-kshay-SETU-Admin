...
class TreatmentAlgorithm extends Model implements HasMedia
{
    use SoftDeletes;
    ...
    {
        return url('/admin/treatment-algorithms/' . $this->getKey());
    }

    public function parent()
    {
        return $this->belongsTo('App\Models\TreatmentAlgorithm','master_node_id','id');
    }

    public function child()
    {
        return $this->hasMany('App\Models\TreatmentAlgorithm', 'parent_id', 'id')->orderBy('index');
    }
