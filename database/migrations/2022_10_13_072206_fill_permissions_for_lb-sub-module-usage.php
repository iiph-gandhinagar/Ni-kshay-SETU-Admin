...
class FillPermissionsForLbSubModuleUsage extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForLbSubModuleUsage constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.lb-sub-module-usage',
            'admin.lb-sub-module-usage.index',
            'admin.lb-sub-module-usage.create',
            'admin.lb-sub-module-usage.show',
            'admin.lb-sub-module-usage.edit',
            'admin.lb-sub-module-usage.delete',
            'admin.lb-sub-module-usage.bulk-delete',
        ]);
