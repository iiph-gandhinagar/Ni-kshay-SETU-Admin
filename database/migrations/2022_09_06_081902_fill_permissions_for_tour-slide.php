...
class FillPermissionsForTourSlide extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTourSlide constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.tour-slide',
            'admin.tour-slide.index',
            'admin.tour-slide.create',
            'admin.tour-slide.show',
            'admin.tour-slide.edit',
            'admin.tour-slide.delete',
            'admin.tour-slide.bulk-delete',
        ]);
