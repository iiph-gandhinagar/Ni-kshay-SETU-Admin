...
class FillPermissionsForUserFeedbackQuestion extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForUserFeedbackQuestion constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.user-feedback-question',
            'admin.user-feedback-question.index',
            'admin.user-feedback-question.create',
            'admin.user-feedback-question.show',
            'admin.user-feedback-question.edit',
            'admin.user-feedback-question.delete',
            'admin.user-feedback-question.bulk-delete',
        ]);
