...
@section('body')
    ...
    <country-listing :data="{{ $data->toJson() }}" :url="'{{ url('admin/countries') }}'" inline-template>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-primary btn-spinner btn-sm pull-right m-b-0"
                            href="{{ url('admin/countries/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp;
                            {{ trans('admin.country.actions.create') }}</a>
                    </div>
                    <div class="card-body" v-cloak>
                        <div class="card-block">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' data-title="id" :column="'id'">
                                            {{ trans('admin.country.columns.id') }}</th>
                                        <th is='sortable' data-title="title" :column="'title'">
                                            {{ trans('admin.country.columns.title') }}</th>
                                        ...
                                        <td class="bg-bulk-info d-table-cell text-center" colspan="4">
                                            <span
                                                ...
                                                @{{ clickedBulkItemsCount }}. <a href="#" class="text-primary"
                                                    @click="onBulkItemsClickedAll('/admin/countries')"
                                            ...
                                            <span class="pull-right pr-2">
                                                <button class="btn btn-sm btn-danger pr-3 pl-3"
                                                    @click="bulkDelete('/admin/countries/bulk-destroy')">{{ trans('brackets/admin-ui::admin.btn.delete') }}</button>
                                            </span>
                            ...
                            <div class="no-items-found" v-if="!collection.length > 0">
                                ...
                                <a class="btn btn-primary btn-spinner" href="{{ url('admin/countries/create') }}"
