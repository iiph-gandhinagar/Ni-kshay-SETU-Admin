...
class FillPermissionsForStaticResourceMaterial extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForStaticResourceMaterial constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.static-resource-material',
            'admin.static-resource-material.index',
            'admin.static-resource-material.create',
            'admin.static-resource-material.show',
            'admin.static-resource-material.edit',
            'admin.static-resource-material.delete',
            'admin.static-resource-material.bulk-delete',
        ]);
