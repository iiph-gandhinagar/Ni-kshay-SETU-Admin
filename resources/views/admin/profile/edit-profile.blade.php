                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="form-group row align-items-center" :class="{'has-danger': errors.has('state'), 'has-success': fields.state && fields.state.valid }">
                                    <label for="state" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-3'">{{ trans('admin.admin-user.columns.state') }}</label>
                                    <div v-if="form.state != '' && form.state != null && form.state.length > 0">
                                        <span class="badge badge-danger p-1 m-1" v-for="state_master in form.state" :value="state_master.title">@{{state_master.title}}</span>
                                    </div>
                                    <div v-else>
                                        <span class="badge badge-danger p-1 m-1">All State</span>
                                    </div>
                                </div>
