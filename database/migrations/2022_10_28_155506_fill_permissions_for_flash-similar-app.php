...
class FillPermissionsForFlashSimilarApp extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForFlashSimilarApp constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.flash-similar-app',
            'admin.flash-similar-app.index',
            'admin.flash-similar-app.create',
            'admin.flash-similar-app.show',
            'admin.flash-similar-app.edit',
            'admin.flash-similar-app.delete',
            'admin.flash-similar-app.bulk-delete',
        ]);
