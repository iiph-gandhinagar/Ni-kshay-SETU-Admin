...
@section('title', trans('admin.static-faq.actions.index'))

@section('body')

    <static-faq-listing :data="{{ $data->toJson() }}" :url="'{{ url('admin/static-faqs') }}'"
            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> {{ trans('admin.static-faq.actions.index') }}
                        <a class="btn btn-primary btn-spinner btn-sm pull-right m-b-0"
                            href="{{ url('admin/static-faqs/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp;
                            {{ trans('admin.static-faq.actions.create') }}</a>
                    </div>
                    <div class="card-body" v-cloak>
                        <div class="card-block">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' width="5%" data-title="id" :column="'id'">
                                            {{ trans('admin.static-faq.columns.id') }}</th>
                                        <th is='sortable' width="35" data-title="question" :column="'question'">
                                            {{ trans('admin.static-faq.columns.question') }}</th>
                                        <th is='sortable' width="35" data-title="description" :column="'description'">
                                            {{ trans('admin.static-faq.columns.description') }}</th>
                                        <th is='sortable' width="5%" data-title="order_index" :column="'order_index'">
                                            {{ trans('admin.static-faq.columns.order_index') }}</th>
                                        <th is='sortable' width="5%" data-title="active" :column="'active'">
                                            {{ trans('admin.static-faq.columns.active') }}</th>
                                        <th is='sortable' width="5%" data-title="created_at" :column="'created_at'">
                                            {{ trans('admin.static-faq.columns.created_at') }}</th>
                                        ...
                                        <td class="bg-bulk-info d-table-cell text-center" colspan="7">
                                            <span
                                                ...
                                                @{{ clickedBulkItemsCount }}. <a href="#" class="text-primary"
                                                    @click="onBulkItemsClickedAll('/admin/static-faqs')"
                                            ...
                                            <span class="pull-right pr-2">
                                                <button class="btn btn-sm btn-danger pr-3 pl-3"
                                                    @click="bulkDelete('/admin/static-faqs/bulk-destroy')">{{ trans('brackets/admin-ui::admin.btn.delete') }}</button>
                                            </span>
                            ...
                            <div class="no-items-found" v-if="!collection.length > 0">
                                ...
                                <a class="btn btn-primary btn-spinner" href="{{ url('admin/static-faqs/create') }}"
