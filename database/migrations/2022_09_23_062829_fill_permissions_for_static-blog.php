...
class FillPermissionsForStaticBlog extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForStaticBlog constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.static-blog.create',
            'admin.static-blog.show',
            'admin.static-blog.edit',
            'admin.static-blog.delete',
            'admin.static-blog.bulk-delete',
        ]);
