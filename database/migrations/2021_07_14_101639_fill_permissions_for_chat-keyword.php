...
class FillPermissionsForChatKeyword extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForChatKeyword constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.chat-keyword',
            'admin.chat-keyword.index',
            'admin.chat-keyword.create',
            'admin.chat-keyword.show',
            'admin.chat-keyword.edit',
            'admin.chat-keyword.delete',
            'admin.chat-keyword.bulk-delete',
        ]);
