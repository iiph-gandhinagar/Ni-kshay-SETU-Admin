...
class PlannedAssessmentBeforeHour extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'planned-assessment:before-an-hour';
    ...
    public function handle()
    {
        ...
        $list_of_assessments_1_hour = Assessment::where('activated', 1)->where('assessment_type', 'planned')->where('from_date', Carbon::now()->addHour())->get();
        ...
        foreach ($list_of_assessments_1_hour as $planned_ass) {
            ...
            $notification['description'] =  "New Assessment: Your Assessment for " . $planned_ass->assessment_title . " will be live in 1 Hour, Click here to enroll";
