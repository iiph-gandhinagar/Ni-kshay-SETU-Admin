...
class FillPermissionsForStaticFaq extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForStaticFaq constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.static-faq.create',
            'admin.static-faq.show',
            'admin.static-faq.edit',
            'admin.static-faq.delete',
            'admin.static-faq.bulk-delete',
        ]);
