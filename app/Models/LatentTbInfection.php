...
class LatentTbInfection extends Model implements HasMedia
{
    use SoftDeletes;
    ...
    {
        return url('/admin/latent-tb-infections/' . $this->getKey());
    }

    public function parent()
    {
        return $this->belongsTo('App\Models\LatentTbInfection','master_node_id','id');
    }

    public function child()
    {
        return $this->hasMany('App\Models\LatentTbInfection', 'parent_id', 'id')->orderBy('index');
    }
