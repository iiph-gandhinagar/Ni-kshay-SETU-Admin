!function(t, e) {
    ...
    function s(t) {
        ...
        r = i = 0; i < n; ++i)
            ...
            "\\" === o)
                ...
                r === s && '"' === o || r === s && "'" === o ? (r = i + 1,
                a = o) : "." !== o || s ? "[" === o ? (i > r && c(),
                s = r = i + 1) : "]" === o && (s || u("Access path missing open bracket: " + t),
                s > 0 && c(),
                s = 0,
                r = i + 1) : i > r ? c() : r = i + 1
            }
        return s && u("Access path missing closing bracket: " + t),
    ...
    function y(t, e) {
        ...
        return {
            ...
            error() {
                return n >= 1 && m(e || "error", "ERROR", arguments),
                this
            },
            warn() {
                return n >= 2 && m(e || "warn", "WARN", arguments),
                this
            },
            info() {
                return n >= 3 && m(e || "log", "INFO", arguments),
                this
            },
            debug() {
                return n >= 4 && m(e || "log", "DEBUG", arguments),
                this
            }
        }
    }
    ...
    function b(...t) {
        return t.reduce(((t,e)=>{
            for (const n in e)
                if ("signals" === n)
                    t.signals = k(t.signals, e.signals);
                else {
                    const r = "legend" === n ? {
                        layout: 1
                    } : "style" === n || null;
    ...
    function Y(t, n, i) {
        ...
        return $(t).forEach(((t,e)=>{
            null != t && (o.push("descending" === n[e] ? -1 : 1),
    ...
    const V = (t,e)=>(t < e || null == t) && null != e ? -1 : (t > e || null == e) && null != t ? 1 : (e = e instanceof Date ? +e : e,
    (t = t instanceof Date ? +t : t) !== t && e == e ? -1 : e != e && t == t ? 1 : 0)
      , G = (t,e)=>1 === t.length ? X(t[0], e[0]) : J(t, e, t.length)
      , X = (t,e)=>function(n, r) {
        return V(t(n), t(r)) * e
    }
      , J = (t,e,n)=>(e.push(0),
    ...
    async function Ot(t, e) {
        ...
        const l = St.test(t);
        return (a = e.baseURL) && !l && (t.startsWith("/") || "/" === a[a.length - 1] || (t = "/" + t),
        t = a + t),
        o = (i = t.startsWith(zt)) || "file" === e.mode || "http" !== e.mode && !l && n,
        i ? t = t.slice(zt.length) : t.startsWith("//") && ("file" === e.defaultProtocol ? (t = t.slice(2),
        o = !0) : t = (e.defaultProtocol || "http") + ":" + t),
        Object.defineProperty(r, "localFile", {
            value: !!o
        }),
        r.href = t,
        e.target && (r.target = e.target + ""),
        e.rel && (r.rel = e.rel + ""),
        "image" === e.context && e.crossOrigin && (r.crossOrigin = e.crossOrigin + ""),
        r
    }
    function Rt(t) {
    ...
    function Wt(t, e) {
        ...
        for (let a, u, s = 0, l = 0; s < n; ++s)
            for (u = e ? t[s][e] : t[s],
            a = 0; a < r; ++a)
                if (i[a] && (null != (o = u) && o == o) && !It[a](u) && (i[a] = 0,
                ++l,
                l === It.length))
                    return "string";
        var o;
    ...
    function Ht(t, e) {
        return e.reduce(((e,n)=>(e[n] = Wt(t, n),
        e)), {})
    }
    var Yt = {}
      , Vt = {};
            ...
            function c() {
                ...
                if (34 === t.charCodeAt(i)) {
                    for (; a++ < o && 34 !== t.charCodeAt(a) || 34 === t.charCodeAt(++a); )
                        ;
                    return (e = a) >= o ? s = !0 : 10 === (r = t.charCodeAt(a++)) ? l = !0 : 13 === r && (l = !0,
                    10 === t.charCodeAt(a) && ++a),
                    t.slice(i + 1, e - 1).replace(/""/g, '"')
                }
                for (; a < o; ) {
                    if (10 === (r = t.charCodeAt(e = a++)))
                        l = !0;
                    else if (13 === r)
                        l = !0,
                        10 === t.charCodeAt(a) && ++a;
    ...
    function Kt(t) {
        ...
        return e.responseType = "text",
        e
    }
    function te(t, e) {
        return e.header && (t = e.header.map(wt).join(e.delimiter) + "\n" + t),
        Qt(e.delimiter).parse(t + "")
    }
    function ee(t, e) {
        const n = e && e.property ? l(e.property) : f;
        return !_(t) || (r = t,
        "function" == typeof Buffer && H(Buffer.isBuffer) && Buffer.isBuffer(r)) ? n(JSON.parse(t)) : function(t, e) {
            !v(t) && ft(t) && (t = [...t]);
    ...
    function re(t, e) {
        return "string" == typeof e && (e = t.objects[e]),
    ...
    function se(t, e, n) {
        ...
        if (arguments.length > 1)
            ...
            for (i = 0,
            r = new Array(o = t.arcs.length); i < o; ++i)
                r[i] = i;
        return {
    ...
    te.responseType = "text",
    ee.responseType = "json";
    const ce = {
        interior: (t,e)=>t !== e,
        exterior: (t,e)=>t === e
    };
    function fe(t, e) {
        ...
        return t = ee(t, e),
        e && e.feature ? (n = re,
        i = e.feature) : e && e.mesh ? (n = ue,
        i = e.mesh,
        o = ce[e.filter]) : u("Missing TopoJSON feature or mesh parameter."),
        r = (r = t.objects[i]) ? n(t, r, o) : u("Invalid TopoJSON object: " + i),
        r && r.features || [r]
    }
    ...
    function de(t, e) {
        return arguments.length > 1 ? (he[t] = e,
        this) : rt(he, t) ? he[t] : null
    }
    function pe(t) {
        const e = de(t);
    ...
    class be {
        ...
        valueOf() {
            ...
            if (i > 0) {
                ...
                !r); )
                    ;
                i > 0 && (r < 0 && t[i - 1] < 0 || r > 0 && t[i - 1] > 0) && (n = 2 * r,
                e = o + n,
                n == e - o && (o = e))
            }
            return o
    ...
    function De(t, e, n) {
        var r = Math.abs(e - t) / Math.max(0, n)
          ...
          , o = r / i;
        return o >= we ? i *= 10 : o >= ke ? i *= 5 : o >= Me && (i *= 2),
        e < t ? -i : i
    }
    function Ce(t, e) {
        let n;
    ...
    var He = {
        ...
        s: function(t, e) {
            ...
            var r = n[0]
              , i = n[1]
              , o = i - (Pe = 3 * Math.max(-8, Math.min(8, Math.floor(i / 3)))) + 1
              , a = r.length;
    ...
    var Ve, Ge, Xe, Je = Array.prototype.map, Ze = ["y", "z", "a", "f", "p", "n", "µ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"];
    function Qe(t) {
        var e, n, r = void 0 === t.grouping || void 0 === t.thousands ? Ye : (e = Je.call(t.grouping, Number),
        n = t.thousands + "",
        function(t, r) {
            for (var i = t.length, o = [], a = 0, u = e[0], s = 0; i > 0 && u > 0 && (s + u + 1 > r && (u = Math.max(1, r - s)),
            o.push(t.substring(i -= u, i + u)),
            !((s += u + 1) > r)); )
                u = e[a = (a + 1) % e.length];
            return o.reverse().join(n)
        }
        ), i = void 0 === t.currency ? "" : t.currency[0] + "", o = void 0 === t.currency ? "" : t.currency[1] + "", a = void 0 === t.decimal ? "." : t.decimal + "", u = void 0 === t.numerals ? Ye : function(t) {
            return function(e) {
        ...
        }(Je.call(t.numerals, String)), s = void 0 === t.percent ? "%" : t.percent + "", l = void 0 === t.minus ? "−" : t.minus + "", c = void 0 === t.nan ? "NaN" : t.nan + "";
        function f(t) {
            var e = (t = Ie(t)).fill
              , n = t.align
              , f = t.sign
            ...
            function k(t) {
                ...
                switch (g && d && (t = r(E + t, E.length ? p - k.length : 1 / 0),
                E = ""),
                n) {
                case "<":
                    t = h + t + k + E;
            ...
            return m = void 0 === m ? 6 : /[gprs]/.test(v) ? Math.max(1, Math.min(21, m)) : Math.max(0, Math.min(20, m)),
            k.toString = function() {
                return t + ""
            }
            ,
    ...
    an.every = function(t) {
        return t = Math.floor(t),
        isFinite(t) && t > 0 ? t > 1 ? on((function(e) {
    ...
    const Bn = "year"
      ...
      , Pn = "seconds"
      , jn = "milliseconds"
      , In = [Bn, Tn, zn, Nn, On, Rn, Ln, Un, qn, Pn, jn]
      , $n = In.reduce(((t,e,n)=>(t[e] = 1 + n,
    t)), {});
    function Wn(t) {
        const e = $(t).slice()
          , n = {};
        ...
        return (n.week || n.day ? 1 : 0) + (n.quarter || n.month || n.date ? 1 : 0) + (n.dayofyear ? 1 : 0) > 1 && u("Incompatible time units: ".concat(t)),
        e.sort(((t,e)=>$n[t] - $n[e])),
        e
    }
    const Hn = {
    ...
    function or(t) {
        return Vn.setTime(Date.UTC(t, 0, 1)),
        Vn.getUTCDay()
    }
    ...
    function qr(t) {
        ...
        return a === Ur.length ? (i = Lr,
        o = De(e[0] / Sr, e[1] / Sr, n)) : a ? (a = Ur[r / Ur[a - 1][2] < Ur[a][2] / r ? a - 1 : a],
        i = a[0],
        o = a[1]) : (i = Br,
        o = Math.max(De(e[0], e[1], n), 1)),
        {
            units: i,
            step: o
        }
        ...
        function w(t, e) {
            return function(n) {
                ...
                for (n instanceof Date || (n = new Date(+n)); ++u < l; )
                    ...
                    null != (i = Xr[r = t.charAt(++u)]) ? r = t.charAt(++u) : i = "e" === r ? " " : "0",
                    (o = e[r]) && (r = o(n, i)),
                    a.push(r),
                    s = u + 1);
            ...
            return function(n) {
                ...
                "V"in o) {
                    if (o.V < 1 || o.V > 53)
                        return null;
                    "w"in o || (o.w = 1),
                    "Z"in o ? (i = (r = jr(Ir(o.y, 0, 1))).getUTCDay(),
                    r = i > 4 || 0 === i ? Dn.ceil(r) : Dn(r),
                    r = Mn.offset(r, 7 * (o.V - 1)),
                    o.y = r.getUTCFullYear(),
                    o.m = r.getUTCMonth(),
                    o.d = r.getUTCDate() + (o.w + 6) % 7) : (i = (r = Pr(Ir(o.y, 0, 1))).getDay(),
                    r = i > 4 || 0 === i ? vn.ceil(r) : vn(r),
                    ...
                    i = "Z"in o ? jr(Ir(o.y, 0, 1)).getUTCDay() : Pr(Ir(o.y, 0, 1)).getDay(),
                    o.m = 0,
        ...
        function M(t, e, n, r) {
            for (var i, o, a = 0, u = e.length, s = n.length; a < u; ) {
                ...
                if (37 === (i = e.charCodeAt(a++))) {
                    if (i = e.charAt(a++),
                    !(o = b[i in Xr ? e.charAt(a++) : i]) || (r = o(t, n, r)) < 0)
                        return -1
    ...
    function Oi(t, e) {
        return t = Ni(t),
        Kr(_n.count(bn(t), t) + (4 === bn(t).getDay()), e, 2)
    }
    function Ri(t) {
        return t.getDay()
    }
    ...
    function eo(t, e) {
        return t = to(t),
        Kr(Cn.count(Sn(t), t) + (4 === Sn(t).getUTCDay()), e, 2)
    }
    function no(t) {
        return t.getUTCDay()
    }
        ...
        return {
            ...
            formatSpan(t, r, i, o) {
                ...
                if (null == o.precision)
                    switch (o.type) {
                    case "s":
                        return isNaN(s = tn(a, u)) || (o.precision = s),
                        n(o, u);
                    case "":
                    case "e":
                    case "g":
    ...
    function Do(t, e) {
        ...
        return n && 2 !== n && u("defaultLocale expects either zero or two arguments."),
        n ? Ao(_o(t), Mo(e)) : Ao(_o(), Mo())
    }
    function Co(t, e, n, r) {
        const i = de((e = e || {}).type || "json");
        return i || u("Unknown data format type: " + e.type),
        t = i(t, e),
        e.parse && function(t, e, n, r) {
            if (!t.length)
                return;
            const i = Mo();
            n = n || i.timeParse,
            ...
            const h = f.map((t=>{
                ...
                if (i && (i.startsWith("date:") || i.startsWith("utc:"))) {
                    o = i.split(/:(.+)?/, 2),
                    a = o[1],
                    ("'" === a[0] && "'" === a[a.length - 1] || '"' === a[0] && '"' === a[a.length - 1]) && (a = a.slice(1, -1));
                    return ("utc" === o[0] ? r : n)(a)
                }
                if (!jt[i])
                    throw Error("Illegal format pattern: " + t + ":" + i);
                return jt[i]
            }
            ));
            for (u = 0,
        ...
        return {
            ...
            pulse(u, s) {
                ...
                h = t.length; f < h; ++f)
                    g = t[f],
                    m = Oo(g),
                    l[m] ? l[m] = 1 : u.add.push(Lo(t[f]));
                for (f = 0,
                h = s.length; f < h; ++f)
                    g = s[f],
                    l[Oo(g)] < 0 && u.rem.push(g);
                function y(t, e, n) {
                    n ? t[e] = n(t) : u.encode = e,
                    a || (c[Oo(t)] = t)
                }
                for (f = 0,
                h = n.length; f < h; ++f)
                ...
                h = i.length; f < h; ++f)
                    ...
                    u.modifies(d.field);
                if (a)
                    u.mod = e.length || r.length ? s.filter((t=>l[Oo(t)] > 0)) : s.slice();
                else
                    for (m in c)
                        u.mod.push(c[m]);
                return (o || null == o && (e.length || r.length)) && u.clean(!0),
                u
            }
        }
    }
    ...
    Ho.prototype = {
        set(t, e, n, r) {
            const i = this
              , o = i[t]
              , a = i[Wo];
            return null != e && e >= 0 ? (o[e] !== n || r) && (o[e] = n,
            a[e + ":" + t] = -1,
            a[t] = -1) : (o !== n || r) && (i[t] = n,
            a[t] = v(n) ? 1 + n.length : -1),
            i
        },
        modified(t, e) {
            const n = this[Wo];
    ...
    function Xo(t) {
        return function(e) {
            const n = this.flags;
            return 0 === arguments.length ? !!(n & t) : (this.flags = e ? n | t : n & ~t,
            this)
        }
    }
    Go.prototype = {
        ...
        parameters(t, e, n) {
            e = !1 !== e;
            const r = this._argval = this._argval || new Ho
              , i = this._argops = this._argops || []
              , o = [];
            let a, s, l, c;
            const f = (t,n,a)=>{
                a instanceof Go ? (a !== this && (e && a.targets().add(this),
                o.push(a)),
                i.push({
                    op: a,
                    name: t,
            ...
            for (a in t)
                ...
                "pulse" === a)
                    $(s).forEach((t=>{
                        t instanceof Go ? t !== this && (t.targets().add(this),
                        o.push(t)) : u("Pulse parameters must be operator instances.")
                    }
                    )),
                    this.source = s;
                else if (v(s))
                    for (r.set(a, -1, Array(l = s.length)),
                    c = 0; c < l; ++c)
                        f(a, c, s[c]);
                else
                    f(a, -1, s);
            return this.marshall().clear(),
            n && (i.initonly = !0),
            o
        },
        marshall(t) {
            const e = this._argval || Vo
              , n = this._argops;
            let r, i, o, a;
            if (n) {
                const u = n.length;
        ...
        run(t) {
            if (t.stamp < this.stamp)
                return t.StopPropagation;
            let e;
            return this.skip() ? (this.skip(!1),
            e = 0) : e = this.evaluate(t),
            this.pulse = e || t
        }
    };
    let Jo = 0;
    ...
    Zo.prototype = {
        ...
        consume(t) {
            return arguments.length ? (this._consume = !!t,
            this) : !!this._consume
        },
        receive(t) {
            if (this._filter(t)) {
                ...
                for (let t = 0; t < r; ++t)
                    n[t].receive(e);
                this._consume && (t.preventDefault(),
                t.stopPropagation())
            }
        },
        filter(t) {
            const e = Qo(t);
            return this.targets().add(e),
            e
        },
        apply(t) {
            const e = Qo(null, t);
        ...
        between(t, e) {
            let n = !1;
            return t.targets().add(Qo(null, null, (()=>n = !0))),
            e.targets().add(Qo(null, null, (()=>n = !1))),
            this.filter((()=>n))
        },
        detach() {}
    };
    ...
    function ta(t, e, n, r, i, o) {
        ...
        let u, s;
        H(n) || (n = Z(n)),
        void 0 === r ? u = e=>t.touch(n(e)) : H(r) ? (s = new Go(null,r,i,!1),
        u = e=>{
            s.evaluate(e);
            const r = n(e)
              , i = s.value;
    ...
    function ea(t, e, n, r, i, o) {
        if (void 0 === r)
            ...
            const a = o || {}
              , u = new Go(null,function(t, e) {
                return e = H(e) ? e : Z(e),
                t ? function(n, r) {
                    const i = e(n, r);
                    return t.skip() || (t.skip(i !== this.value).value = i),
                    i
                }
                : e
            }(n, r),i,!1);
    ...
    function ua(t, e, n, r) {
        ...
        for (let t = 0; t < o; ++t) {
            ...
            if (r.stamp === e) {
                ...
                r.changed(i.ADD) && (a |= i.ADD),
                r.changed(i.REM) && (a |= i.REM),
                r.changed(i.MOD) && (a |= i.MOD)
            }
        }
        this.changes = a
    }
    function sa(t) {
        return t.error("Dataflow already running. Use runAsync() to chain invocations."),
        t
    }
    ra.prototype = {
        StopPropagation: na,
        ...
        addAll() {
            let t = this;
            return !t.source || t.add === t.rem || !t.rem.length && t.source.length === t.add.length || (t = new ra(this.dataflow).init(this),
            t.add = t.source,
            t.rem = []),
            t
        },
        init(t, e) {
            const n = this;
            return n.stamp = t.stamp,
            n.encode = t.encode,
            !t.fields || 64 & e || (n.fields = t.fields),
            1 & e ? (n.addF = t.addF,
            n.add = t.add) : (n.addF = null,
            n.add = []),
            2 & e ? (n.remF = t.remF,
            n.rem = t.rem) : (n.remF = null,
            n.rem = []),
            4 & e ? (n.modF = t.modF,
            n.mod = t.mod) : (n.modF = null,
            n.mod = []),
            32 & e ? (n.srcF = null,
            n.source = null) : (n.srcF = t.srcF,
            n.source = t.source,
        ...
        reflow(t) {
            ...
            return n && n !== e && (this.mod = this.source,
            e && this.filter(4, oa(this, 1))),
            this
        },
        clean(t) {
            return arguments.length ? (this.cleans = !!t,
            this) : this.cleans
        },
        modifies(t) {
            const e = this.fields || (this.fields = {});
            return v(t) ? t.forEach((t=>e[t] = !0)) : e[t] = !0,
            this
        },
        modified(t, e) {
            const n = this.fields;
        ...
        filter(t, e) {
            const n = this;
            return 1 & t && (n.addF = aa(n.addF, e)),
            2 & t && (n.remF = aa(n.remF, e)),
            4 & t && (n.modF = aa(n.modF, e)),
            16 & t && (n.srcF = aa(n.srcF, e)),
            n
        },
        materialize(t) {
            const e = this;
            return 1 & (t = t || 7) && e.addF && (e.add = ia(e.add, e.addF),
            e.addF = null),
            2 & t && e.remF && (e.rem = ia(e.rem, e.remF),
            e.remF = null),
            4 & t && e.modF && (e.mod = ia(e.mod, e.modF),
            e.modF = null),
            16 & t && e.srcF && (e.source = e.source.filter(e.srcF),
            e.srcF = null),
            e
        },
        visit(t, e) {
    ...
    ut(ua, ra, {
        fork(t) {
            ...
            return void 0 !== t && (t & e.ADD && this.visit(e.ADD, (t=>e.add.push(t))),
        ...
        visit(t, e) {
            ...
            if (t & n.SOURCE)
                ...
                for (; o < i; ++o)
                    r[o].stamp === n.stamp && r[o].visit(t, e);
            return n
        }
    });
    const la = {
    ...
    function ha() {
        ...
        this._input = {},
        this._pulse = null,
        this._heap = ca(((t,e)=>t.qrank - e.qrank)),
        this._postrun = []
    }
    function da(t) {
        return function() {
    ...
    ha.prototype = {
        ...
        loader(t) {
            return arguments.length ? (this._loader = t,
            this) : this._loader
        },
        locale(t) {
            return arguments.length ? (this._locale = t,
            this) : this._locale
        },
        logger(t) {
            return arguments.length ? (this._log = t,
            this) : this._log
        },
        error: da("error"),
        warn: da("warn"),
        ...
        add: function(t, e, n, r) {
            let i, o = 1;
            return t instanceof Go ? i = t : t && t.prototype instanceof Go ? i = new t : H(t) ? i = new Go(null,t) : (o = 0,
            i = new Go(t,e)),
            this.rank(i),
            o && (r = n,
            n = e),
        ...
        pulse: function(t, e, n) {
            this.touch(t, n || la);
            const r = new ra(this,this._clock + (this._pulse ? 0 : 1))
              , i = t.pulse && t.pulse.source || [];
            return r.target = t,
            this._input[t.id] = e.pulse(r, i),
            this
        },
        touch: function(t, e) {
            const n = e || la;
            return this._pulse ? this._enqueue(t) : this._touched.add(t),
            n.skip && t.skip(!0),
            this
        },
        update: function(t, e, n) {
            const r = n || la;
            return (t.set(e) || r.force) && this.touch(t, r),
            this
        },
        changeset: $o,
        ingest: function(t, e, n) {
            return e = this.parse(e, n),
            this.pulse(t, this.changeset().insert(e))
        },
        parse: function(t, e) {
            const n = this.locale();
        ...
        preload: async function(t, e, n) {
            const r = this
              , i = r._pending || function(t) {
                let e;
                const n = new Promise((t=>e = t));
                return n.requests = 0,
                n.done = ()=>{
                    0 == --n.requests && (t._pending = null,
                    e(t))
                }
                ,
                t._pending = n
            ...
            return r.pulse(t, r.changeset().remove(p).insert(o.data || [])),
            i.done(),
            o
        },
        request: async function(t, e) {
            ...
            let r, i = 0;
            try {
                r = await n.loader().load(t, {
                    context: "dataflow",
                    response: pe(e && e.type)
                });
                try {
                    r = n.parse(r, e)
                } catch (e) {
                    i = -2,
                    n.warn("Data ingestion failed", t, e)
                }
            } catch (e) {
                i = -1,
                n.warn("Loading failed", t, e)
            }
            return {
                data: r,
                status: i
        ...
        events: function(t, e, n, r) {
            ...
            const s = u.length;
            for (let t = 0; t < s; ++t)
                u[t].addEventListener(e, a);
            return o
        },
        on: function(t, e, n, r, i) {
            return (t instanceof Go ? ea : ta)(this, t, e, n, r, i),
            this
        },
        evaluate: async function(t, e, n) {
            ...
            if (r._pulse)
                return sa(r);
            if (r._pending && await r._pending,
            e && await Bo(r, e),
            !r._touched.length)
                return r.debug("Dataflow invoked, but nothing to do."),
                r;
            const o = ++r._clock;
            r._pulse = new ra(r,o,t),
            ...
            try {
                for (; r._heap.size() > 0; )
                    a = r._heap.pop(),
                    a.rank === a.qrank ? (u = a.run(r._getPulse(a, t)),
                    u.then ? u = await u : u.async && (i.push(u.async),
                    u = na),
                    u !== na && a._targets && a._targets.forEach((t=>r._enqueue(t))),
                    ++l) : r._enqueue(a, !0)
            } catch (t) {
                r._heap.clear(),
                s = t
            ...
            r._postrun.length) {
                ...
                r._postrun = [];
                for (let e = 0; e < t.length; ++e)
                    await Bo(r, t[e].callback)
            }
            return n && await Bo(r, n),
            i.length && Promise.all(i).then((t=>r.runAsync(null, (()=>{
                t.forEach((t=>{
                    try {
                        t(r)
                    } catch (t) {
        ...
        run: function(t, e, n) {
            return this._pulse ? sa(this) : (this.evaluate(t, e, n),
            this)
        },
        runAsync: async function(t, e, n) {
            ...
            return (this._running = this.evaluate(t, e, n)).then(r, r),
            this._running
        },
    ...
    ut(pa, Go, {
        run(t) {
            if (t.stamp < this.stamp)
                return t.StopPropagation;
            let e;
            return this.skip() ? this.skip(!1) : e = this.evaluate(t),
            e = e || t,
            e.then ? e = e.then((t=>this.pulse = t)) : e !== t.StopPropagation && (this.pulse = e),
            e
        },
        evaluate(t) {
    ...
    function wa(t) {
        ...
        if (t.step)
            ...
            for (s = d / e,
            l = 0,
            c = t.steps.length; l < c && t.steps[l] < s; ++l)
                ;
            o = t.steps[Math.max(0, l - 1)]
        } else {
            for (a = Math.ceil(Math.log(e) / r),
            u = t.minstep || 0,
            o = Math.max(u, Math.pow(n, Math.round(Math.log(d) / r) - a)); Math.ceil(d / o) > e; )
                o *= n;
            for (l = 0,
            c = i.length; l < c; ++l)
                s = o / i[l],
        ...
        const p = s >= 0 ? 0 : 1 + ~~(-s / r)
          , g = Math.pow(n, -p - 1);
        return (t.nice || void 0 === t.nice) && (s = Math.floor(f / o + g) * o,
        f = f < s ? s - o : s,
        h = Math.ceil(h / o) * o),
        {
            start: f,
    ...
    function ka(e, n, r, i) {
        ...
        const o = Float64Array.from(va(e, i))
          , a = o.length
          , u = n;
        let s, l, c, f;
        for (c = 0,
    ...
    function Sa(t, e, n) {
        ...
        if (i > 37)
            ...
            let e;
            i < 7.07106781186547 ? (e = .0352624965998911 * i + .700383064443688,
            ...
            o = t * e,
            e = .0883883476483184 * i + 1.75566716318264,
    ...
    function Ba(t, e, n) {
        return t < 0 || t > 1 ? NaN : (e || 0) + (null == n ? 1 : n) * Ea * function(t) {
            ...
            e = .00018673420803405714 + e * n,
            e = e * n - .000740702534166267,
            e = e * n - .006033670871430149,
            e = .24015818242558962 + e * n,
            e = 1.6536545626831027 + e * n) : n < 16 ? (n = Math.sqrt(n) - 3.25,
            ...
            e = e * n - .0003550375203628475,
            e = .0009532893797373805 + e * n,
            e = e * n - .0016882755560235047,
            e = .002491442096107851 + e * n,
            e = e * n - .003751208507569241,
            e = .005370914553590064 + e * n,
            e = 1.0052589676941592 + e * n,
            e = 3.0838856104922208 + e * n) : Number.isFinite(n) ? (n = Math.sqrt(n) - 5,
            ...
            e = e * n - .00021503011930044477,
            e = e * n - .00013871931833623122,
            e = 1.0103004648645344 + e * n,
            e = 4.849906401408584 + e * n) : e = 1 / 0;
            return e * t
        }(2 * t - 1)
    }
    function Ta(t, e) {
        ...
        const i = {
            ...
            stdev(t) {
                return arguments.length ? (r = null == t ? 1 : t,
                i) : r
            },
            sample: ()=>Ca(n, r),
            pdf: t=>Fa(t, n, r),
    ...
    function za(e, n) {
        ...
        const o = {
            ...
            bandwidth(t) {
                return arguments.length ? (!(n = t) && e && (n = ba(e)),
                o) : n
            },
    ...
    function qa(e, n) {
        ...
        const o = {
            ...
            distributions(t) {
                return arguments.length ? (t ? (i = t.length,
                e = t) : (i = 0,
                e = []),
                o.weights(n)) : e
            },
    ...
    function Va(t, e, n, r) {
        ...
        for (const u of t)
            i = e(u),
            o = n(u),
            null != i && (i = +i) >= i && null != o && (o = +o) >= o && r(i, o, ++a)
    }
    ...
    function Za(t, e, n) {
        ...
        const [g,m] = Ha(f / a, c / a, h / a, d / a)
          , y = t=>Math.exp(g + m * (t - o));
        return {
            coef: [Math.exp(g - m * o), m],
            predict: y,
            rSquared: Ga(t, e, n, a, y)
        }
    }
    function Qa(t, e, n) {
        let r = 0
    ...
    function eu(t, e, n, r) {
        ...
        for (o = t - 1; o >= 0; --o)
            ...
            a = 1; a <= o; ++a)
                s *= (o + 1 - a) / a,
                i[o - a] += u * Math.pow(n, a) * s;
        return i[0] += r,
        i
    }
    function nu(t, e, n, r) {
        const [i,o,a,u] = Ya(t, e, n, !0)
          , s = i.length
          , l = Math.max(2, ~~(r * s))
    ...
    function au(t, e, n, r) {
        ...
        for (; h; ) {
            const t = i((f[0] + h[0]) / 2);
            t[0] - f[0] >= s && uu(f, t, h) > ou ? c.push(t) : (f = h,
            l.push(h),
            c.pop()),
            h = c[c.length - 1]
        }
    ...
    function uu(t, e, n) {
        const r = Math.atan2(n[1] - t[1], n[0] - t[0])
          , i = Math.atan2(e[1] - t[1], e[0] - t[0]);
        return Math.abs(r - i)
    }
    function su(t) {
        return t && t.length ? 1 === t.length ? t[0] : (e = t,
        t=>{
            const n = e.length;
            let r = 1
              , i = String(e[0](t));
    ...
    const cu = ()=>{}
      ...
      , hu = {
        ...
        mean: {
            ...
            add: (t,e)=>(t.mean_d = e - t.mean,
            t.mean += t.mean_d / t.valid),
            rem: (t,e)=>(t.mean_d = e - t.mean,
    ...
    function _u(t) {
        return this._out.forEach((e=>t[e.out] = e.value(this))),
        t
    }
    function xu(t, e) {
        const n = e || f
    ...
    wu.quartile = function(t) {
        return this._get === t && this._q || (this._q = xa(this.values(), t),
        this._get = t),
        this._q
    }
    ,
    ...
    ,
    wu.ci = function(t) {
        return this._get === t && this._ci || (this._ci = ka(this.values(), 1e3, .05, t),
        this._get = t),
        this._ci
    }
    ,
    ...
    ut(ku, pa, {
        transform(t, e) {
            const n = this
              ...
              , i = t.modified();
            return n.stamp = r.stamp,
            n.value && (i || e.modified(n._inputs, !0)) ? (n._prev = n.value,
            n.value = i ? n.init(t) : {},
            e.visit(e.SOURCE, (t=>n.add(t)))) : (n.value = n.value || n.init(t),
            e.visit(e.REM, (t=>n.rem(t))),
            e.visit(e.ADD, (t=>n.add(t)))),
            r.modifies(n._outputs),
            n._drop = !1 !== t.drop,
            t.cross && n._dims.length > 1 && (n._drop = !1,
            n.cross()),
        ...
        init(t) {
            ...
            this.cellkey = t.key ? t.key : su(this._dims),
            this._countOnly = !0,
            this._counts = [],
            this._measures = [];
            const s = t.fields || [null]
              ...
              , h = {};
            let d, p, g, m, y, v;
            for (f !== l.length && u("Unmatched number of fields and aggregate ops."),
            v = 0; v < f; ++v)
                d = s[v],
                p = l[v],
                ...
                g.push(pu(p, y))) : this._counts.push(y);
        ...
        changes(t) {
            ...
            if (r)
                for (l in r)
                    s = r[l],
                    i && !s.num || a.push(s.tuple);
            for (c = 0,
            f = this._alen; c < f; ++c)
                o.push(this.celltuple(e[c])),
                e[c] = null;
            for (c = 0,
            f = this._mlen; c < f; ++c)
                s = n[c],
                ...
                n[c] = null;
            return this._alen = this._mlen = 0,
            this._prev = null,
            t
        }
    });
    ...
    function Au(t, e, n) {
        ...
        return {
            ...
            remove: t=>a[r(t)] = ++u,
            size: ()=>i.length,
            data: (t,e)=>(u && (i = i.filter((t=>!a[r(t)])),
            a = {},
            u = 0),
            e && t && i.sort(t),
            o.length && (i = t ? vt(t, i, o.sort(t)) : i.concat(o),
            o = []),
            i)
        }
    }
    ...
    ut(Mu, pa, {
        transform(t, e) {
            const n = !1 !== t.interval
              ...
              , l = u[1];
            let c;
            return c = t.modified() ? (e = e.reflow(!0)).SOURCE : e.modified(r(t.field)) ? e.ADD_MOD : e.ADD,
            e.visit(c, n ? t=>{
                const e = i(t);
                t[s] = e,
        ...
        _bins(t) {
            ...
            null != (u = t.anchor) && (s = u - (l + a * Math.floor((u - l) / a)),
            l += s,
            c += s);
            const f = function(t) {
                let e = A(i(t));
                return null == e ? null : e < l ? -1 / 0 : e > c ? 1 / 0 : (e = Math.max(l, Math.min(e, c - a)),
    ...
    ut(Fu, pa, {
        transform(t, e) {
            const n = e=>n=>{
                for (var r, i = function(t, e, n) {
                    ...
                    return t.match(n)
                }(u(n), t.case, o) || [], s = 0, l = i.length; s < l; ++s)
                    a.test(r = i[s]) || e(r)
            }
              ...
              , l = n((t=>i[t] = 1 + (i[t] || 0)))
              , c = n((t=>i[t] -= 1));
            return r ? e.visit(e.SOURCE, l) : (e.visit(e.ADD, l),
            e.visit(e.REM, c)),
            this._finish(e, s)
        },
        _parameterCheck(t, e) {
        ...
        _finish(t, e) {
            ...
            for (u in n)
                ...
                s[i] = u,
                s[o] = l,
                a.add.push(s)) : 0 === l ? (s && a.rem.push(s),
                n[u] = null,
                r[u] = null) : s[o] !== l && (s[o] = l,
                a.mod.push(s));
            return a.modifies(e)
        }
    }),
    ...
    ut(Su, pa, {
        transform(t, e) {
            ...
            n.add = this.value = function(t, e, n, r) {
                for (var i, o, a = [], u = {}, s = t.length, l = 0; l < s; ++l)
                    for (u[e] = o = t[l],
                    i = 0; i < s; ++i)
                        u[n] = t[i],
                        r(u) && (a.push(Lo(u)),
    ...
    function zu(t, e) {
        ...
        const r = Bu[n]();
        for (const n in t)
            "field" === n ? r.data((t.from || e()).map(t[n])) : "distributions" === n ? r[n](t[n].map((t=>zu(t, e)))) : typeof r[n] === Tu && r[n](t[n]);
        return r
    }
    function Nu(t) {
        pa.call(this, null, t)
        ...
        transform(t, e) {
            ...
            if (!this.value || e.changed() || t.modified()) {
                ...
                const s = t.as || ["value", "density"]
                  , l = au(a, t.extent || tt(r.data()), i, o).map((t=>{
                    const e = {};
                    return e[s[0]] = t[0],
                    e[s[1]] = t[1],
                    Lo(e)
    ...
    ut(Iu, pa, {
        transform(t, e) {
            ...
            !Number.isFinite(a) || !Number.isFinite(u)) {
                ...
                e.dataflow.warn("Infinite extent".concat(t, ": [").concat(a, ", ").concat(u, "]")),
                a = u = void 0
            }
            this.value = [a, u]
        }
    ...
    ut($u, Go, {
        connect(t) {
            return this.detachSubflow = t.detachSubflow,
            this.targets().add(t),
            t.source = this
        },
        add(t) {
    ...
    ut(Wu, pa, {
        ...
        subflow(t, e, n, r) {
            ...
            o = n.dataflow,
            u = new $u(n.fork(n.NO_SOURCE),this),
        ...
        transform(t, e) {
            ...
            function c(e) {
                const n = Oo(e)
                  ...
                  , c = r.get(n);
                i && c ? (r.delete(n),
                o.push(e)) : i || c ? l && i && !c && u.push(e) : (r.set(n, 1),
                a.push(e))
            }
    ...
    ut(ts, pa, {
        transform(t, e) {
            var r, i, o, a, s, l, c, f, h, d, p = e.fork(e.ALL), g = function(t) {
                ...
                if (null != Qu[n])
                    return n === Qu.value ? (e = void 0 !== t.value ? t.value : 0,
                    ()=>e) : Qu[n];
                ...
                for (p.forEach(((t,e)=>g[t] = e + 1)),
                u = 0,
                c = t.length; u < c; ++u)
                    l = n(f = t[u]),
                    s = g[l] || (g[l] = p.push(l)),
                    (a = m[o = (i = e ? e.map(h) : Ku) + ""]) || (a = m[o] = [],
                    d.push(a),
                    a.values = i),
                    a[s - 1] = f;
                return d.domain = p,
            ...
            return b.length && (p.add = p.materialize(p.ADD).add.concat(b)),
    ...
    ut(es, ku, {
        transform(t, e) {
            const n = this
              , r = t.modified();
            let i;
            return n.value && (r || e.modified(n._inputs, !0)) ? (i = n.value = r ? n.init(t) : {},
            e.visit(e.SOURCE, (t=>n.add(t)))) : (i = n.value = n.value || this.init(t),
            e.visit(e.REM, (t=>n.rem(t))),
            e.visit(e.ADD, (t=>n.add(t)))),
            n.changes(),
            e.visit(e.SOURCE, (t=>{
    ...
    ut(ns, pa, {
        transform(t, e) {
            ...
            if (!this.value || e.changed() || t.modified()) {
                ...
                "shared" === t.resolve && (h || (h = tt(i, t.field)),
                d = p = t.steps || p),
                o.forEach((e=>{
                    const n = za(e, s)[l]
    ...
    ut(os, pa, {
        transform(t, e) {
            const n = e.dataflow;
            if (this._pending)
                return as(this, e, this._pending);
            if (function(t) {
                return t.modified("async") && !(t.modified("values") || t.modified("url") || t.modified("format"))
            }(t))
                return e.StopPropagation;
            if (t.values)
                return as(this, e, n.parse(t.values, t.format));
            if (t.async) {
                return {
                    async: n.request(t.url, t.format).then((t=>(this._pending = $(t.data),
                    t=>t.touch(this))))
                }
            }
    ...
    ut(us, pa, {
        transform(t, e) {
            ...
            return o ? (f = o.length,
            l > 1 && !g && u('Multi-field lookup requires explicit "as" parameter.'),
            g && g.length !== l * f && u('The "as" parameter has too few output field names.'),
            g = g || o.map(n),
            c = function(t) {
            ...
            s ? p = e.reflow(!0) : (h = r.some((t=>e.modified(t.fields))),
            d |= h ? e.MOD : 0),
            e.visit(d, c),
            p.modifies(g)
        }
    ...
    ut(hs, pa, {
        transform(t, e) {
            return this.modified(t.modified()),
            this.value = t,
    ...
    ut(ds, ku, {
        _transform: ku.prototype.transform,
        transform(t, n) {
    ...
    ut(ps, Wu, {
        transform(t, e) {
            const n = t.subflow
              , i = t.field
              , o = t=>this.subflow(Oo(t), n, e, t);
            return (t.modified("field") || i && e.modified(r(i))) && u("PreFacet does not support field modification."),
            this.initTargets(),
            i ? (e.visit(e.MOD, (t=>{
                const e = o(t);
    ...
    ut(gs, pa, {
        transform(t, e) {
            ...
            let a;
            return this.value ? a = this.value : (e = e.addAll(),
            a = this.value = {}),
            e.visit(e.REM, (t=>{
                const e = Oo(t);
                n.rem.push(a[e]),
    ...
    ut(ms, pa, {
        transform(t, e) {
            ...
            t.modified("value") ? e.fork(e.NO_SOURCE | e.NO_FIELDS) : e.StopPropagation
        }
    }),
    ys.Definition = {
        type: "Quantile",
    ...
    ut(ys, pa, {
        transform(t, e) {
            const r = e.fork(e.NO_SOURCE | e.NO_FIELDS)
              , i = t.as || ["prob", "value"];
            if (this.value && !t.modified() && !e.changed())
                return r.source = this.value,
                r;
            const o = Uu(e.materialize(e.SOURCE).source, t.groupby, t.field)
              , a = (t.groupby || []).map(n)
              , u = []
              , s = t.step || .01
              , l = t.probs || Re(s / 2, 1 - 1e-14, s)
              , c = l.length;
            return o.forEach((t=>{
                const e = _a(t, l);
                for (let n = 0; n < c; ++n) {
    ...
    ut(_s, pa, {
        transform(e, n) {
            const r = n.fork(n.NO_SOURCE)
              , i = e.modified("size")
              , o = e.size
              , a = this.value.reduce(((t,e)=>(t[Oo(e)] = 1,
            t)), {});
            let u = this.value
              , s = this.count
              , l = 0;
            function c(e) {
                let n, i;
                u.length < o ? u.push(e) : (i = ~~((s + 1) * t.random()),
                i < u.length && i >= l && (n = u[i],
                a[Oo(n)] && r.rem.push(n),
                u[i] = e)),
                ++s
            }
            ...
            u = u.filter((t=>-1 !== a[Oo(t)]))),
            (n.rem.length || i) && u.length < o && n.source && (l = s = u.length,
            n.visit(n.SOURCE, (t=>{
                a[Oo(t)] || c(t)
            }
            )),
            ...
            (n.add.length || l < 0) && (r.add = u.filter((t=>!a[Oo(t)]))),
            this.count = s,
    ...
    ut(ws, pa, {
        transform(t, e) {
            ...
            let h = a.start || 1 / 0
              , d = a.stop || -1 / 0
              , p = e.ADD;
            return (t.modified() || e.modified(r(n))) && (p = (e = e.reflow(!0)).SOURCE,
            h = 1 / 0,
            d = -1 / 0),
            e.visit(p, (t=>{
                const e = n(t);
    ...
    ut(Ms, pa, {
        transform(t, e) {
            ...
            e.visit(e.SOURCE, o)) : e.changed() ? (e.visit(e.REM, (t=>i.delete(r(t)))),
            e.visit(e.ADD, o)) : a = !1,
            this.modified(a),
    ...
    const Es = {
        ...
        ntile: function(t, e) {
            ...
            const n = Es.cume_dist()
              , r = n.next;
            return {
                init: n.init,
                next: t=>Math.ceil(e * r(t))
            }
        },
        lag: function(t, e) {
            return e = +e || 1,
        ...
        first_value: function(t) {
            return {
                next: e=>t(e.data[e.i0])
            }
        },
        last_value: function(t) {
            return {
                next: e=>t(e.data[e.i1 - 1])
            }
        },
    ...
    function Cs(t) {
        ...
        e.forEach(((t,e)=>{
            ...
            rt(Es, t))
                ...
                if (null == r && "count" !== t && u("Null aggregate field specified."),
                "count" === t)
    ...
    ut(Ss, pa, {
        transform(t, e) {
            ...
            const n = t.modified()
              ...
              , o = t=>this.group(i(t));
            let a = this.state;
            a && !n || (a = this.state = new Cs(t)),
            n || e.modified(a.inputs) ? (this.value = {},
            e.visit(e.SOURCE, (t=>o(t).add(t)))) : (e.visit(e.REM, (t=>o(t).remove(t))),
            e.visit(e.ADD, (t=>o(t).add(t))));
            for (let e = 0, n = this._mlen; e < n; ++e)
                Bs(this._mods[e], a, r, t);
            return this._mlen = 0,
            this._mods = [],
            e.reflow(n).modifies(a.outputs)
        },
        group(t) {
            let e = this.value[t];
            return e || (e = this.value[t] = Au(Oo),
            e.stamp = -1),
            e.stamp < this.stamp && (e.stamp = this.stamp,
    ...
    qs.prototype = Ps.prototype = {
            ...
            if (null === this._x1)
                ...
                if (Math.abs(c * u - s * l) > Ls && i) {
                    var h = n - o
                      ...
                      , m = Math.sqrt(p)
                      , y = Math.sqrt(f)
                      , v = i * Math.tan((Os - Math.acos((p + f - g) / (2 * m * y))) / 2)
                      , _ = v / y
                      , x = v / m;
                    Math.abs(_ - 1) > Ls && (this._ += "L" + (t + _ * l) + "," + (e + _ * c)),
                    this._ += "A" + i + "," + i + ",0,0," + +(c * h > l * d) + "," + (this._x1 = t + x * u) + "," + (this._y1 = e + x * s)
                } else
                    this._ += "L" + (this._x1 = t) + "," + (this._y1 = e);
            else
                ;
        ...
        arc: function(t, e, n, r, i, o) {
            ...
            null === this._x1 ? this._ += "M" + s + "," + l : (Math.abs(this._x1 - s) > Ls || Math.abs(this._y1 - l) > Ls) && (this._ += "L" + s + "," + l),
            n && (f < 0 && (f = f % Rs + Rs),
            f > Us ? this._ += "A" + n + "," + n + ",0,1," + c + "," + (t - a) + "," + (e - u) + "A" + n + "," + n + ",0,1," + c + "," + (this._x1 = s) + "," + (this._y1 = l) : f > Ls && (this._ += "A" + n + "," + n + ",0," + +(f >= Os) + "," + c + "," + (this._x1 = t + n * Math.cos(i)) + "," + (this._y1 = e + n * Math.sin(i))))
        },
    ...
    function dl(t, e) {
        ...
        function a(a) {
            ...
            for (null == r && (o = i(l = Ps())),
            u = 0; u <= c; ++u)
                !(u < c && n(s = a[u], u, a)) === f && ((f = !f) ? o.lineStart() : o.lineEnd()),
                f && o.point(+t(s, u, a), +e(s, u, a));
            if (l)
                return o = null,
                l + "" || null
        }
        return t = "function" == typeof t ? t : void 0 === t ? fl : js(t),
        e = "function" == typeof e ? e : void 0 === e ? hl : js(e),
        a.x = function(e) {
            return arguments.length ? (t = "function" == typeof e ? e : js(+e),
            a) : t
        }
        ,
        a.y = function(t) {
            return arguments.length ? (e = "function" == typeof t ? t : js(+t),
            a) : e
        }
        ,
        a.defined = function(t) {
            return arguments.length ? (n = "function" == typeof t ? t : js(!!t),
            a) : n
        }
        ,
        a.curve = function(t) {
    ...
    function pl(t, e, n) {
        ...
        return t = "function" == typeof t ? t : void 0 === t ? fl : js(+t),
        e = "function" == typeof e ? e : js(void 0 === e ? 0 : +e),
        n = "function" == typeof n ? n : void 0 === n ? hl : js(+n),
        s.x = function(e) {
            return arguments.length ? (t = "function" == typeof e ? e : js(+e),
            r = null,
            s) : t
        ...
        ,
        s.x1 = function(t) {
            return arguments.length ? (r = null == t ? null : "function" == typeof t ? t : js(+t),
            s) : r
        }
        ,
        s.y = function(t) {
        ...
        ,
        s.y1 = function(t) {
            return arguments.length ? (n = null == t ? null : "function" == typeof t ? t : js(+t),
            s) : n
        }
        ,
        ...
        s.defined = function(t) {
            return arguments.length ? (i = "function" == typeof t ? t : js(!!t),
            s) : i
        }
        ,
        s.curve = function(t) {
    ...
    bl.prototype = {
        ...
        lineEnd: function() {
            var t = this._x
              ...
              , n = t.length - 1;
            if (n > 0)
                for (var r, i = t[0], o = e[0], a = t[n] - i, u = e[n] - o, s = -1; ++s <= n; )
                    r = s / n,
                    this._basis.point(this._beta * t[s] + (1 - this._beta) * (i + r * a), this._beta * e[s] + (1 - this._beta) * (o + r * u));
    ...
    Il.prototype = {
        ...
        point: function(t, e) {
            ...
            (t = +t) !== this._x1 || e !== this._y1) {
                ...
                case 2:
                    this._point = 3,
                    jl(this, Pl(this, n = ql(this, t, e)), n);
                    break;
                default:
        ...
        lineEnd: function() {
            ...
            if (n)
                ...
                2 === n)
                    ...
                    for (var r = Yl(t), i = Yl(e), o = 0, a = 1; a < n; ++o,
                    ++a)
    ...
    function Kl() {
        ...
        ,
        i.range = function(t) {
            return arguments.length ? (n = Array.from(t),
            i) : n.slice()
        }
        ,
    ...
    var rc = .7
      ...
      , uc = "\\s*([+-]?\\d*\\.?\\d+(?:[eE][+-]?\\d+)?)%\\s*"
      , sc = /^#([0-9a-f]{3,8})$/
      , lc = new RegExp("^rgb\\(" + [oc, oc, oc] + "\\)$")
      , cc = new RegExp("^rgb\\(" + [uc, uc, uc] + "\\)$")
      , fc = new RegExp("^rgba\\(" + [oc, oc, oc, ac] + "\\)$")
      , hc = new RegExp("^rgba\\(" + [uc, uc, uc, ac] + "\\)$")
      , dc = new RegExp("^hsl\\(" + [ac, uc, uc] + "\\)$")
      , pc = new RegExp("^hsla\\(" + [ac, uc, uc, ac] + "\\)$")
      , gc = {
        aliceblue: 15792383,
    ...
    function bc(t) {
        return t instanceof nc || (t = vc(t)),
        t ? new kc((t = t.rgb()).r,t.g,t.b,t.opacity) : new kc
    }
    function wc(t, e, n, r) {
    ...
    function Cc(t) {
        if (t instanceof Sc)
            return new Sc(t.h,t.s,t.l,t.opacity);
        if (t instanceof nc || (t = vc(t)),
        !t)
            return new Sc;
        if (t instanceof Sc)
            return t;
        var e = (t = t.rgb()).r / 255
          ...
          , u = o - i
          , s = (o + i) / 2;
        return u ? (a = e === o ? (n - r) / u + 6 * (n < r) : n === o ? (r - e) / u + 2 : (e - n) / u + 4,
        u /= s < .5 ? o + i : 2 - o - i,
        a *= 60) : u = s > 0 && s < 1 ? 0 : a,
        new Sc(a,u,s,t.opacity)
    }
    function Fc(t, e, n, r) {
    ...
    tc(kc, wc, ec(nc, {
        brighter: function(t) {
            return t = null == t ? ic : Math.pow(ic, t),
            new kc(this.r * t,this.g * t,this.b * t,this.opacity)
        },
        darker: function(t) {
            return t = null == t ? rc : Math.pow(rc, t),
            new kc(this.r * t,this.g * t,this.b * t,this.opacity)
        },
        rgb: function() {
            return this
    ...
    tc(Sc, Fc, ec(nc, {
        brighter: function(t) {
            return t = null == t ? ic : Math.pow(ic, t),
            new Sc(this.h,this.s,this.l * t,this.opacity)
        },
        darker: function(t) {
            return t = null == t ? rc : Math.pow(rc, t),
            new Sc(this.h,this.s,this.l * t,this.opacity)
    ...
    function qc(t) {
        if (t instanceof jc)
            return new jc(t.l,t.a,t.b,t.opacity);
        if (t instanceof Gc)
            return Xc(t);
        t instanceof kc || (t = bc(t));
        var e, n, r = Hc(t.r), i = Hc(t.g), o = Hc(t.b), a = Ic((.2225045 * r + .7168786 * i + .0606169 * o) / 1);
        return r === i && i === o ? e = n = a : (e = Ic((.4360747 * r + .3850649 * i + .1430804 * o) / Nc),
        n = Ic((.0139322 * r + .0971045 * i + .7141733 * o) / Oc)),
        new jc(116 * a - 16,500 * (e - a),200 * (a - n),t.opacity)
    }
    function Pc(t, e, n, r) {
    ...
    function Yc(t) {
        if (t instanceof Gc)
            return new Gc(t.h,t.c,t.l,t.opacity);
        if (t instanceof jc || (t = qc(t)),
        0 === t.a && 0 === t.b)
            return new Gc(NaN,0 < t.l && t.l < 100 ? 0 : NaN,t.l,t.opacity);
    ...
    function Xc(t) {
        if (isNaN(t.h))
            return new jc(t.l,0,0,t.opacity);
        var e = t.h * Tc;
    ...
    function of(t) {
        if (t instanceof uf)
            return new uf(t.h,t.s,t.l,t.opacity);
        t instanceof kc || (t = bc(t));
        var e = t.r / 255
          , n = t.g / 255
          , r = t.b / 255
          , i = (rf * r + ef * e - nf * n) / (rf + ef - nf)
          , o = r - i
          , a = (tf * (n - i) - Qc * o) / Kc
          , u = Math.sqrt(a * a + o * o) / (tf * i * (1 - i))
    ...
    tc(uf, af, ec(nc, {
        brighter: function(t) {
            return t = null == t ? ic : Math.pow(ic, t),
            new uf(this.h,this.s,this.l * t,this.opacity)
        },
        darker: function(t) {
            return t = null == t ? rc : Math.pow(rc, t),
            new uf(this.h,this.s,this.l * t,this.opacity)
        ...
        rgb: function() {
            var t = isNaN(this.h) ? 0 : (this.h + 120) * Tc
              , e = +this.l
    ...
    var mf = function t(e) {
        var n = pf(e);
        function r(t, e) {
            var r = n((t = wc(t)).r, (e = wc(e)).r)
              , i = n(t.g, e.g)
              , o = n(t.b, e.b)
              , a = gf(t.opacity, e.opacity);
            return function(e) {
                return t.r = r(e),
                t.g = i(e),
                t.b = o(e),
    ...
    var Ef = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g
      , Df = new RegExp(Ef.source,"g");
    function Cf(t, e) {
        var n, r, i, o = Ef.lastIndex = Df.lastIndex = 0, a = -1, u = [], s = [];
        for (t += "",
        e += ""; (n = Ef.exec(t)) && (r = Df.exec(e)); )
    ...
    function Ff(t, e) {
        var n, r = typeof e;
        return null == e || "boolean" === r ? ff(e) : ("number" === r ? Mf : "string" === r ? (n = vc(e)) ? (e = n,
        mf) : Cf : e instanceof vc ? mf : e instanceof Date ? kf : bf(e) ? xf : Array.isArray(e) ? wf : "function" != typeof e.valueOf && "function" != typeof e.toString || isNaN(e) ? Af : Mf)(t, e)
    }
    function Sf(t, e) {
        return t = +t,
        e = +e,
    ...
    var Rf = Of((function(t) {
      ...
      , Lf = Of((function(t) {
        return null == t ? zf : (Bf || (Bf = document.createElementNS("http://www.w3.org/2000/svg", "g")),
        Bf.setAttribute("transform", t),
        (t = Bf.transform.baseVal.consolidate()) ? Nf((t = t.matrix).a, t.b, t.c, t.d, t.e, t.f) : zf)
    }
    ), ", ", ")", ")");
    function Uf(t) {
    ...
    var qf = function t(e, n, r) {
        function i(t, i) {
            var o, a, u = t[0], s = t[1], l = t[2], c = i[0], f = i[1], h = i[2], d = c - u, p = f - s, g = d * d + p * p;
            if (g < 1e-12)
                a = Math.log(h / l) / e,
                o = function(t) {
            ...
            return o.duration = 1e3 * a * e / Math.SQRT2,
            o
        }
    ...
    function Pf(t) {
        return function(e, n) {
            var r = t((e = Fc(e)).h, (n = Fc(n)).h)
              , i = gf(e.s, n.s)
              , o = gf(e.l, n.l)
              , a = gf(e.opacity, n.opacity);
            return function(t) {
                return e.h = r(t),
                e.s = i(t),
                e.l = o(t),
    ...
    var Jf = Object.freeze({
        ...
        interpolateLab: function(t, e) {
            var n = gf((t = Pc(t)).l, (e = Pc(e)).l)
              , r = gf(t.a, e.a)
              , i = gf(t.b, e.b)
              , o = gf(t.opacity, e.opacity);
            return function(e) {
                return t.l = n(e),
                t.a = r(e),
                t.b = i(e),
    ...
    function ih() {
        ...
        ,
        f.domain = function(t) {
            return arguments.length ? (a = Array.from(t, Zf),
            c()) : a.slice()
        }
        ,
        f.range = function(t) {
        ...
        ,
        f.clamp = function(t) {
            return arguments.length ? (l = !!t || Kf,
            c()) : l !== Kf
        }
        ,
    ...
    function ah(t, e, n, r) {
        ...
        case "s":
            ...
            return null != r.precision || isNaN(i = tn(o, a)) || (r.precision = i),
            Xe(r, a);
        case "":
        case "e":
        case "g":
    ...
    function gh(t) {
        ...
        r.ticks = function(t) {
            ...
            if (!(o % 1) && d - h < p) {
                ...
                g = Ae(h, d, Math.min(d - h, p)).map(n);
            return r ? g.reverse() : g
        }
        ,
        r.tickFormat = function(t, i) {
            if (null == i && (i = 10 === o ? ".0e" : ","),
            "function" != typeof i && (i = Ge(i)),
            t === 1 / 0)
                return i;
            null == t && (t = 10);
    ...
    function Th(t, e, n, r, i, o, a, u, s) {
        ...
        function w(e, n, r) {
            ...
            "number" == typeof e) {
                ...
                return a === x.length ? (i = De(n / Fh, r / Fh, e),
                e = t) : a ? (i = (a = x[o / x[a - 1][2] < x[a][2] / o ? a - 1 : a])[1],
                e = a[0]) : (i = Math.max(De(n, r, e), 1),
                e = u),
                e.every(i)
            }
            return e
    ...
    function zh() {
        ...
        function l(e) {
            return isNaN(e = +e) ? i : u(0 === n ? .5 : (e = (r(e) - t) * n,
    ...
    function Lh() {
        ...
        function d(t) {
            return isNaN(t = +t) ? a : (t = .5 + ((t = +o(t)) - e) * (c * t < c * e ? r : i),
            f(h ? Math.max(0, Math.min(1, t)) : t))
        }
        function p(t) {
            return function(e) {
                var n, r, i;
                return arguments.length ? ([n,r,i] = e,
                f = Xf(t, [n, r, i]),
                d) : [f(0), f(.5), f(1)]
            }
        }
        return d.domain = function(a) {
            return arguments.length ? ([u,s,l] = a,
            t = o(u = +u),
            e = o(s = +s),
            n = o(l = +l),
            r = t === e ? 0 : .5 / (e - t),
    ...
    function ud() {
        ...
        t.invertRange = function(t) {
            ...
            return f != f || h != h || (h < f && (c = f,
            f = h,
            h = c),
            h < a[0] || f > o[1 - r]) ? void 0 : (s = Math.max(0, _e(a, f) - 1),
            l = f === h ? s : _e(a, h) - 1,
            f - a[s] > i + 1e-10 && ++s,
            r && (c = s,
            s = u - l,
            ...
            return n.invertRange || (n.invertRange = n.invert ? function(t) {
                ...
                return function(e) {
                    ...
                    a = n.length; o < a; ++o)
                        ...
                        r = o);
                    if (!(l < 0))
                        return u = t.invertExtent(n[l]),
                        s = t.invertExtent(n[r]),
                        [void 0 === u[0] ? u[1] : u[0], void 0 === s[1] ? s[0] : s[1]]
                }
            }(n) : void 0),
            n.type = t,
            n
        };
        return r.metadata = Dt($(n)),
        r
    }
    function pd(t, e, n) {
        return arguments.length > 1 ? (hd[t] = dd(t, e, n),
        this) : gd(t) ? hd[t] : void 0
    }
    function gd(t) {
        return rt(hd, t)
    }
    ...
    pd("identity", (function t(e) {
        ...
        r.domain = r.range = function(t) {
            return arguments.length ? (e = Array.from(t, Zf),
            r) : e.slice()
        }
        ,
        ...
        ,
        e = arguments.length ? Array.from(e, Zf) : [0, 1],
        uh(r)
    }
    )),
    pd(Ph, (function t() {
    ...
    pd(Vh, Oh, [nd, od]),
    pd("".concat(Vh, "-").concat(Ph), Oh, [nd, od]),
    pd("".concat(Vh, "-").concat(jh), (function t() {
    ...
    pd("".concat(Vh, "-").concat(Ih), Rh, [nd, od]),
    pd("".concat(Vh, "-").concat($h), (function() {
        return Rh.apply(null, arguments).exponent(.5)
    }
    ), [nd, od]),
    pd("".concat(Vh, "-").concat(Wh), (function t() {
        var e = vh(zh());
        return e.copy = function() {
    ...
    pd("".concat(Gh, "-").concat(Ph), (function t() {
        var e = uh(Lh()(Kf));
        return e.copy = function() {
            return Nh(e, t())
        }
    ...
    pd("".concat(Gh, "-").concat(jh), (function t() {
    ...
    pd("".concat(Gh, "-").concat(Ih), Uh, [nd, od]),
    pd("".concat(Gh, "-").concat($h), (function() {
        return Uh.apply(null, arguments).exponent(.5)
    }
    ), [nd, od]),
    pd("".concat(Gh, "-").concat(Wh), (function t() {
        var e = vh(Lh());
        return e.copy = function() {
            return Nh(e, t()).constant(e.constant())
        }
    ...
    pd(ed, (function t() {
        ...
        return r.domain = function(t) {
            return arguments.length ? (e = cd(t),
            r) : e.slice()
        }
        ,
        r.range = function(t) {
            return arguments.length ? (n = fd.call(t),
            r) : n.slice()
        }
        ,
    ...
    function Dd(t, e, n) {
        const r = n - e;
        let i, o, a;
        return r && Number.isFinite(r) ? (i = (o = t.type).indexOf("-"),
        o = i < 0 ? o : o.slice(i + 1),
        a = pd(o)().domain([e, n]).range([0, 1]),
        kd.forEach((e=>t[e] ? a[e](t[e]()) : 0)),
        a) : Z(.5)
    }
    function Cd(t, e) {
    ...
    const zd = "symbol"
      , Nd = t=>v(t) ? t.map((t=>String(t))) : String(t)
      , Od = (t,e)=>t[1] - e[1]
      , Rd = (t,e)=>e[1] - t[1];
    function Ld(t, e, n) {
        let r;
        return ht(e) && (t.bins && (e = Math.max(e, t.bins.length)),
        null != n && (e = Math.min(e, Math.floor(bt(t.domain()) / n || 1)))),
        _(e) && (r = e.step,
        e = e.interval),
        pt(e) && (e = t.type === Hh ? yr(e) : t.type == Yh ? vr(e) : u("Only time and utc scales accept interval strings."),
        r && (e = e.every(r))),
        e
    }
    function Ud(t, e, n) {
        ...
        i = Math.floor(i),
        o = Math.ceil(o),
        e = e.map((e=>[e, t(e)])).filter((t=>i <= t[1] && t[1] <= o)).sort(a).map((t=>t[0])),
        n > 0 && e.length > 1) {
            const t = [e[0], M(e)];
            for (; e.length > n && e.length >= 3; )
                e = e.filter(((t,e)=>!(e % 2)));
            e.length < 3 && (e = t)
        }
        return e
    ...
    function Zd(t, e, n, r) {
        ...
        return pt(n) && function(t) {
            return md(t, ad)
        }(i) && (n = n.replace(/%a/g, "%A").replace(/%b/g, "%B")),
        n || i !== Hh ? n || i !== Yh ? Hd(t, e, 5, null, n, r, !0) : t.utcFormat("%A, %d %B %Y, %X UTC") : t.timeFormat("%A, %d %B %Y, %X")
    }
    function Qd(t, e, n) {
        n = n || {};
        const r = Math.max(3, n.maxlen || 7)
          , i = Zd(t, e, n.format, n.formatType);
        if (_d(e.type)) {
            const t = Wd(e).slice(1).map(i)
              , n = t.length;
    ...
    function np(t, e, n) {
        ...
        let i = t.id
          , o = "radial" === r ? tp : "";
        return i || (i = t.id = "gradient_" + Kd++,
        "radial" === r ? (t.x1 = rp(t.x1, .5),
        t.y1 = rp(t.y1, .5),
        t.r1 = rp(t.r1, 0),
        t.x2 = rp(t.x2, .5),
        t.y2 = rp(t.y2, .5),
    ...
    function lp(t) {
        ...
        c = h.length; s < c; ++s) {
            for (n = h[s],
            r = n.slice(1).trim().replace(sp[2], "$1###$2").replace(sp[3], "$1###$2").split(sp[4]),
            a = n.charAt(0),
            i = [a],
            l = 0,
            f = r.length; l < f; ++l)
                (o = +r[l]) === o && i.push(o);
            if (u = up[a.toLowerCase()],
            i.length - 1 > u) {
                const t = i.length;
                for (l = 1,
                e.push([a].concat(i.slice(l, l += u))),
                a = "M" === a ? "L" : "m" === a ? "l" : a; l < t; l += u)
                    e.push([a].concat(i.slice(l, l + u)))
            } else
                e.push(i)
        }
    ...
    function xp(t, e, n, r, i, o) {
        ...
        for (var m = 0, y = e.length; m < y; ++m) {
            ...
            case "c":
                ...
                p = h + a[3],
                g = d + a[4],
                t.bezierCurveTo(h + a[1] + n, d + a[2] + r, p + n, g + r, u + n, s + r),
                h = u,
                d = s;
                break;
            case "C":
            ...
            case "s":
                ...
                p = 2 * h - p,
                g = 2 * d - g,
                t.bezierCurveTo(p + n, g + r, h + a[1] + n, d + a[2] + r, u + n, s + r),
                p = h + a[1],
                g = d + a[2],
                h = u,
                d = s;
            ...
            case "t":
                u = h + a[1],
                s = d + a[2],
                null === f[0].match(/[QqTt]/) ? (p = h,
                g = d) : "t" === f[0] ? (p = 2 * h - l,
                g = 2 * d - c) : "q" === f[0] && (p = 2 * h - p,
                g = 2 * d - g),
                l = p,
                c = g,
                t.quadraticCurveTo(p + n, g + r, u + n, s + r),
            ...
            case "T":
                ...
                break;
            case "a":
                bp(t, h + n, d + r, [a[1], a[2], a[3], a[4], a[5], a[6] + h + n, a[7] + d + r]),
                h += a[6],
                d += a[7];
                break;
            case "A":
                bp(t, h + n, d + r, [a[1], a[2], a[3], a[4], a[5], a[6] + n, a[7] + r]),
                h = a[6],
                d = a[7];
                break;
            case "z":
    ...
    function bp(t, e, n, r) {
        const i = function(t, e, n, r, i, o, a, u, s) {
            ...
            const S = Math.ceil(Math.abs(F / (fp + .001)))
              , B = [];
            for (let t = 0; t < S; ++t) {
                const e = C + t * F / S
                  , i = C + (t + 1) * F / S;
    ...
    function zp() {
        var t = Dp
          ...
          , s = null;
        function l(l, c, f) {
            var h, d = null != c ? c : +t.call(this, l), p = null != f ? f : +e.call(this, l), g = +n.call(this, l), m = +r.call(this, l), y = Math.min(g, m) / 2, v = Tp(+i.call(this, l), 0, y), _ = Tp(+o.call(this, l), 0, y), x = Tp(+a.call(this, l), 0, y), b = Tp(+u.call(this, l), 0, y);
            if (s || (s = h = Ps()),
            v <= 0 && _ <= 0 && x <= 0 && b <= 0)
                s.rect(d, p, g, m);
            else {
                ...
                s.moveTo(d + v, p),
                s.lineTo(w - _, p),
                s.bezierCurveTo(w - Ep * _, p, w, p + Ep * _, w, p + _),
                s.lineTo(w, k - b),
                s.bezierCurveTo(w, k - Ep * b, w - Ep * b, k, w - b, k),
                s.lineTo(d + x, k),
                s.bezierCurveTo(d + Ep * x, k, d, k - Ep * x, d, k - x),
                s.lineTo(d, p + v),
                s.bezierCurveTo(d, p + Ep * v, d + Ep * v, p, d + v, p),
                s.closePath()
            }
            if (h)
                return s = null,
        ...
        return l.x = function(e) {
            return arguments.length ? (t = Bp(e),
            l) : t
        }
        ,
        l.y = function(t) {
            return arguments.length ? (e = Bp(t),
            l) : e
        }
        ,
        l.width = function(t) {
            return arguments.length ? (n = Bp(t),
            l) : n
        }
        ,
        l.height = function(t) {
            return arguments.length ? (r = Bp(t),
            l) : r
        }
        ,
        l.cornerRadius = function(t, e, n, r) {
            return arguments.length ? (i = Bp(t),
            o = null != e ? Bp(e) : i,
            u = null != n ? Bp(n) : i,
            a = null != r ? Bp(r) : o,
            l) : i
        ...
        l.context = function(t) {
            return arguments.length ? (s = null == t ? null : t,
            l) : s
        }
        ,
        l
    ...
    const Rp = t=>t.x || 0
      ...
      , qp = function() {
        var t = el
          ...
          , u = null;
        function s() {
            var s, l, c = +t.apply(this, arguments), f = +e.apply(this, arguments), h = i.apply(this, arguments) - Zs, d = o.apply(this, arguments) - Zs, p = Is(d - h), g = d > h;
            if (u || (u = s = Ps()),
            f < c && (l = f,
            f = c,
            c = l),
            f > Xs)
                if (p > Qs - Xs)
                    u.moveTo(f * Ws(h), f * Vs(h)),
                    u.arc(0, 0, f, h, d, !g),
                    c > Xs && (u.moveTo(c * Ws(d), c * Vs(d)),
                    u.arc(0, 0, c, d, h, g));
                else {
                    var m, y, v = h, _ = d, x = h, b = d, w = p, k = p, M = a.apply(this, arguments) / 2, A = M > Xs && (r ? +r.apply(this, arguments) : Gs(c * c + f * f)), E = Ys(Is(f - c) / 2, +n.apply(this, arguments)), D = E, C = E;
                    if (A > Xs) {
                        var F = tl(A / c * Vs(M))
                          , S = tl(A / f * Vs(M));
                        (w -= 2 * F) > Xs ? (x += F *= g ? 1 : -1,
                    ...
                    k > Xs ? C > Xs ? (m = ul(U, q, B, T, f, C, g),
                    y = ul(R, L, z, N, f, C, g),
                    u.moveTo(m.cx + m.x01, m.cy + m.y01),
                    C < E ? u.arc(m.cx, m.cy, C, $s(m.y01, m.x01), $s(y.y01, y.x01), !g) : (u.arc(m.cx, m.cy, C, $s(m.y01, m.x01), $s(m.y11, m.x11), !g),
                    u.arc(0, 0, f, $s(m.cy + m.y11, m.cx + m.x11), $s(y.cy + y.y11, y.cx + y.x11), !g),
                    u.arc(y.cx, y.cy, C, $s(y.y11, y.x11), $s(y.y01, y.x01), !g))) : (u.moveTo(B, T),
                    u.arc(0, 0, f, v, _, !g)) : u.moveTo(B, T),
                    c > Xs && w > Xs ? D > Xs ? (m = ul(z, N, R, L, c, -D, g),
                    y = ul(B, T, U, q, c, -D, g),
                    u.lineTo(m.cx + m.x01, m.cy + m.y01),
                    D < E ? u.arc(m.cx, m.cy, D, $s(m.y01, m.x01), $s(y.y01, y.x01), !g) : (u.arc(m.cx, m.cy, D, $s(m.y01, m.x01), $s(m.y11, m.x11), !g),
                    u.arc(0, 0, c, $s(m.cy + m.y11, m.cx + m.x11), $s(y.cy + y.y11, y.cx + y.x11), g),
                    u.arc(y.cx, y.cy, D, $s(y.y11, y.x11), $s(y.y01, y.x01), !g))) : u.arc(0, 0, c, b, x, g) : u.lineTo(z, N)
                }
            else
                u.moveTo(0, 0);
            if (u.closePath(),
        ...
        s.endAngle = function(t) {
            return arguments.length ? (o = "function" == typeof t ? t : js(+t),
            s) : o
        }
        ,
        s.padAngle = function(t) {
            return arguments.length ? (a = "function" == typeof t ? t : js(+t),
            s) : a
        }
        ,
        s.context = function(t) {
      ...
      , Wp = function(t, e) {
        ...
        return t = "function" == typeof t ? t : js(t || gl),
        e = "function" == typeof e ? e : js(void 0 === e ? 64 : +e),
        r.type = function(e) {
            return arguments.length ? (t = "function" == typeof e ? e : js(e),
            r) : t
        }
    ...
    function Jp(t, e, n) {
        var r = e.clip
          , i = t._defs
          , o = e.clip_id || (e.clip_id = "clip" + Gp++)
          , a = i.clipping[o] || (i.clipping[o] = {
            id: o
        });
        return H(r) ? a.path = r(null) : Yp(n) ? a.path = Vp(null, n, 0, 0) : (a.width = n.width || 0,
        a.height = n.height || 0),
        "url(#" + o + ")"
    }
    function Zp(t) {
    ...
    function Qp(t) {
        this.mark = t,
        this.bounds = this.bounds || new Zp
    }
    function Kp(t) {
        Qp.call(this, t),
    ...
    Zp.prototype = {
        ...
        round() {
            return this.x1 = Math.floor(this.x1),
        ...
        union(t) {
            return t.x1 < this.x1 && (this.x1 = t.x1),
    ...
    const dg = (t,e)=>og.add(t, e)
      , pg = (t,e)=>dg(ag = t, ug = e)
      , gg = t=>dg(t, og.y1)
      , mg = t=>dg(og.x1, t)
      , yg = (t,e)=>lg * t + fg * e
      , vg = (t,e)=>cg * t + hg * e
      , _g = (t,e)=>dg(yg(t, e), vg(t, e))
      , xg = (t,e)=>pg(yg(t, e), vg(t, e));
    function bg(t, e) {
        return og = t,
        e ? (sg = e * cp,
        lg = hg = Math.cos(sg),
    ...
    function Mg(t, e, n, r, i) {
        const o = r - t + 3 * e - 3 * n
          ...
          , u = t - e;
        let s, l = 0, c = 0;
        Math.abs(o) > 1e-14 ? (s = a * a + u * o,
        s >= 0 && (s = Math.sqrt(s),
        l = (-a + s) / o,
        c = (-a - s) / o)) : l = .5 * u / a,
        0 < l && l < 1 && i(Ag(l, t, e, n, r)),
        0 < c && c < 1 && i(Ag(c, t, e, n, r))
    }
    ...
    function Cg(t) {
        return function(e, n) {
            if (!Eg)
                return !0;
            t(Eg, e),
            Dg.clear().union(e.bounds).intersect(n).round();
            const {x1: r, y1: i, x2: o, y2: a} = Dg;
            for (let t = i; t <= a; ++t)
                for (let e = r; e <= o; ++e)
                    if (Eg.isPointInPath(e, t))
                        return !0;
            return !1
        }
    }
    ...
    function Og(t, e) {
        const n = e.length;
        for (let r = 0; r < n; ++r)
            t.addColorStop(e[r].offset, e[r].color);
        return t
    }
    function Rg(t, e, n) {
        return ep(n) ? function(t, e, n) {
            ...
            if ("radial" === e.gradient)
                o = t.createRadialGradient(n.x1 + Ng(e.x1, .5) * r, n.y1 + Ng(e.y1, .5) * i, Math.max(r, i) * Ng(e.r1, 0), n.x1 + Ng(e.x2, .5) * r, n.y1 + Ng(e.y2, .5) * i, Math.max(r, i) * Ng(e.r2, .5));
            else {
                const a = Ng(e.x1, 0)
                  , u = Ng(e.y1, 0)
                  , s = Ng(e.x2, 1)
                  , l = Ng(e.y2, 0);
                if (a !== s && u !== l && r !== i) {
                    const n = Gl(Math.ceil(r), Math.ceil(i))
                      , o = n.getContext("2d");
                    return o.scale(r, i),
                    o.fillStyle = Og(o.createLinearGradient(a, u, s, l), e.stops),
                    o.fillRect(0, 0, r, i),
    ...
    function Yg(t, e, n, r) {
        ...
        0 !== i && (t(e, r) || (zg(e, n),
        n.fill && Lg(e, n, i) && e.fill(),
        n.stroke && qg(e, n, i) && e.stroke()))
    }
    function Vg(t) {
        return t = t || p,
        function(e, n, r, i, o, a) {
            return r *= e.pixelRatio,
            i *= e.pixelRatio,
            $g(n, (n=>{
                const u = n.bounds;
    ...
    function Gg(t, e) {
        return function(n, r, i, o) {
            ...
            return c && (a = s.strokeWidth,
            u = s.strokeCap,
            n.lineWidth = null != a ? a : 1,
            n.lineCap = null != u ? u : "butt"),
            !t(n, r) && (l && n.isPointInPath(i, o) || c && n.isPointInStroke(i, o))
        }
    }
    function Xg(t) {
        return Vg(Gg(t))
    ...
    function Kg(t, e, n) {
        ...
        return {
            ...
            bound: function(t, n) {
                return e(bg(t, n.angle), n),
                rg(t, n).translate(n.x || 0, n.y || 0)
            },
            draw: Wg(r),
            pick: Xg(r),
            isect: n || Cg(r)
    ...
    function em(t, e, n) {
        ...
        return {
            ...
            pick: function(t, e, n, r, o, a) {
                var u = e.items
                  , s = e.bounds;
                return !u || !u.length || s && !s.contains(o, a) ? null : (n *= t.pixelRatio,
                r *= t.pixelRatio,
                i(t, u, n, r) ? u[0] : null)
            },
            isect: Fg,
    ...
    var nm = em("area", (function(t, e) {
        ...
        for (var n, r, i = "horizontal" === t[0].orient ? e[1] : e[0], o = "horizontal" === t[0].orient ? "y" : "x", a = t.length, u = 1 / 0; --a >= 0; )
            !1 !== t[a].defined && (r = Math.abs(t[a][o] - i)) < u && (u = r,
            n = t[a]);
        return n
    }
    ));
    function rm(t, e) {
        t.beginPath(),
        Yp(e) ? Vp(t, e, 0, 0) : t.rect(0, 0, e.width || 0, e.height || 0),
        t.clip()
    }
    function im(t) {
    ...
    var cm = {
        ...
        draw: function(t, e, n) {
            Ig(e, (e=>{
                ...
                (e.stroke || e.fill) && a && (am(t, e, r, i),
                zg(t, e),
                e.fill && Lg(t, e, a) && t.fill(),
                e.stroke && !o && qg(t, e, a) && t.stroke()),
                t.save(),
                t.translate(r, i),
                e.clip && rm(t, e),
                n && n.translate(-r, -i),
        ...
        pick: function(t, e, n, r, i, o) {
            if (e.bounds && !e.bounds.contains(i, o) || !e.items)
                return null;
            ...
            return $g(e, (s=>{
                ...
                const m = s.strokeForeground
                  , y = !1 !== e.interactive;
                return y && m && s.stroke && sm(t, s, a, u) ? (t.restore(),
                s) : (l = $g(s, (t=>function(t, e, n) {
                    return (!1 !== t.interactive || "group" === t.marktype) && t.bounds && t.bounds.contains(e, n)
                }(t, c, f) ? this.pick(t, n, r, c, f) : null)),
                !l && y && (s.fill || !m && s.stroke) && um(t, s, a, u) && (l = s),
                t.restore(),
                l || null)
            }
            ))
    ...
    var ym = {
        ...
        attr: function(t, e, n) {
            const r = hm(e, n)
              , i = dm(e, r)
              , o = pm(e, r)
              , a = (e.x || 0) - gm(e.align, i)
              , u = (e.y || 0) - mm(e.baseline, o);
            t("href", !r.src && r.toDataURL ? r.toDataURL() : r.src || "", fm["xmlns:xlink"], "xlink:href"),
            t("transform", Jg(a, u)),
            t("width", i),
            t("height", o),
        ...
        draw: function(t, e, n) {
            Ig(e, (e=>{
                if (n && !n.intersects(e.bounds))
                    return;
                const r = hm(e, this);
                let i, o, a, u, s = dm(e, r), l = pm(e, r), c = (e.x || 0) - gm(e.align, s), f = (e.y || 0) - mm(e.baseline, l);
                !1 !== e.aspect && (o = r.width / r.height,
                a = e.width / e.height,
                o == o && a == a && o !== a && (a < o ? (u = s / o,
                f += (l - u) / 2,
                l = u) : (u = l * o,
                c += (s - u) / 2,
                s = u))),
                (r.complete || r.toDataURL) && (zg(t, e),
                t.globalAlpha = null != (i = e.opacity) ? i : 1,
                t.imageSmoothingEnabled = !1 !== e.smooth,
                t.drawImage(r, c, f, s, l))
            }
            ))
        },
        pick: Vg(),
      ...
      , vm = em("line", (function(t, e) {
        ...
        for (var n, r, i = Math.pow(t[0].strokeWidth || 1, 2), o = t.length; --o >= 0; )
            if (!1 !== t[o].defined && (n = t[o].x - e[0]) * n + (r = t[o].y - e[1]) * r < i)
                return t[o];
        return null
    }
    ));
    function _m(t, e) {
        ...
        var r = e.x || 0
          ...
          , u = (e.angle || 0) * cp
          , s = e.pathCache;
        s && s.path === n || ((e.pathCache = s = lp(n)).path = n),
        u && t.rotate && t.translate ? (t.translate(r, i),
        t.rotate(u),
        xp(t, s, 0, 0, o, a),
        t.rotate(-u),
        t.translate(-r, -i)) : xp(t, s, r, i, o, a)
    }
    var xm = {
        type: "path",
        tag: "path",
        ...
        attr: function(t, e) {
            ...
            t("transform", function(t) {
                return Jg(t.x || 0, t.y || 0) + (t.angle ? " " + Zg(t.angle) : "") + (t.scaleX || t.scaleY ? " " + (e = t.scaleX || 1,
                n = t.scaleY || 1,
                "scale(" + e + "," + n + ")") : "");
                var e, n
            }(e)),
    ...
    function km(t, e, n) {
        var r, i, o, a;
        return !(!e.stroke || !qg(t, e, n)) && (r = e.x || 0,
        i = e.y || 0,
        o = null != e.x2 ? e.x2 : r,
        a = null != e.y2 ? e.y2 : i,
        t.beginPath(),
    ...
    function zm(t, e) {
        ...
        let r = Dm.get(n);
        return void 0 === r && (Eg.font = e,
        r = Eg.measureText(t).width,
        Dm.set(n, r)),
        r
    }
    function Nm(t) {
    ...
    function Rm(t) {
        return e = t.lineBreak && t.text && !v(t.text) ? t.text.split(t.lineBreak) : t.text,
    ...
    function Hm(t, e, n) {
        var r, i = Cm.height(e), o = e.align, a = Wm(e), u = a.x1, s = a.y1, l = e.dx || 0, c = (e.dy || 0) + jm(e) - Math.round(.8 * i), f = Rm(e);
        if (v(f) ? (i += Om(e) * (f.length - 1),
        r = f.reduce(((t,n)=>Math.max(t, Cm.width(e, n))), 0)) : r = Cm.width(e, f),
        "center" === o ? l -= r / 2 : "right" === o && (l -= r),
        t.set(l += u, c += s, l + r, c + i),
        e.angle && !n)
            t.rotate(e.angle * cp, u, s);
        else if (2 === n)
            return t.rotatedPoints(e.angle * cp, u, s);
        return t
    }
    var Ym = {
        arc: tm,
        ...
        text: {
            ...
            attr: function(t, e) {
                ...
                t("text-anchor", Im[e.align] || "start"),
                s ? (n = Jg(a, u) + " " + Zg(s),
                (r || i) && (n += " " + Jg(r, i))) : n = Jg(a + r, u + i),
                t("transform", n)
            },
            bound: Hm,
            draw: function(t, e, n) {
                Ig(e, (e=>{
                    ...
                    if (!(n && !n.intersects(e.bounds) || 0 === c || e.fontSize <= 0 || null == e.text || 0 === e.text.length)) {
                        ...
                        v(s))
                            ...
                            a = 0; a < s.length; ++a)
                                l = Um(e, s[a]),
                                e.fill && Lg(t, e, c) && t.fillText(l, i, o),
                                e.stroke && qg(t, e, c) && t.strokeText(l, i, o),
                                o += u;
                        else
                            l = Um(e, s),
                            e.fill && Lg(t, e, c) && t.fillText(l, i, o),
        ...
        trail: em("trail", (function(t, e) {
            ...
            for (var n, r, i = t.length; --i >= 0; )
                if (!1 !== t[i].defined && (n = t[i].x - e[0]) * n + (r = t[i].y - e[1]) * r < (n = t[i].size || 1) * n)
                    return t[i];
            return null
        }
        ))
    ...
    function Vm(t, e, n) {
        var r = Ym[t.mark.marktype]
          , i = e || r.bound;
        return r.nested && (t = t.mark),
        i(t.bounds || (t.bounds = new Zp), t, n)
    }
    var Gm = {
        mark: null
    };
    function Xm(t, e, n) {
        ...
        if (u.nested)
            return c ? o = l[0] : (Gm.mark = t,
            o = Gm),
            a = Vm(o, s, n),
            e = e && e.union(a) || a;
        if (e = e || t.bounds && t.bounds.clear() || new Zp,
        c)
            for (r = 0,
            i = l.length; r < i; ++r)
                e.union(Vm(l[r], s, n));
    ...
    function ey(t, e) {
        ...
        return null != t.aria && (n.aria = t.aria),
    ...
    function ry(t, e) {
        ...
        for (var n = t.childNodes, r = 0, i = n.length; r < i; ++r)
            if (n[r].tagName.toLowerCase() === e)
                return n[r]
    }
    function iy(t, e, n, r) {
        var i, o = t.childNodes[e];
        return o && o.tagName.toLowerCase() === n.toLowerCase() || (i = o || null,
        o = ny(t.ownerDocument, n, r),
        t.insertBefore(o, i)),
        o
    }
    function oy(t, e) {
    ...
    sy.prototype = {
        ...
        origin(t) {
            return arguments.length ? (this._origin = t || [0, 0],
            this) : this._origin.slice()
        },
        scene(t) {
            return arguments.length ? (this._scene = t,
            this) : this._scene
        },
        on() {},
        off() {},
    ...
    cy.prototype = {
        ...
        background(t) {
            return 0 === arguments.length ? this._bgcolor : (this._bgcolor = t,
            this)
        },
        resize(t, e, n, r) {
    ...
    ut(Ey, sy, {
        initialize(t, e, n) {
            return this._canvas = t && ry(t, "canvas"),
            [vy, py, gy, my, hy].forEach((t=>Dy(this, t))),
            sy.prototype.initialize.call(this, t, e, n)
        },
        canvas() {
            return this._canvas
        },
        ...
        click(t) {
            this._down === this._active && (this.fire(vy, t),
            this._down = null)
        },
        touchstart(t) {
            this._touch = this.pickEvent(t.changedTouches[0]),
            this._first && (this._active = this._touch,
            this._first = !1),
            this.fire(xy, t, !0)
        },
        touchmove(t) {
        ...
        fire(t, e, n) {
            const r = n ? this._touch : this._active
              , i = this._handlers[t];
            if (e.vegaType = t,
            t === Ay && r && r.href ? this.handleHref(e, r, r.href) : t !== ky && t !== My || this.handleTooltip(e, r, t !== My),
            i)
        ...
        on(t, e) {
            const n = this.eventName(t)
              , r = this._handlers;
            return this._handlerIndex(r[n], t, e) < 0 && (Dy(this, t),
            (r[n] || (r[n] = [])).push({
                type: t,
                handler: e
            })),
        ...
        off(t, e) {
            ...
            return i >= 0 && r.splice(i, 1),
            this
        },
        pickEvent(t) {
            const e = uy(t, this._canvas)
              , n = this._origin;
    ...
    ut(By, cy, {
        initialize(t, e, n, r, i, o) {
            ...
            this._canvas = this._options.externalContext ? null : Gl(1, 1, this._options.type),
            t && this._canvas && (oy(t, 0).appendChild(this._canvas),
            this._canvas.setAttribute("class", "marks")),
            Ty.initialize.call(this, t, e, n, r, i)
        },
        resize(t, e, n, r) {
            if (Ty.resize.call(this, t, e, n, r),
            this._canvas)
        ...
        _render(t) {
            ...
            e.save();
            const u = this._redraw || o.empty() ? (this._redraw = !1,
            a.expand(1)) : function(t, e, n) {
                return e.expand(1).round(),
                t.pixelRatio % 1 && e.scale(t.pixelRatio).round().scale(1 / t.pixelRatio),
        ...
        clear(t, e, n, r) {
            ...
            null != this._bgcolor && (o.fillStyle = this._bgcolor,
            o.fillRect(t, e, n, r))
        }
    });
    const Ny = (t,e)=>n=>{
    ...
    ut(zy, sy, {
        initialize(t, e, n) {
            let r = this._svg;
            return r && (r.removeEventListener(Ay, this._hrefHandler),
            r.removeEventListener(ky, this._tooltipHandler),
            r.removeEventListener(My, this._tooltipHandler)),
            this._svg = r = t && ry(t, "svg"),
            r && (r.addEventListener(Ay, this._hrefHandler),
            r.addEventListener(ky, this._tooltipHandler),
            r.addEventListener(My, this._tooltipHandler)),
            sy.prototype.initialize.call(this, t, e, n)
        },
        canvas() {
            return this._svg
    ...
    const Oy = "aria-hidden"
      , Ry = "aria-label"
      , Ly = "role"
      , Uy = "aria-roledescription"
      , qy = "graphics-object"
      , Py = "graphics-symbol"
      , jy = (t,e,n)=>({
        [Ly]: t,
      ...
      , $y = {
        ...
        legend: {
            ...
            caption: function(t) {
                const e = t.datum
                  ...
                  , s = a.dataflow.locale();
                return l = r,
                (l.length ? l[0].toUpperCase() + l.slice(1) : l) + (n ? " titled '".concat(n, "'") : "") + " for ".concat(function(t) {
        ...
        "title-text": {
            desc: "title",
            caption: t=>"Title text '".concat(Vy(t), "'")
        },
        "title-subtitle": {
            desc: "subtitle",
            caption: t=>"Subtitle text '".concat(Vy(t), "'")
        }
    }
      , Wy = {
        ariaRole: Ly,
        ariaRoleDescription: Uy,
        description: Ry
    };
    function Hy(t, e) {
        const n = !1 === e.aria;
        ...
        n || null == e.description)
            ...
            t(Ry, e.description),
            t(Ly, e.ariaRole || ("group" === n ? qy : Py)),
            t(Uy, e.ariaRoleDescription || "".concat(n, " mark"))
        }
    }
    function Yy(t) {
        return !1 === t.aria ? {
            [Oy]: !0
        } : Iy[t.role] ? null : $y[t.role] ? function(t, e) {
            try {
                const n = t.items[0]
                  , r = e.caption || (()=>"");
    ...
    function Jy() {
        ...
        a)
          , a = {
            ...
            close() {
                const o = r.pop();
                return t += e ? e + (n ? ">".concat(n, "</").concat(o, ">") : "/>") : "</".concat(o, ">"),
                i(),
                a
            },
            attr: o,
    ...
    function av(t, e, n) {
        let r;
        return (t = iy(t, n, "clipPath", ev)).setAttribute("id", e.id),
        e.path ? (r = iy(t, 0, "path", ev),
        r.setAttribute("d", e.path)) : (r = iy(t, 0, "rect", ev),
        dv(r, {
            x: 0,
            y: 0,
            width: e.width,
    ...
    function uv(t, e, n, r, i) {
        ...
        }(a, n)) && e.insertBefore(a, n ? n.nextSibling : e.firstChild),
        a
    }
    ut(nv, cy, {
        initialize(t, e, n, r, i) {
            return this._defs = {},
            this._clearDefs(),
            t && (this._svg = iy(t, 0, "svg", ev),
            dv(this._svg, fm),
            this._svg.setAttribute("class", "marks"),
            oy(t, 1),
            this._root = iy(this._svg, 0, "g", ev),
            dv(this._root, tv),
            oy(this._svg, 1)),
            this.background(this._bgcolor),
            rv.initialize.call(this, t, e, n, r, i)
        },
        background(t) {
            return arguments.length && this._svg && this._svg.style.setProperty("background-color", t),
            rv.background.apply(this, arguments)
        },
        resize(t, e, n, r) {
            return rv.resize.call(this, t, e, n, r),
            this._svg && (dv(this._svg, {
        ...
        svg() {
            ...
            const r = Zy(t);
            return e && (t.removeChild(n),
            this._svg.style.setProperty("background-color", e)),
            r
        },
        _render(t) {
            return this._dirtyCheck() && (this._dirtyAll && this._clearDefs(),
        ...
        dirty(t) {
            t.dirty !== this._dirtyID && (t.dirty = this._dirtyID,
            this._dirty.push(t))
        },
        isDirty(t) {
        ...
        _dirtyCheck() {
            ...
            u = t.length; a < u; ++a)
                n = t[a],
                r = n.mark,
                r.marktype !== i && (i = r.marktype,
                o = Ym[i]),
                r.zdirty && r.dirty !== e && (this._dirtyAll = !1,
                iv(n, e),
                r.items.forEach((t=>{
                    t.dirty = e
                }
                ))),
                r.zdirty || (n.exit ? (o.nested && r.items.length ? (s = r.items[0],
                s._svg && this._update(o, s._svg, s)) : n._svg && (s = n._svg.parentNode,
                s && s.removeChild(n._svg)),
                n._svg = null) : (n = o.nested ? r.items[0] : n,
                n._update !== e && (n._svg && n._svg.ownerSVGElement ? this._update(o, n._svg, n) : (this._dirtyAll = !1,
                iv(n, e)),
                n._update = e)));
        ...
        mark(t, e, n) {
            ...
            for (const t in c)
                pv(l, t, c[t]);
            a || pv(l, "pointer-events", o),
            pv(l, "clip-path", e.clip ? Jp(this, e, e.group) : null);
            const f = t=>{
                const e = this.isDirty(t)
                  , n = uv(t, l, u, i.tag, r);
                e && (this._update(i, n, t),
                a && function(t, e, n) {
            ...
            ;
            return i.nested ? e.items.length && f(e.items[0]) : Ig(e, f),
            oy(l, s),
            l
        },
        _update(t, e, n) {
            ...
            if (null != e)
                for (const n in Ky) {
                    ...
                    if (r === lv[n])
                        continue;
                    const i = Ky[n];
                    null == r ? t.removeAttribute(i) : (ep(r) && (r = np(r, this._defs.gradient, gv())),
                    t.setAttribute(i, r + "")),
                    lv[n] = r
                }
        },
        defs() {
            ...
            for (const i in e.gradient)
                n || (e.el = n = iy(t, 1, "defs", ev)),
                r = ov(n, e.gradient[i], r);
            for (const i in e.clipping)
                n || (e.el = n = iy(t, 1, "defs", ev)),
                r = av(n, e.clipping[i], r);
            n && (0 === r ? (t.removeChild(n),
            e.el = null) : oy(n, r))
        },
        _clearDefs() {
            const t = this._defs;
    ...
    const cv = {
        group(t, e, n) {
            ...
            if (o !== lv.events && (pv(r, "pointer-events", o),
            pv(i, "pointer-events", o),
            lv.events = o),
        ...
        image(t, e, n) {
            !1 === n.smooth ? (hv(e, "image-rendering", "optimizeSpeed"),
            hv(e, "image-rendering", "pixelated")) : hv(e, "image-rendering", null)
        },
        text(t, e, n) {
            const r = Rm(n);
            let i, o, a, u;
            v(r) ? (o = r.map((t=>Um(n, t))),
            i = o.join("\n"),
            i !== lv.text && (oy(e, 0),
            a = e.ownerDocument,
            u = Om(n),
            o.forEach(((t,r)=>{
                ...
                i.__data__ = n,
                i.textContent = t,
                r && (i.setAttribute("x", 0),
                i.setAttribute("dy", u)),
                e.appendChild(i)
            }
            )),
            lv.text = i)) : (o = Um(n, r),
            o !== lv.text && (e.textContent = o,
            lv.text = o)),
            pv(e, "font-family", qm(n)),
            pv(e, "font-size", Nm(n) + "px"),
            pv(e, "font-style", n.fontStyle),
            pv(e, "font-variant", n.fontVariant),
            pv(e, "font-weight", n.fontWeight)
        }
    };
    function fv(t, e, n) {
    ...
    function hv(t, e, n) {
        n !== lv[e] && (null == n ? t.style.removeProperty(e) : t.style.setProperty(e, n + ""),
        lv[e] = n)
    }
    function dv(t, e) {
        for (const n in e)
                ...
                "text" === r) {
                    ...
                    if (v(e)) {
                        ...
                        for (let r = 0; r < e.length; ++r)
                            t.open("tspan", r ? n : null).text(Um(o, e[r])).close()
                    } else
                        t.text(Um(o, e))
                } else if ("g" === r) {
                    ...
                    Ig(o, (e=>this.mark(t, e))),
                    t.close(),
                    r && a ? (i && (o.fill = null),
                    o.stroke = a,
                    t.open("path", this.attr(e, o, n.foreground, "bgrect")).close(),
                    i && (o.fill = i)) : t.open("path", this.attr(e, o, n.foreground, "bgfore")).close()
                }
                t.close(),
                a && t.close()
            }
            ;
            return n.nested ? e.items && e.items.length && o(e.items[0]) : Ig(e, o),
            t.close()
        },
        href(t) {
            const e = t.href;
        ...
        attr(t, e, n, r) {
            ...
            r && function(t, e, n, r, i) {
                ...
                for (const n in Ky) {
                    let r = e[n];
                    const o = Ky[n];
                    ("transparent" !== r || "fill" !== o && "stroke" !== o) && null != r && (ep(r) && (r = np(r, i.gradient, "")),
                    t[o] = r)
                }
            }(i, e, t, r, this._defs),
            i
    ...
    ut(o_, pa, {
        transform(t, e) {
            ...
            if (o.nested)
            ...
            else if (i === Lv || t.modified())
                switch (e.visit(e.MOD, (t=>n.dirty(t))),
                s.clear(),
                r.items.forEach((t=>s.union(a_(t, a)))),
                r.role) {
                case Uv:
                case Iv:
                case qv:
                ...
                e.visit(e.MOD, (t=>{
                    u = u || s.alignsWith(t.bounds),
                    n.dirty(t),
                    s.union(a_(t, a))
                }
                )),
                u && (s.clear(),
                r.items.forEach((t=>s.union(t.bounds))));
            return Dv(r),
            e.modifies("bounds")
        }
    });
    ...
    ut(s_, pa, {
        transform(t, e) {
            const n = (i = e.dataflow)._signals[u_] || (i._signals[u_] = i.add(0))
              , r = t.as;
            var i;
            let o = n.value;
            return e.visit(e.ADD, (t=>t[r] = t[r] || ++o)),
            n.set(this.value = o),
            e
        }
    }),
    ut(l_, pa, {
        transform(t, e) {
            ...
            return e.visit(e.ADD, (t=>r.call(t, n))),
    ...
    const f_ = {
        ...
        greedy: (t,e)=>{
            let n;
            return t.filter(((t,r)=>r && h_(n.bounds, t.bounds, e) ? t.opacity = 0 : (n = t,
            1)))
        }
    }
      , h_ = (t,e,n)=>n > Math.max(e.x1 - t.x2, t.x1 - e.x2, e.y1 - t.y2, t.y1 - e.y2)
      , d_ = (t,e)=>{
        for (var n, r = 1, i = t.length, o = t[0].bounds; r < i; o = n,
        ++r)
            if (h_(o, n = t[r].bounds, e))
                return !0
    }
      , p_ = t=>{
        const e = t.bounds;
      ...
      , g_ = t=>(t.forEach((t=>t.opacity = 1)),
    t)
      , m_ = (t,e)=>t.reflow(e.modified()).modifies("opacity");
    function y_(t) {
        pa.call(this, null, t)
    }
    ut(c_, pa, {
        transform(t, e) {
            const n = f_[t.method] || f_.parity
              , r = t.separation || 0;
            let i, o, a = e.materialize(e.SOURCE).source;
            if (!a || !a.length)
                return;
            if (!t.method)
                return t.modified("method") && (g_(a),
                e = m_(e, t)),
                e;
            if (a = a.filter(p_),
            !a.length)
            ...
            i.length >= 3 && d_(i, r)) {
                ...
                i.length < 3 && !M(a).opacity && (i.length > 1 && (M(i).opacity = 0),
                M(a).opacity = 1)
            }
            t.boundScale && t.boundTolerance >= 0 && (o = ((t,e,n)=>{
                var r = t.range()
                  , i = new Zp;
                return e === Sv || e === zv ? i.set(r[0], -1 / 0, r[1], 1 / 0) : i.set(-1 / 0, r[0], 1 / 0, r[1]),
                i.expand(n || 1),
    ...
    ut(y_, pa, {
        transform(t, e) {
            const n = e.dataflow;
            if (e.visit(e.ALL, (t=>n.dirty(t))),
            e.fields && e.fields.zindex) {
    ...
    function b_(t, e, n, r) {
        var i, o, a = e.items[0], u = a.datum, s = null != a.translate ? a.translate : .5, l = a.orient, c = function(t) {
            let e = +t.grid;
            return [t.ticks ? e++ : -1, t.labels ? e++ : -1, e + +t.domain]
        }(u), f = a.range, h = a.offset, d = a.position, p = a.minExtent, g = a.maxExtent, m = u.title && a.items[c[2]].items[0], y = a.titlePadding, v = a.bounds, _ = m && Lm(m), x = 0, b = 0;
        switch (v_.clear().union(v),
        v.clear(),
        ...
        case zv:
            ...
            v.add(0, 0).add(f, o),
            m && w_(t, m, o, y, 0, 0, 1, v);
            break;
        default:
            x = a.x,
            b = a.y
        }
        return rg(v.translate(x, b), a),
        __(a, "x", x + s) | __(a, "y", b + s) && (a.bounds = v_,
        t.dirty(a),
        a.bounds = v,
        t.dirty(a)),
    ...
    function F_(t, e, n) {
        var r, i, o, a, u, s, l, c, f, h, d, p = !n.nodirty, g = n.bounds === n_ ? A_ : E_, m = v_.set(0, 0, 0, 0), y = D_(n.align, r_), v = D_(n.align, i_), _ = D_(n.padding, r_), x = D_(n.padding, i_), b = n.columns || e.length, w = b <= 0 ? 1 : Math.ceil(e.length / b), k = e.length, M = Array(k), A = Array(b), E = 0, D = Array(k), C = Array(w), F = 0, S = Array(k), B = Array(k), T = Array(k);
        for (i = 0; i < b; ++i)
            A[i] = 0;
        for (i = 0; i < w; ++i)
            C[i] = 0;
        ...
        for (o = 0; o < b; ++o)
            ...
            i = o; i < k; i += b)
                h += D[i],
                B[i] += h - e[i].y;
        if (y && D_(n.center, r_) && w > 1)
            for (i = 0; i < k; ++i)
                (f = (u = y === t_ ? E : A[i % b]) - T[i].x2 - e[i].x - S[i]) > 0 && (S[i] += f / 2);
        if (v && D_(n.center, i_) && 1 !== b)
            for (i = 0; i < k; ++i)
                (h = (u = v === t_ ? F : C[~~(i / b)]) - T[i].y2 - e[i].y - B[i]) > 0 && (B[i] += h / 2);
        for (i = 0; i < k; ++i)
            m.union(T[i].translate(S[i], B[i]));
        switch (f = D_(n.anchor, "x"),
        h = D_(n.anchor, "y"),
        D_(n.anchor, r_)) {
        case Rv:
            f -= m.width();
    ...
    function S_(t, e, n) {
        var r, i, o, a, u, s, l, c = function(t) {
            ...
            return a
        }(e), f = c.marks, h = n.bounds === n_ ? B_ : T_, d = n.offset, p = n.columns || f.length, g = p <= 0 ? 1 : Math.ceil(f.length / p), m = g * p;
        const y = F_(t, f, n);
        y.empty() && y.set(0, 0, 0, 0),
        c.rowheaders && (s = D_(n.headerBand, i_, null),
        r = z_(t, c.rowheaders, f, p, g, -D_(d, "rowHeader"), k_, 0, h, "x1", 0, p, 1, s)),
        c.colheaders && (s = D_(n.headerBand, r_, null),
        i = z_(t, c.colheaders, f, p, p, -D_(d, "columnHeader"), k_, 1, h, "y1", 0, 1, p, s)),
        c.rowfooters && (s = D_(n.footerBand, i_, null),
        o = z_(t, c.rowfooters, f, p, g, D_(d, "rowFooter"), M_, 0, h, "x2", p - 1, p, 1, s)),
        c.colfooters && (s = D_(n.footerBand, r_, null),
        a = z_(t, c.colfooters, f, p, p, D_(d, "columnFooter"), M_, 1, h, "y2", m - p, 1, p, s)),
        c.rowtitle && (u = D_(n.titleAnchor, i_),
        l = D_(d, "rowTitle"),
        l = u === Rv ? o + l : r - l,
        s = D_(n.titleBand, i_, .5),
        N_(t, c.rowtitle, l, 0, y, s)),
        c.coltitle && (u = D_(n.titleAnchor, r_),
        l = D_(d, "columnTitle"),
        l = u === Rv ? a + l : i - l,
        s = D_(n.titleBand, r_, .5),
        N_(t, c.coltitle, l, 1, y, s))
    }
    function B_(t, e) {
    ...
    function z_(t, e, n, r, i, o, a, u, s, l, c, f, h, d) {
        ...
        y = e.length; g < y; ++g)
            t.dirty(e[g]),
            e[g].mark.bounds.clear();
        for (p = c,
        g = 0,
        y = e.length; g < y; ++g,
        p += f) {
            for (v = (_ = e[g]).mark.bounds,
            m = p; m >= 0 && null == (x = n[m]); m -= h)
                ;
            u ? (b = null == d ? x.x : Math.round(x.bounds.x1 + d * x.bounds.width()),
            w = M) : (b = M,
            w = null == d ? x.y : Math.round(x.bounds.y1 + d * x.bounds.height())),
    ...
    function N_(t, e, n, r, i, o) {
        if (e) {
            ...
            var a = n
              , u = n;
            r ? a = Math.round(i.x1 + o * i.width()) : u = Math.round(i.y1 + o * i.height()),
    ...
    function R_(t, e) {
        ...
        return i._bounds ? i._bounds.clear().union(u) : i._bounds = u.clone(),
        u.clear(),
        function(t, e, n) {
            var r = e.padding
              , i = r - n.x
            ...
            if (e.datum.title) {
                ...
                case zv:
                    l += L_(e, n, a, u, 0, 0),
                    c += L_(e, n, a, Rv, -1, 0, 1) + s;
                    break;
                default:
                    l += L_(e, n, a, u, 0, 0)
                }
                (l || c) && U_(t, a, l, c),
                (l = Math.round(a.bounds.x1 - r)) < 0 && (U_(t, n, -l, 0),
                U_(t, a, -l, 0))
            } else
                (i || o) && U_(t, n, i, o)
        }(t, i, i.items[0].items[0]),
        u = function(t, e) {
            return t.items.forEach((t=>e.union(t.bounds))),
            e.x1 = t.padding,
            e.y1 = t.padding,
            e
        }(i, u),
        n = 2 * i.padding,
        r = 2 * i.padding,
        u.empty() || (n = Math.ceil(u.width() + n),
        r = Math.ceil(u.height() + r)),
        "symbol" === o.type && function(t) {
            const e = t.reduce(((t,e)=>(t[e.column] = Math.max(e.bounds.x2 - e.x, t[e.column] || 0),
            t)), {});
            t.forEach((t=>{
                t.width = e[t.column],
    ...
    function L_(t, e, n, r, i, o, a) {
        const u = "symbol" !== t.datum.type
          , s = n.datum.vgrad
          , l = (!u || !o && s || a ? e : e.items[0]).bounds[i ? "y2" : "x2"] - t.padding
          , c = s && o ? l : 0
          , f = s && o ? 0 : l
          , h = i <= 0 ? 0 : Lm(n);
    ...
    ut(q_, pa, {
        transform(t, e) {
            ...
            return t.mark.items.forEach((e=>{
                t.layout && S_(n, e, t.layout),
                function(t, e, n) {
                    var r, i, o, a, u, s = e.items, l = Math.max(0, e.width || 0), c = Math.max(0, e.height || 0), f = (new Zp).set(0, 0, l, c), h = f.clone(), d = f.clone(), p = [];
                    for (a = 0,
                    u = s.length; a < u; ++a)
                        switch ((i = s[a]).role) {
                        case Uv:
                    ...
                    if (p.length) {
                        ...
                        p.forEach((e=>{
                            const r = e.bounds;
                            if (r.equals(e._bounds) || (e.bounds = e._bounds,
                            t.dirty(e),
                            e.bounds = r,
                            t.dirty(e)),
                            n.autosize && n.autosize.type === Jv)
                                switch (e.orient) {
                                case Bv:
                                case Tv:
                    ...
                    f.union(h).union(d),
                    r && f.union(function(t, e, n, r, i) {
                        var o, a = e.items[0], u = a.frame, s = a.orient, l = a.anchor, c = a.offset, f = a.padding, h = a.items[0].items[0], d = a.items[1] && a.items[1].items[0], p = s === Bv || s === Tv ? r : n, g = 0, m = 0, y = 0, v = 0, _ = 0;
                        if (u !== Lv ? s === Bv ? (g = i.y2,
                        p = i.y1) : s === Tv ? (g = i.y1,
                        p = i.y2) : (g = i.x1,
                        p = i.x2) : s === Bv && (g = r,
                        p = 0),
                        o = l === Nv ? g : l === Rv ? p : (g + p) / 2,
                        d && d.text) {
                            switch (s) {
                            case Sv:
                            case zv:
                        ...
                        return __(a, "x", m) | __(a, "y", y) && (v_.translate(m, y),
                        t.dirty(a),
                    ...
                    !function(t, e, n, r) {
                        ...
                        f = 0,
                        s = a,
                        c = u) : o === Jv ? (s = Math.max(0, a - l - h),
                        c = Math.max(0, u - f - d)) : o === Zv ? (s = Math.max(0, a - l - h),
                        u = c + f + d) : o === Qv ? (a = s + l + h,
                        c = Math.max(0, u - f - d)) : "pad" === o && (a = s + l + h,
                        u = c + f + d);
    ...
    ut(I_, pa, {
        transform(t, e) {
            var n = e.dataflow
              ...
              , o = t.key || Oo
              , a = this.value;
            return v(r.encode) && (r.encode = null),
            a && (t.modified("key") || e.modified(o)) && u("DataJoin does not support modified key function or fields."),
            a || (e = e.addAll(),
            this.value = a = function(t) {
                const e = ot().test((t=>t.exit));
                return e.lookup = n=>e.get(t(n)),
                e
            }(o)),
            e.visit(e.ADD, (t=>{
                const e = o(t);
                let n = a.get(e);
                n ? n.exit ? (a.empty--,
                r.add.push(n)) : r.mod.push(n) : (n = i(t),
                a.set(e, n),
                r.add.push(n)),
                n.datum = t,
                n.exit = !1
            ...
            e.visit(e.REM, (t=>{
                const e = o(t)
                  , n = a.get(e);
                t !== n.datum || n.exit || (r.rem.push(n),
                n.exit = !0,
                ++a.empty)
            }
            )),
            e.changed(e.ADD_MOD) && r.modifies("datum"),
            (e.clean() || t.clean && a.empty > n.cleanThreshold) && n.runAfter(a.clean),
            r
        }
    }),
    ut(W_, pa, {
        transform(t, e) {
            ...
            n.modifies(s.output),
            n.modifies(u.output),
            c !== g && c !== u && (e.visit(e.ADD, (e=>{
                c(e, t)
            }
            )),
            n.modifies(c.output))),
            e.changed(e.REM) && l !== g && (e.visit(e.REM, (e=>{
                l(e, t)
            }
            )),
            n.modifies(l.output)),
    ...
    ut(H_, pa, {
        transform(t, e) {
            if (null != this.value && !t.modified())
                return e.StopPropagation;
            var n, r, i, o, a, u = e.dataflow.locale(), s = e.fork(e.NO_SOURCE | e.NO_FIELDS), l = this.value, c = t.type || zd, f = t.scale, h = +t.limit, d = Ld(f, null == t.count ? 5 : t.count, t.minstep), p = !!t.values || c === zd, g = t.format || Hd(u, f, d, c, t.formatSpecifier, t.formatType, p), m = t.values || Wd(f, d);
            return l && (s.rem = l),
            c === zd ? (h && m.length > h ? (e.dataflow.warn("Symbol legend count exceeds limit, filtering items."),
            l = m.slice(0, h - 1),
            a = !0) : l = m,
            H(i = t.size) ? (t.values || 0 !== f(l[0]) || (l = l.slice(1)),
            o = l.reduce(((e,n)=>Math.max(e, i(n, t))), 0)) : i = Z(o = i || 8),
            l = l.map(((e,n)=>Lo({
                index: n,
                label: g(e, n, l),
                value: e,
            ...
            l.push(Lo({
                ...
                offset: o,
                size: i(a, t)
            })))) : "gradient" === c ? (n = f.domain(),
            r = Dd(f, n[0], M(n)),
            m.length < 3 && !t.values && n[0] !== M(n) && (m = [n[0], M(n)]),
            l = m.map(((t,e)=>Lo({
                index: e,
                label: g(t, e, m),
                value: t,
    ...
    ut(J_, pa, {
        transform(t, e) {
            var n = t.sourceX || Y_
              ...
              , s = t.orient || "vertical"
              , l = t.shape || "line"
              , c = tx.get(l + "-" + s) || tx.get(l);
            return c || u("LinkPath unsupported type: " + t.shape + (t.orient ? "-" + t.orient : "")),
            e.visit(e.SOURCE, (t=>{
    ...
    ut(ex, pa, {
        transform(t, e) {
            var n, r, i, o = t.as || ["startAngle", "endAngle"], a = o[0], u = o[1], s = t.field || d, l = t.startAngle || 0, c = null != t.endAngle ? t.endAngle : 2 * Math.PI, f = e.source, h = f.map(s), p = h.length, g = l, m = (c - l) / Le(h), y = Re(p);
            for (t.sort && y.sort(((t,e)=>h[t] - h[e])),
            n = 0; n < p; ++n)
                i = h[y[n]],
                (r = f[y[n]])[a] = g,
                r[u] = g += i * m;
            return this.value = h,
            e.reflow(t.modified()).modifies(o)
        }
    });
    function nx(t) {
        return yd(t) && t !== Vh
    ...
    ut(ix, pa, {
        transform(t, e) {
            ...
            for (i in r && i === r.type || (this.value = r = pd(i)()),
            t)
                if (!rx[i]) {
                    if ("padding" === i && nx(r.type))
                        continue;
            ...
            return function(t, e, n) {
                ...
                if (null != e.rangeStep)
                    ...
                    return n = t === Zh ? n + 1 : t === ed ? n - 1 : t === Xh || t === Jh ? +e.schemeCount || 5 : n,
                    bd(t) ? ax(r, i, e.reverse) : H(r) ? Ed(ax(r, i), n) : t === Qh ? r : r.slice(0, n)
                }(r, e, n),
                H(o))) {
                    if (t.interpolator)
                        return t.interpolator(o);
                    u("Scale type ".concat(r, " does not support interpolating color schemes."))
                }
                if (o && bd(r))
                    return t.interpolator(Ad(ux(o, e.reverse), e.interpolate, e.interpolateGamma));
                ...
                t.type === ed && (r ? e.domain || e.domainRaw || (t.domain(r),
                n = r.length) : t.bins = t.domain());
                return n
            }(r, t, function(t, e, n) {
                const r = function(t, e, n) {
                    return e ? (t.domain(ox(t.type, e, n)),
                    e.length) : -1
                }(t, e.domainRaw, n);
                if (r > -1)
                    return r;
                ...
                null != e.domainMid)) {
                    ...
                    t !== i && n.warn("Scale domainMid exceeds domain min or max.", o),
                    a.splice(t, 0, o)
                }
                t.domain(ox(u, a, n)),
                u === Qh && t.unknown(e.domainImplicit ? Ql : void 0);
    ...
    ut(sx, pa, {
        transform(t, e) {
            ...
            return n && e.source.sort(jo(t.sort)),
            this.modified(n),
            e
        }
    });
    ...
    ut(dx, pa, {
        transform(t, e) {
            var n, r, i, o, a = t.as || hx, u = a[0], s = a[1], l = jo(t.sort), c = t.field || d, f = t.offset === cx ? px : t.offset === fx ? gx : mx;
    ...
    var Gx, Xx, Jx, Zx, Qx, Kx, tb, eb, nb, rb, ib, ob, ab, ub, sb, lb, cb = new be, fb = new be, hb = {
        ...
        polygonEnd: function() {
            var t = +cb;
            fb.add(t < 0 ? kx + t : t),
            this.lineStart = this.lineEnd = this.point = jx
        },
        sphere: function() {
            fb.add(kx)
        }
    ...
    var Mb, Ab, Eb, Db, Cb, Fb, Sb, Bb, Tb, zb, Nb, Ob, Rb, Lb, Ub, qb, Pb = {
        ...
        polygonEnd: function() {
            ...
            Pb.lineEnd = Wb,
            cb < 0 ? (Kx = -(eb = 180),
            tb = -(nb = 90)) : ub > vx ? nb = 90 : ub < -1e-6 && (tb = -90),
            lb[0] = Kx,
            lb[1] = eb
        },
        sphere: function() {
    ...
    function Ib(t, e) {
        ...
        if (ab) {
            ...
            l ^ (u * rb < s && s < u * t) ? (o = i[1] * Mx) > nb && (nb = o) : l ^ (u * rb < (s = (s + 360) % 360 - 180) && s < u * t) ? (o = -i[1] * Mx) < tb && (tb = o) : (e < tb && (tb = e),
            e > nb && (nb = e)),
            l ? t < rb ? Gb(Kx, t) > Gb(Kx, eb) && (eb = t) : Gb(t, eb) > Gb(Kx, eb) && (Kx = t) : eb >= Kx ? (t < Kx && (Kx = t),
            t > eb && (eb = t)) : t > rb ? Gb(Kx, t) > Gb(Kx, eb) && (eb = t) : Gb(t, eb) > Gb(Kx, eb) && (Kx = t)
        } else
            sb.push(lb = [Kx = t, eb = t]);
        e < tb && (tb = e),
        e > nb && (nb = e),
    ...
    function vw(t, e, n, r, i) {
        ...
        if (t.forEach((function(t) {
            if (!((e = t.length - 1) <= 0)) {
                ...
                u.push(n = new yw(r,t,null,!0)),
                s.push(n.o = new yw(r,null,n,!1)),
                u.push(n = new yw(a,t,null,!1)),
                s.push(n.o = new yw(a,null,n,!0))
            }
        }
        )),
        u.length) {
                ...
                polygonEnd: function() {
                    ...
                    var t = function(t, e) {
                        ...
                        for (var l = 0, c = t.length; l < c; ++l)
                            if (h = (f = t[l]).length)
                                for (var f, h, d = f[h - 1], p = xw(d), g = d[1] / 2 + wx, m = Ox(g), y = Fx(g), v = 0; v < h; ++v,
                                p = x,
                                m = w,
                                y = k,
                                d = _) {
                                    var _ = f[v]
                                      ...
                                      , D = E > xx
                                      , C = m * w;
                                    if (s.add(Cx(C * A * Ox(E), y * k + C * Fx(E))),
                                    a += D ? M + A * kx : M,
                                    D ^ p >= n ^ x >= n) {
                                        var F = xb(vb(d), vb(_));
                                        kb(F);
                    ...
                    a.length ? (f || (i.polygonStart(),
                    f = !0),
                    vw(a, kw, t, n, i)) : t && (f || (i.polygonStart(),
                    f = !0),
                    i.lineStart(),
                    n(null, null, 1, i),
                    i.lineEnd()),
    ...
    var Mw = bw((function() {
        ...
        return {
            ...
            point: function(o, a) {
                var u = o > 0 ? xx : -xx
                  , s = Ex(o - n);
                Ex(s - xx) < vx ? (t.point(n, r = (r + a) / 2 > 0 ? bx : -bx),
                t.point(i, r),
                t.lineEnd(),
                t.lineStart(),
                t.point(u, r),
                t.point(o, r),
                e = 0) : i !== u && s >= xx && (Ex(n - i) < vx && (n -= i * vx),
                Ex(o - u) < vx && (o -= u * vx),
                r = function(t, e, n, r) {
                    var i, o, a = Ox(t - n);
    ...
    function Aw(t) {
        ...
        function a(t, n, r) {
            ...
            if (!(m < 0)) {
                ...
                w = k,
                k = _),
                A || M < vx ? A ? w + k > 0 ^ v[1] < (Ex(v[0] - x) < vx ? w : k) : w <= v[1] && v[1] <= k : M > xx ^ (x <= v[0] && v[0] <= b)) {
                    var E = wb(d, (-p + y) / g);
                    return bb(E, h),
                    [v, yb(E)]
                }
        ...
        return bw(o, (function(t) {
            ...
            return {
                ...
                point: function(f, h) {
                    ...
                    if (!e && (l = s = g) && t.lineStart(),
                    g !== s && (!(d = a(e, p)) || mw(e, d) || mw(p, d)) && (p[2] = 1),
                    g !== s)
                        c = 0,
                        g ? (t.lineStart(),
                        d = a(p, e),
                        t.point(d[0], d[1])) : (d = a(e, p),
                        t.point(d[0], d[1], 2),
                        t.lineEnd()),
                        e = d;
                    else if (i && e && r ^ g) {
    ...
    function Cw(t, e, n, r) {
        ...
        function o(i, o, u, l) {
            var c = 0
              , f = 0;
            if (null == i || (c = a(i, u)) !== (f = a(o, u)) || s(i, o) < 0 ^ u > 0)
                do {
                ...
                polygonEnd: function() {
                    var e = function() {
                        for (var e = 0, n = 0, i = l.length; n < i; ++n)
                            for (var o, a, u = l[n], s = 1, c = u.length, f = u[0], h = f[0], d = f[1]; s < c; ++s)
                                o = h,
                                a = d,
                                h = (f = u[s])[0],
                                d = f[1],
                                a <= r ? d > r && (h - o) * (r - a) > (d - a) * (t - o) && ++e : d <= r && (h - o) * (r - a) < (d - a) * (t - o) && --e;
                        return e
                    }()
                      , n = v && e
                      , i = (s = Oe(s)).length;
    ...
    var Bw, Tw, zw, Nw, Ow = t=>t, Rw = new be, Lw = new be, Uw = {
        ...
        polygonEnd: function() {
            Uw.lineStart = Uw.lineEnd = Uw.point = jx,
            Rw.add(Ex(Lw)),
            Lw = new be
        },
        result: function() {
    ...
    var Gw, Xw, Jw, Zw, Qw = 0, Kw = 0, tk = 0, ek = 0, nk = 0, rk = 0, ik = 0, ok = 0, ak = 0, uk = {
        ...
        result: function() {
            ...
            return Qw = Kw = tk = ek = nk = rk = ik = ok = ak = 0,
            t
        }
    };
    function sk(t, e) {
    ...
    Dk.prototype = {
        ...
        point: function(t, e) {
            ...
            case 1:
                ...
                break;
            default:
                null == this._circle && (this._circle = Ck(this._radius)),
            ...
            function n(r, i, o, a, u, s, l, c, f, h, d, p, g, m) {
                ...
                if (_ > 4 * e && g--) {
                    var x = a + h
                      ...
                      , k = Lx(x * x + b * b + w * w)
                      , M = Px(w /= k)
                      , A = Ex(Ex(w) - 1) < vx || Ex(o - f) < vx ? (o + f) / 2 : Cx(b, x)
                      , E = t(A, M)
                      , D = E[0]
                      , C = E[1]
                      , F = D - r
                      , S = C - i
                      , B = v * F - y * S;
                    (B * B / _ > e || Ex((y * F + v * S) / _ - .5) > .3 || a * h + u * d + s * p < Lk) && (n(r, i, o, a, u, s, D, C, A, x /= k, b /= k, w, g, m),
                    m.point(D, C),
                    n(D, C, A, x, b, w, l, c, f, h, d, p, g, m))
                }
            }
            return function(e) {
                ...
                function v(r, i) {
                    var o = vb([r, i])
                      , a = t(r, i);
                    n(c, f, l, h, d, p, c = a[0], f = a[1], l = r, h = o[0], d = o[1], p = o[2], 16, e),
                    e.point(c, f)
                }
                function _() {
                    g.point = m,
    ...
    function Ik(t) {
        var e, n, r, i, o, a, u, s, l, c, f = 150, h = 480, d = 250, p = 0, g = 0, m = 0, y = 0, v = 0, _ = 0, x = 1, b = 1, w = null, k = Mw, M = null, A = Ow, E = .5;
        function D(t) {
        ...
        function F() {
            var t = Pk(f, 0, 0, x, b, _).apply(null, e(p, g))
              , r = Pk(f, h - t[0], d - t[1], x, b, _);
            return n = cw(m, y, v),
            u = sw(e, r),
            s = sw(n, u),
            a = Uk(u, E),
        ...
        D.clipAngle = function(t) {
            return arguments.length ? (k = +t ? Aw(w = t * Ax) : (w = null,
            Mw),
            S()) : w * Mx
        }
        ,
        D.clipExtent = function(t) {
            return arguments.length ? (A = null == t ? (M = r = i = o = null,
            Ow) : Cw(M = +t[0][0], r = +t[0][1], i = +t[1][0], o = +t[1][1]),
            S()) : null == M ? null : [[M, r], [i, o]]
        }
        ,
        D.scale = function(t) {
            return arguments.length ? (f = +t,
        ...
        ,
        D.center = function(t) {
            return arguments.length ? (p = t[0] % 360 * Ax,
            g = t[1] % 360 * Ax,
            F()) : [p * Mx, g * Mx]
        }
        ,
        D.rotate = function(t) {
            return arguments.length ? (m = t[0] % 360 * Ax,
            y = t[1] % 360 * Ax,
            v = t.length > 2 ? t[2] % 360 * Ax : 0,
            F()) : [m * Mx, y * Mx, v * Mx]
        }
        ,
        D.angle = function(t) {
            return arguments.length ? (_ = t % 360 * Ax,
            F()) : _ * Mx
        }
        ,
        ...
        D.reflectY = function(t) {
            return arguments.length ? (b = t ? -1 : 1,
            F()) : b < 0
        }
        ,
        D.precision = function(t) {
            return arguments.length ? (a = Uk(u, E = t * t),
            S()) : Lx(E)
        }
        ,
    ...
    function Wk(t, e) {
        ...
        return a.invert = function(t, e) {
            var n = o - e
              , a = Cx(t, Ex(n)) * Rx(n);
            return n * r < 0 && (a -= xx * Rx(t) * Rx(n)),
            [a / r, Px((i - (t * t + n * n) * r * r) / (2 * r))]
        }
        ,
        a
    }
    ...
    function Qk(t) {
        ...
        function c() {
            var o = xx * a()
              , u = i(function(t) {
                function e(e) {
                    return (e = t(e[0] * Ax, e[1] * Ax))[0] *= Mx,
                    e[1] *= Mx,
                    e
                }
                return t = cw(t[0] * Ax, t[1] * Ax, t.length > 2 ? t[2] * Ax : 0),
                e.invert = function(e) {
                    return (e = t.invert(e[0] * Ax, e[1] * Ax))[0] *= Mx,
                    e[1] *= Mx,
                    e
                }
                ,
        ...
        i.clipExtent = function(t) {
            return arguments.length ? (null == t ? l = e = n = r = null : (l = +t[0][0],
            e = +t[0][1],
            n = +t[1][0],
            r = +t[1][1]),
            c()) : null == l ? null : [[l, e], [n, r]]
        }
        ,
        c()
    }
    ...
    function tM(t, e) {
        var n = Fx(t)
          , r = t === e ? Ox(t) : zx(n / Fx(e)) / zx(Kk(e) / Kk(t))
          , i = n * Nx(Kk(t), r) / r;
        if (!r)
            return Zk;
        function o(t, e) {
    ...
    function nM(t, e) {
        ...
        return o.invert = function(t, e) {
            var n = i - e
              , o = Cx(t, Ex(n)) * Rx(n);
            return n * r < 0 && (o -= xx * Rx(t) * Rx(n)),
            [o / r, i - Rx(r) * Lx(t * t + n * n)]
        }
        ,
        o
    }
    ...
    sM.invert = function(t, e) {
        for (var n, r = e, i = r * r, o = i * i * i, a = 0; a < 12 && (o = (i = (r -= n = (r * (rM + iM * i + o * (oM + aM * i)) - e) / (rM + 3 * iM * i + o * (7 * oM + 9 * aM * i))) * r) * i * i,
        !(Ex(n) < _x)); ++a)
            ;
    ...
    function AM(t, e) {
        return function n() {
            const r = e();
            return r.type = t,
            r.path = Fk().projection(r),
            r.copy = r.copy || function() {
                const t = n();
                return MM.forEach((e=>{
                    r[e] && t[e](r[e]())
                }
    ...
    function EM(t, e) {
        ...
        arguments.length > 1 ? (CM[t] = AM(t, e),
        this) : CM[t] || null
    }
    function DM(t) {
        return t && t.path || kM
    ...
    const CM = {
        albers: Yk,
        albersusa: function() {
            var t, e, n, r, i, o, a = Yk(), u = Hk().rotate([154, 0]).center([-2, 58.5]).parallels([55, 65]), s = Hk().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18]), l = {
                point: function(t, e) {
                    o = [t, e]
                }
            };
            ...
            ,
            c.stream = function(n) {
                return t && e === n ? t : (r = [a.stream(e = n), u.stream(n), s.stream(n)],
                i = r.length,
                t = {
                    point: function(t, e) {
                        for (var n = -1; ++n < i; )
            ...
            c.translate = function(t) {
                ...
                var e = a.scale()
                  , o = +t[0]
                  , c = +t[1];
                return n = a.translate(t).clipExtent([[o - .455 * e, c - .238 * e], [o + .455 * e, c + .238 * e]]).stream(l),
                r = u.translate([o - .307 * e, c + .201 * e]).clipExtent([[o - .425 * e + vx, c + .12 * e + vx], [o - .214 * e - vx, c + .234 * e - vx]]).stream(l),
                i = s.translate([o - .205 * e, c + .212 * e]).clipExtent([[o - .214 * e + vx, c + .166 * e + vx], [o - .115 * e - vx, c + .234 * e - vx]]).stream(l),
                f()
            }
            ,
        ...
        identity: function() {
            ...
            _.clipExtent = function(t) {
                return arguments.length ? (y = null == t ? (d = n = r = i = null,
                Ow) : Cw(d = +t[0][0], n = +t[0][1], r = +t[1][0], i = +t[1][1]),
                v()) : null == d ? null : [[d, n], [r, i]]
            }
            ,
            _.scale = function(t) {
                return arguments.length ? (u = +t,
            ...
            ,
            _.angle = function(n) {
                return arguments.length ? (e = Ox(h = n % 360 * Ax),
                t = Fx(h),
                v()) : h * Mx
            }
            ,
            _.reflectX = function(t) {
                return arguments.length ? (c = t ? -1 : 1,
                v()) : c < 0
            }
            ,
            _.reflectY = function(t) {
                return arguments.length ? (f = t ? -1 : 1,
                v()) : f < 0
            }
            ,
    ...
    function BM() {
        ...
        function i(r, i) {
            ...
            return function(n, r, i) {
                ...
                for (; ++u < e - 1; ) {
                    ...
                    l = n[u * t + t] >= r,
                    c = n[u * t] >= r,
                    SM[l << 1 | c << 2].forEach(p); ++a < t - 1; )
                        s = l,
                        l = n[u * t + t + a + 1] >= r,
                        f = c,
                        c = n[u * t + a + 1] >= r,
                        SM[s | l << 1 | c << 2 | f << 3].forEach(p);
                    SM[l | c << 3].forEach(p)
                }
                a = -1,
                c = n[u * t] >= r,
                ...
                function p(t) {
                    ...
                    e.ring.push(s),
                    d[e.end = c] = e) : (e = h[c]) ? (n = d[l]) ? (delete h[e.start],
                    delete d[n.end],
                    e === n ? (e.ring.push(s),
        ...
        function a(n, r, i) {
            n.forEach((n=>{
                ...
                a > 0 && a < t && s === a && (o = r[l * t + s - 1],
                n[0] = a + (i - o) / (c - o) - .5),
                u > 0 && u < e && l === u && (o = r[(l - 1) * t + s],
                n[1] = u + (i - o) / (c - o) - .5)
            }
            ))
        }
        ...
        ,
        r.smooth = function(t) {
            return arguments.length ? (n = t ? a : FM,
            r) : n === a
        }
        ,
        r
    ...
    function LM(t, e, n, r, i) {
        ...
        return function(t) {
            return t.coordinates.forEach(s),
            t
        }
    }
    function UM(t, e, n) {
    ...
    function PM() {
        ...
        function s(u, s) {
            ...
            l > 0 && c > 0 ? (jM(d, p, g, m, l),
            IM(d, p, m, g, c),
            jM(d, p, g, m, l),
            IM(d, p, m, g, c),
            jM(d, p, g, m, l),
            IM(d, p, m, g, c)) : l > 0 ? (jM(d, p, g, m, l),
            jM(d, p, m, g, l),
            jM(d, p, g, m, l),
            y = m) : c > 0 && (IM(d, p, g, m, c),
            IM(d, p, m, g, c),
            IM(d, p, g, m, c),
            y = m);
            const v = s ? Math.pow(2, -2 * a) : 1 / Le(y);
            for (let t = 0, e = d * p; t < e; ++t)
                y[t] *= v;
            return {
                values: y,
                scale: 1 << a,
        ...
        return s.x = function(e) {
            return arguments.length ? (t = qM(e),
            s) : t
        }
        ,
        s.y = function(t) {
            return arguments.length ? (e = qM(t),
            s) : e
        }
        ,
        s.weight = function(t) {
            return arguments.length ? (n = qM(t),
            s) : n
        }
        ,
        s.size = function(t) {
        ...
        s.cellSize = function(t) {
            return arguments.length ? ((t = +t) >= 1 || u("invalid cell size"),
            a = Math.floor(Math.log(t) / Math.LN2),
            s) : 1 << a
        }
        ,
        s.bandwidth = function(t) {
            return arguments.length ? (1 === (t = $(t)).length && (t = [+t[0], +t[0]]),
    ...
    function HM(t, e) {
        return WM.forEach((n=>null != e[n] ? t[n](e[n]) : 0)),
        t
    }
    function YM(t) {
        pa.call(this, null, t)
            ...
            var r, i = e.fork(e.NO_SOURCE | e.NO_FIELDS), o = function(t, e) {
                ...
                if (null == e)
                    ...
                    i = t.length; r < i; ++r)
                        ...
                        u.push(o);
                return s
            }(e.materialize(e.SOURCE).source, t.groupby), a = (t.groupby || []).map(n), u = HM(PM(), t), s = t.as || "grid";
    ...
    ut(YM, pa, {
        transform(t, e) {
            if (this.value && !e.changed() && !t.modified())
                return e.StopPropagation;
            var n, r, i = e.fork(e.NO_SOURCE | e.NO_FIELDS), o = BM().smooth(!1 !== t.smooth), a = t.values, u = t.thresholds || OM(t.count || 10, t.nice, !!a), s = t.size;
            return a || (a = e.materialize(e.SOURCE).source,
            r = LM(n = HM(PM(), t)(a, !0), n.scale || 1, n.scale || 1, 0, 0),
            s = [n.width, n.height],
            a = n.values),
            u = v(u) ? u : u(a),
            a = o.size(s)(a, u),
            r && a.forEach(r),
            this.value && (i.rem = this.value),
            this.value = i.source = i.add = (a || []).map(Lo),
            i
        }
    });
    const VM = "Feature"
    ...
    ut(XM, pa, {
        transform(t, e) {
            var n, i = this._features, o = this._points, a = t.fields, u = a && a[0], s = a && a[1], l = t.geojson || !a && f, c = e.ADD;
            n = t.modified() || e.changed(e.REM) || e.modified(r(l)) || u && e.modified(r(u)) || s && e.modified(r(s)),
    ...
    ut(JM, pa, {
        transform(t, e) {
            var n = e.fork(e.ALL)
              ...
              , o = t.as || "path"
              , a = n.SOURCE;
            !r || t.modified() ? (this.value = r = DM(t.projection),
            n.materialize().reflow()) : a = i === f || e.modified(i.fields) ? n.ADD_MOD : n.ADD;
            const u = function(t, e) {
                const n = t.pointRadius();
                t.context(null),
                null != e && t.pointRadius(e);
                return n
            }(r, t.pointRadius);
            return n.visit(a, (t=>t[o] = r(i(t)))),
            r.pointRadius(u),
            n.modifies(o)
        }
    }),
    ...
    ut(ZM, pa, {
        transform(t, e) {
            ...
            return t.modified() ? e = e.materialize().reflow(!0).visit(e.SOURCE, l) : (n = e.modified(i.fields) || e.modified(o.fields),
        ...
        transform(t, e) {
            ...
            return r && !t.modified() || (this.value = r = function(t, e, n) {
                const r = null == n ? n=>t(e(n)) : r=>{
                    ...
                    return t.pointRadius(i),
                    o
                }
                ;
                return r.context = e=>(t.context(e),
                r),
                r
            }(DM(t.projection), t.field || l("datum"), t.pointRadius),
    ...
    ut(KM, pa, {
        transform(t, e) {
            ...
            if (!r.length || t.modified())
                for (const e in t)
                    H(i[e]) && i[e](t[e]);
            return n = i(),
            r.length ? e.mod.push(Po(r[0], n)) : e.add.push(Lo(n)),
            r[0] = n,
            e
        }
    }),
        ...
        transform(t, e) {
            ...
            var n = e.materialize(e.SOURCE).source
              ...
              , o = function(t, e) {
                let n;
                H(t) ? (n = n=>t(n, e),
                n.dep = eA(t)) : t ? n = Z(t) : (n = t=>t.$value / t.$max || 0,
                n.dep = !0);
                return n
            }(t.opacity, t)
              , a = function(t, e) {
              ...
              , s = {
                ...
                $y: 0,
                $value: 0,
                $max: r ? Ce(n.map((t=>Ce(i(t).values)))) : 0
            };
            return n.forEach((t=>{
                const e = i(t)
                  , n = K({}, t, s);
    ...
    function oA(t, e, n, r) {
        if (isNaN(e) || isNaN(n))
            return t;
        var i, o, a, u, s, l, c, f, h, d = t._root, p = {
            data: r
        }, g = t._x0, m = t._y0, y = t._x1, v = t._y1;
        if (!d)
            return t._root = p,
            t;
        for (; d.length; )
            if ((l = e >= (o = (g + y) / 2)) ? g = o : y = o,
            (c = n >= (a = (m + v) / 2)) ? m = a : v = a,
            i = d,
            !(d = d[f = c << 1 | l]))
                return i[f] = p,
    ...
    hA.addAll = function(t) {
        ...
        for (n = 0; n < o; ++n)
            isNaN(r = +this._x.call(null, e = t[n])) || isNaN(i = +this._y.call(null, e)) || (a[n] = r,
            u[n] = i,
            r < s && (s = r),
            r > c && (c = r),
            i < l && (l = i),
    ...
    hA.find = function(t, e, n) {
        ...
        for (g && p.push(new aA(g,c,f,h,d)),
        null == n ? n = 1 / 0 : (c = t - n,
        f = e - n,
        h = t + n,
        d = e + n,
        n *= n); s = p.pop(); )
            if (!(!(g = s.node) || (i = s.x0) > h || (o = s.y0) > d || (a = s.x1) < c || (u = s.y1) < f))
                if (g.length) {
                    var m = (i + a) / 2
                      , y = (o + u) / 2;
                    p.push(new aA(g[3],m,y,a,u), new aA(g[2],i,y,m,u), new aA(g[1],m,o,a,y), new aA(g[0],i,o,m,y)),
                    (l = (e >= y) << 1 | t >= m) && (s = p[p.length - 1],
    ...
    hA.visit = function(t) {
        ...
        for (s && u.push(new aA(s,this._x0,this._y0,this._x1,this._y1)); e = u.pop(); )
            if (!t(s = e.node, r = e.x0, i = e.y0, o = e.x1, a = e.y1) && s.length) {
                var l = (r + o) / 2
                  , c = (i + a) / 2;
                (n = s[3]) && u.push(new aA(n,l,c,o,a)),
                (n = s[2]) && u.push(new aA(n,r,c,l,a)),
                (n = s[1]) && u.push(new aA(n,l,i,o,c)),
                (n = s[0]) && u.push(new aA(n,r,i,l,c))
            }
        return this
    }
    ,
    hA.visitAfter = function(t) {
        ...
        for (this._root && n.push(new aA(this._root,this._x0,this._y0,this._x1,this._y1)); e = n.pop(); ) {
            ...
            if (i.length) {
                ...
                (o = i[0]) && n.push(new aA(o,a,u,c,f)),
                (o = i[1]) && n.push(new aA(o,c,u,s,f)),
                (o = i[2]) && n.push(new aA(o,a,f,c,l)),
                (o = i[3]) && n.push(new aA(o,c,f,s,l))
            }
            r.push(e)
        }
        for (; e = r.pop(); )
            ...
            if (!(arguments.length < 2)) {
                ...
                for (; ++o < a; )
                    if (n = (t = i[o]).type)
                        ...
                        for (n in r)
                            r[n] = MA(r[n], t.name, null);
                return this
            }
            for (; ++o < a; )
                if ((n = (t = i[o]).type) && (n = kA(r[n], t.name)))
                    return n
        },
        copy: function() {
            var t = {}
    ...
    var AA, EA, DA = 0, CA = 0, FA = 0, SA = 0, BA = 0, TA = 0, zA = "object" == typeof performance && performance.now ? performance : Date, NA = "object" == typeof window && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function(t) {
        setTimeout(t, 17)
    }
    ;
    function OA() {
    ...
    function qA() {
        ...
        try {
            !function() {
                ...
                ++DA;
                for (var t, e = AA; e; )
                    (t = BA - e._time) >= 0 && e._call.call(null, t),
                    e = e._next;
                --DA
            }()
        } finally {
    ...
    function jA(t) {
        DA || (CA && (CA = clearTimeout(CA)),
        t - BA > 24 ? (t < 1 / 0 && (CA = setTimeout(qA, t - zA.now() - TA)),
        FA && (FA = clearInterval(FA))) : (FA || (SA = zA.now(),
        FA = setInterval(PA, 1e3)),
        DA = 1,
        NA(qA)))
    }
    LA.prototype = UA.prototype = {
        ...
        restart: function(t, e, n) {
            ...
            n = (null == n ? OA() : +n) + (null == e ? 0 : +e),
            this._next || EA === this || (EA ? EA._next = this : AA = this,
            EA = this),
            this._call = t,
            this._time = n,
            jA()
    ...
    function YA(t) {
        var e, n = 1, r = .001, i = 1 - Math.pow(r, 1 / 300), o = 0, a = .6, u = new Map, s = UA(f), l = xA("tick", "end"), c = function() {
            let t = 1;
        ...
        function h(r) {
            ...
            for (var f = 0; f < r; ++f)
                ...
                s = 0; s < c; ++s)
                    null == (l = t[s]).fx ? l.x += l.vx *= a : (l.x = l.fx,
                    l.vx = 0),
                    null == l.fy ? l.y += l.vy *= a : (l.y = l.fy,
                    l.vy = 0);
            return e
        }
        function d() {
        ...
        function p(e) {
            return e.initialize && e.initialize(t, c),
            e
        }
        return null == t && (t = []),
        d(),
        e = {
            ...
            force: function(t, n) {
                return arguments.length > 1 ? (null == n ? u.delete(t) : u.set(t, p(n)),
                e) : u.get(t)
            },
            find: function(e, n, r) {
                ...
                l = 0; l < c; ++l)
                    (a = (i = e - (u = t[l]).x) * i + (o = n - u.y) * o) < r && (s = u,
                    r = a);
                return s
            },
            on: function(t, n) {
                return arguments.length > 1 ? (l.on(t, n),
                e) : l.on(t)
            }
        }
    }
    const VA = {
        ...
        collide: function(t) {
            ...
            function a() {
                ...
                function g(t, e, n, o, a) {
                    var u = t.data
                      ...
                      , p = f + d;
                    if (!u)
                        return e > l + p || o < l - p || n > c + p || a < c - p;
                    if (u.index > s.index) {
                        var g = l - u.x - u.vx
                          , m = c - u.y - u.vy
                          , y = g * g + m * m;
                        y < p * p && (0 === g && (y += (g = pA(r)) * g),
                        0 === m && (y += (m = pA(r)) * m),
            ...
            return "function" != typeof t && (t = dA(null == t ? 1 : +t)),
            ...
            ,
            a.radius = function(e) {
                return arguments.length ? (t = "function" == typeof e ? e : dA(+e),
                s(),
                a) : t
            }
            ,
        ...
        nbody: function() {
            ...
            function f(t) {
                ...
                if (t.length) {
                    for (r = o = a = 0; a < 4; ++a)
                        (e = t[a]) && (n = Math.abs(e.value)) && (u += e.value,
                        s += n,
                        r += n * e.x,
                        o += n * e.y);
                    t.x = r / s,
            ...
            function h(t, o, l, c) {
                ...
                if (d * d / s < p)
                    ...
                    !0;
                if (!(t.length || p >= u)) {
                    (t.data !== e || t.next) && (0 === f && (p += (f = pA(n)) * f),
                    0 === h && (p += (h = pA(n)) * h),
                    p < a && (p = Math.sqrt(a * p)));
                    do {
                        t.data !== e && (d = i[t.data.index] * r / p,
                        e.vx += f * d,
                        e.vy += h * d)
                    } while (t = t.next)
                }
            ...
            l.strength = function(t) {
                return arguments.length ? (o = "function" == typeof t ? t : dA(+t),
                c(),
                l) : o
            }
            ,
        ...
        link: function(t) {
            ...
            function f(r) {
                for (var i = 0, u = t.length; i < c; ++i)
                    for (var s, l, f, h, d, p, g, m = 0; m < u; ++m)
                        l = (s = t[m]).source,
                        h = (f = s.target).x + f.vx - l.x - l.vx || pA(a),
                        d = f.y + f.vy - l.y - l.vy || pA(a),
                        h *= p = ((p = Math.sqrt(h * h + d * d)) - n[m]) / p * r * e[m],
                        d *= p,
                        f.vx -= h * (g = o[m]),
                        f.vy -= d * g,
                        l.vx += h * (g = 1 - g),
            ...
            function h() {
                if (r) {
                    ...
                    i = new Array(l); a < c; ++a)
                        (s = t[a]).index = a,
                        "object" != typeof s.source && (s.source = vA(f, s.source)),
                        "object" != typeof s.target && (s.target = vA(f, s.target)),
            ...
            f.strength = function(t) {
                return arguments.length ? (s = "function" == typeof t ? t : dA(+t),
                d(),
                f) : s
            }
            ,
            f.distance = function(t) {
                return arguments.length ? (l = "function" == typeof t ? t : dA(+t),
                p(),
                f) : l
            }
            ,
        ...
        x: function(t) {
            ...
            return "function" != typeof t && (t = dA(null == t ? 0 : +t)),
            ...
            o.strength = function(t) {
                return arguments.length ? (i = "function" == typeof t ? t : dA(+t),
                a(),
                o) : i
            }
            ,
      ...
      , GA = "forces"
      , XA = ["alpha", "alphaMin", "alphaTarget", "velocityDecay", "forces"]
      , JA = ["static", "iterations"]
      , ZA = ["x", "y", "vx", "vy"];
    function QA(t) {
        pa.call(this, null, t)
    }
    function KA(t, e, n, r) {
        ...
        for (i = 0,
        o = XA.length; i < o; ++i)
            (a = XA[i]) !== GA && e.modified(a) && t[a](e[a]);
        for (i = 0,
        o = s.length; i < o; ++i)
            u = GA + i,
            (a = n || e.modified(GA, i) ? eE(s[i]) : r && tE(s[i], r) ? t.force(u) : null) && t.force(u, a);
        for (o = t.numForces || 0; i < o; ++i)
            t.force(GA + i, null);
        return t.numForces = s.length,
        t
    }
    function tE(t, e) {
        var n, i;
        for (n in t)
            if (H(i = t[n]) && e.modified(r(i)))
                return 1;
        return 0
    }
    function eE(t) {
        var e, n;
        for (n in rt(VA, t.force) || u("Unrecognized force: " + t.force),
        e = VA[t.force](),
        t)
            H(e[n]) && nE(e[n], t[n], t);
        return e
    ...
    ut(QA, pa, {
        transform(t, e) {
            ...
            if (i ? (o && (e.modifies("index"),
            i.nodes(e.source)),
            (a || e.changed(e.MOD)) && KA(i, t, 0, e)) : (this.value = i = function(t, e) {
                const n = YA(t)
                  , r = n.stop
                  , i = n.restart;
                let o = !1;
            ...
            i.on("tick", (n = e.dataflow,
            r = this,
            ()=>n.touch(r).run())),
            t.static || (o = !0,
            i.tick()),
            e.modifies("index")),
            a || o || t.modified(JA) || e.changed() && t.restart)
                if (i.alpha(Math.max(i.alpha(), t.alpha || 1)).alphaDecay(1 - Math.pow(i.alphaMin(), 1 / u)),
                t.static)
                    for (i.stop(); --u >= 0; )
                        i.tick();
                else if (i.stopped() && i.restart(),
                !o)
                    return e.StopPropagation;
        ...
        finish(t, e) {
            ...
            for (let t, e = this._argops, u = 0, s = e.length; u < s; ++u)
                if (t = e[u],
                t.name === GA && "link" === t.op._argval.force)
    ...
    function sE(t, e) {
        ...
        void 0 === e && (e = cE)) : void 0 === e && (e = lE);
        for (var n, r, i, o, a, u = new dE(t), s = [u]; n = s.pop(); )
            if ((i = e(n.data)) && (a = (i = Array.from(i)).length))
                for (n.children = i,
                o = a - 1; o >= 0; --o)
                    s.push(r = i[o] = new dE(i[o])),
                    r.parent = n,
                    r.depth = n.depth + 1;
    ...
    function gE(t, e) {
        ...
        for (n = 0; n < t.length; ++n)
            if (mE(e, t[n]) && vE(xE(t[n], e), t))
                return [t[n], e];
        for (n = 0; n < t.length - 1; ++n)
            for (r = n + 1; r < t.length; ++r)
                if (mE(xE(t[n], t[r]), e) && mE(xE(t[n], e), t[r]) && mE(xE(t[r], e), t[n]) && vE(bE(t[n], t[r], e), t))
                    return [t[n], t[r], e];
        throw new Error
    }
    function mE(t, e) {
    ...
    function wE(t, e, n) {
        ...
        n.x = t.x - r * u - o * s,
        n.y = t.y - r * s + o * u) : (r = (l + i - a) / (2 * l),
        o = Math.sqrt(Math.max(0, i / l - r * r)),
        n.x = e.x + r * u - o * s,
        n.y = e.y + r * s + o * u)) : (n.x = e.x + n.r,
        n.y = e.y)
    }
    function kE(t, e) {
        var n = t.r + e.r - 1e-6
    ...
    function RE(t, e, n, r, i) {
        for (var o, a = t.children, u = -1, s = a.length, l = t.value && (r - e) / t.value; ++u < s; )
            (o = a[u]).y0 = n,
            o.y1 = i,
            o.x0 = e,
            o.x1 = e += o.value * l
    ...
    function jE() {
        ...
        function n(n) {
            ...
            for (i = 0; i < f; ++i)
                r = c[i],
                u = c[i] = new dE(r),
                null != (s = t(r, i, n)) && (s += "") && (l = u.id = s,
                h.set(l, h.has(l) ? UE : u)),
                null != (s = e(r, i, n)) && (s += "") && (u.parent = s);
            for (i = 0; i < f; ++i)
                if (s = (u = c[i]).parent) {
                    if (!(a = h.get(s)))
        ...
        return n.id = function(e) {
            return arguments.length ? (t = CE(e),
            n) : t
        }
        ,
        n.parentId = function(t) {
            return arguments.length ? (e = CE(t),
            n) : e
        }
        ,
        n
    ...
    function GE(t, e, n, r, i) {
        for (var o, a = t.children, u = -1, s = a.length, l = t.value && (i - n) / t.value; ++u < s; )
            (o = a[u]).x0 = e,
            o.x1 = r,
            o.y0 = n,
            o.y1 = n += o.value * l
    ...
    function JE(t, e, n, r, i, o) {
        for (var a, u, s, l, c, f, h, d, p, g, m, y = [], v = e.children, _ = 0, x = 0, b = v.length, w = e.value; _ < b; ) {
            ...
            a.dice ? RE(a, n, r, i, w ? r += l * c / w : o) : GE(a, n, r, w ? n += s * c / w : i, o),
            w -= c,
            _ = x
        }
        return y
        ...
        function n(t, n, r, i, o) {
            if ((a = t._squarify) && a.ratio === e)
                for (var a, u, s, l, c, f = -1, h = a.length, d = t.value; ++f < h; ) {
                    for (s = (u = a[f]).children,
                    l = u.value = 0,
                    c = s.length; l < c; ++l)
                        u.value += s[l].value;
                    u.dice ? RE(u, n, r, i, d ? r += (o - r) * u.value / d : o) : GE(u, n, r, d ? n += (i - n) * u.value / d : i, o),
                    d -= u.value
                }
            else
                t._squarify = a = JE(e, t, n, r, i, o),
                a.ratio = e
        }
        return n.ratio = function(e) {
            return t((e = +e) > 1 ? e : 1)
    ...
    ut(tD, pa, {
        transform(t, e) {
            ...
            this.value = o = sE({
                values: $(t.keys).reduce(((t,e)=>(t.key(e),
                t)), nD()).entries(i.source)
            }, eD),
            n && o.each((t=>{
                t.children && (t = Lo(t.data),
                i.add.push(t),
                i.source.push(t))
            }
            )),
    ...
    ut(rD, pa, {
        transform(t, e) {
            ...
            t.sort && i.sort(jo(t.sort, (t=>t.data))),
            function(t, e, n) {
                for (let r, i = 0, o = e.length; i < o; ++i)
                    r = e[i],
                    r in n && t[r](n[r])
            }(n, this.params, t),
            n.separation && n.separation(!1 !== t.separation ? iD : d);
            try {
                this.value = n(i)
            } catch (t) {
                u(t)
    ...
    ut(aD, rD, {
        layout: function() {
            ...
            function i(i) {
                return i.x = e / 2,
                i.y = n / 2,
                t ? i.eachBefore(TE(t)).eachAfter(zE(r, .5)).eachBefore(NE(1)) : i.eachBefore(TE(BE)).eachAfter(zE(FE, 1)).eachAfter(zE(r, i.r / Math.min(e, n))).eachBefore(NE(Math.min(e, n) / (2 * i.r))),
                i
            }
            return i.radius = function(e) {
                return arguments.length ? (t = DE(e),
                i) : t
            }
            ,
            i.size = function(t) {
            ...
            i.padding = function(t) {
                return arguments.length ? (r = "function" == typeof t ? t : SE(+t),
                i) : r
            }
            ,
            i
    ...
    ut(lD, pa, {
        transform(t, e) {
            ...
            return i.source = i.source.slice(),
            o && (n = i.source.length ? KE(jE().id(t.key).parentId(t.parentKey)(i.source), t.key, p) : KE(jE()([{}]), t.key, t.key)),
    ...
    const cD = {
        tidy: function() {
            ...
            function i(i) {
                var s = function(t) {
                    for (var e, n, r, i, o, a = new VE(t,0), u = [a]; e = u.pop(); )
                        if (r = e._.children)
                            for (e.children = new Array(o = r.length),
                            i = o - 1; i >= 0; --i)
                                u.push(n = e.children[i] = new VE(r[i],i)),
                                n.parent = e;
                    return (a.parent = new VE(null,0)).children = [a],
                    a
                }(i);
                if (s.eachAfter(o),
                s.parent.m = -s.z,
            ...
            function o(e) {
                ...
                e.parent.A = function(e, n, r) {
                    if (n) {
                        for (var i, o = e, a = e, u = n, s = o.parent.children[0], l = o.m, c = a.m, f = u.m, h = s.m; u = WE(u),
                        o = $E(o),
                        u && o; )
                            s = $E(s),
                            (a = WE(a)).a = e,
                            (i = u.z + f - o.z - l + t(u._, o._)) > 0 && (HE(YE(u, e, r), e, i),
                            l += i,
                            c += i),
                            f += u.m,
                            l += o.m,
    ...
    ut(dD, pa, {
        transform(t, e) {
            const n = this.value
              ...
              , o = {};
            return r || u("TreeLinks transform requires a tree data source."),
            e.changed(e.ADD_REM) ? (i.rem = n,
            e.visit(e.SOURCE, (t=>o[Oo(t)] = 1)),
            r.each((t=>{
                const e = t.data
                  , n = t.parent && t.parent.data;
                n && o[Oo(e)] && o[Oo(n)] && i.add.push(Lo({
                    source: n,
                    target: e
                }))
            }
            )),
            this.value = i.add) : e.changed(e.MOD) && (e.visit(e.MOD, (t=>o[Oo(t)] = 1)),
            n.forEach((t=>{
        ...
        layout() {
            const t = function() {
                ...
                function f(e) {
                    ...
                    e.x1 = f,
                    e.y1 = h,
                    e.children && (n = i[e.depth + 1] = o(e) / 2,
                    r += l(e) - n,
                    c += a(e) - n,
                    (f -= u(e) - n) < r && (r = f = (r + f) / 2),
                    (h -= s(e) - n) < c && (c = h = (c + h) / 2),
                ...
                c.paddingInner = function(t) {
                    return arguments.length ? (o = "function" == typeof t ? t : SE(+t),
                    c) : o
                }
                ,
                ...
                c.paddingTop = function(t) {
                    return arguments.length ? (a = "function" == typeof t ? t : SE(+t),
                    c) : a
                }
                ,
                c.paddingRight = function(t) {
                    return arguments.length ? (u = "function" == typeof t ? t : SE(+t),
                    c) : u
                }
                ,
                c.paddingBottom = function(t) {
                    return arguments.length ? (s = "function" == typeof t ? t : SE(+t),
                    c) : s
                }
                ,
                c.paddingLeft = function(t) {
                    return arguments.length ? (l = "function" == typeof t ? t : SE(+t),
                    c) : l
                }
                ,
                c
    ...
    function vD(t, e, n, r) {
        const i = t.width
          , o = t.height
          , a = n || r
          , u = Gl(i, o).getContext("2d");
        e.forEach((t=>_D(u, t, a)));
        const s = new Uint32Array(u.getImageData(0, 0, i, o).data.buffer)
          , l = t.bitmap()
          , c = a && t.bitmap();
        let f, h, d, p, g;
        for (h = 0; h < o; ++h)
            for (f = 0; f < i; ++f)
                g = 4278190080 & s[h * i + f],
                g && (d = t(f),
                p = t(h),
                r || l.set(d, p),
                a && 268435456 ^ g && c.set(d, p));
        return [l, c]
    }
    function _D(t, e, n) {
        if (!e.length)
    ...
    function xD(t) {
        const e = qo(t, {});
        return e.stroke && (e.strokeOpacity = 1),
        e.fill && (e.fillOpacity = .0625,
        e.stroke = "#000",
        e.strokeOpacity = 1,
        e.strokeWidth = 2),
        e
    ...
    const bD = 31
      , wD = new Uint32Array(33)
      , kD = new Uint32Array(33);
    kD[0] = 0,
    wD[0] = ~kD[0];
    for (let t = 1; t <= 32; ++t)
        kD[t] = kD[t - 1] << 1 | 1,
    ...
    function MD(t, e, n) {
        const r = Math.max(1, Math.sqrt(t * e / 1e6))
          ...
          , o = ~~((e + 2 * n + r) / r)
          , a = t=>~~((t + n) / r);
        return a.invert = t=>t * r - n,
        a.bitmap = ()=>function(t, e) {
    ...
    const DD = [-1, -1, 1, 1]
      , CD = [-1, 1, -1, 1];
    const FD = ["right", "center", "left"]
      , SD = ["bottom", "middle", "top"];
      ...
      , zD = {
        naive: function(t, e, n, r) {
            ...
            return function(t) {
                ...
                f = t.y + d,
                t.align = "center",
                s < 0 && l <= i ? t.align = "left" : 0 <= s && i < l && (t.align = "right"),
                t.baseline = "middle",
                c < 0 && f <= o ? t.baseline = "top" : 0 <= c && o < f && (t.baseline = "bottom"),
                !0
            }
        },
                ...
                for (let r = 0; r < l; ++r) {
                    ...
                    for (v = b; v <= w; ++v)
                        for (_ = M; _ <= A; ++_)
                            D = s(v, _, F, f, c),
                            D && ([e.x,e.y,F,S] = D);
                    S || n || (E = Math.abs(d - h + g - p),
                    m = (h + d) / 2,
                    y = (p + g) / 2,
                    E >= T && !AD(m, y, f, c, i, o) && !ED(t, m, y, c, f, c, a, null) && (T = E,
                    e.x = m,
                    e.y = y,
                    B = !0))
                }
        ...
        floodfill: function(t, e, n, r) {
            ...
            return function(e) {
                const l = e.datum.datum.items[r].items
                  , c = l.length
                  , f = e.datum.fontSize
                  , h = Cm.width(e.datum, e.datum.text)
                  , d = [];
                ...
                for (let r = 0; r < c; ++r) {
                    ...
                    d.push([t((p + g) / 2), t((m + y) / 2)]); d.length; )
                        if ([x,b] = d.pop(),
                        !(a.get(x, b) || u.get(x, b) || s.get(x, b))) {
                            ...
                            w = E,
                            k = o,
                            !AD(v, _, h, f, i, o) && !ED(t, v, _, f, h, w, a, u) && !ED(t, v, _, f, h, f, a, null)) {
                                for (; k - w >= 1; )
                                    M = (w + k) / 2,
                                    ED(t, v, _, f, h, M, a, u) ? k = M : w = M;
                                w > E && (e.x = v,
                                e.y = _,
                                E = w,
                                D = !0)
                    ...
                    D || n || (A = Math.abs(g - p + y - m),
                    v = (p + g) / 2,
                    _ = (m + y) / 2,
                    A >= F && !AD(v, _, h, f, i, o) && !ED(t, v, _, f, h, f, a, null) && (F = A,
                    e.x = v,
                    e.y = _,
                    C = !0))
                }
    ...
    function ND(t, e, n, r, i, o, a, u, s, l, c) {
        ...
        const f = Math.max(r.length, i.length)
          ...
          , y = function(t, e, n, r) {
            ...
            return t ? "line" === t || "area" === t ? t=>i(t.datum) : "line" === e ? t=>{
                ...
                return i(e.length ? e["start" === n ? 0 : e.length - 1] : {
                    x: NaN,
                    y: NaN
                })
            }
        ...
        if (!_) {
            ...
            let e = !1;
            for (let t = 0; t < d.length && !e; ++t)
                e = 5 === d[t] || h[t] < 0;
            p && (a || m) && (o = [t.map((t=>t.datum))].concat(o)),
            w = o.length ? vD(v, o, e, m) : function(t, e) {
                const n = t.bitmap();
                return (e || []).forEach((e=>n.set(t(e.boundary[0]), t(e.boundary[3])))),
                [n, void 0]
            }(v, a && b)
        }
        const k = m ? zD[c](v, w, a, s) : function(t, e, n, r) {
            ...
            return function(e) {
                ...
                for (let i = 0; i < s; ++i) {
                    ...
                    w = t(m),
                    k = t(y),
                    BD(w, k, M, A, a, u, m, y, v, _, l, d))
                        return e.x = f ? f * g < 0 ? y : m : x,
                        e.y = h ? h * g < 0 ? _ : v : b,
                        e.align = FD[f * g + 1],
                        e.baseline = SD[h * g + 1],
                        a.setRange(w, M, k, A),
        ...
        return b.forEach((t=>t.opacity = +k(t))),
        b
    }
    ...
    ut(PD, pa, {
        transform(t, e) {
            const r = e.fork(e.NO_SOURCE | e.NO_FIELDS);
            if (!this.value || e.changed() || t.modified()) {
                const i = qD(e.materialize(e.SOURCE).source, t.groupby)
                  , o = (t.groupby || []).map(n)
                  , a = o.length
                  , u = t.as || [n(t.x), n(t.y)]
                  , s = [];
        ...
        transform(t, e) {
            ...
            if (!this.value || e.changed() || t.modified()) {
                const i = qD(e.materialize(e.SOURCE).source, t.groupby)
                  ...
                  , h = [];
                let d = t.extent;
                rt(jD, a) || u("Invalid regression method: " + a),
                null != d && "log" === a && d[0] <= 0 && (e.dataflow.warn("Ignoring extent with values <= 0 for log regression."),
                d = null),
                i.forEach((n=>{
                    if (n.length <= l)
                        return void e.dataflow.warn("Skipping regression with more parameters than data points.");
                    const r = f(n, t.x, t.y, s);
                    if (t.params)
                        return void h.push(Lo({
                            keys: n.dims,
                            coef: r.coef,
                            rSquared: r.rSquared
                        }));
    ...
    const WD = Math.pow(2, -52)
      , HD = new Uint32Array(512);
    class YD {
        ...
        update() {
            const {coords: t, _hullPrev: e, _hullNext: n, _hullTri: r, _hullHash: i} = this
              , o = t.length >> 1;
            let a = 1 / 0
              , u = 1 / 0
              , s = -1 / 0
            ...
            if (x === 1 / 0) {
                ...
                for (let t = 0, r = -1 / 0; t < o; t++) {
                    const i = this._ids[t];
                    this._dists[i] > r && (e[n++] = i,
                    r = this._dists[i])
                }
                return this.hull = e.subarray(0, n),
            ...
            this._cy = k.y;
            for (let e = 0; e < o; e++)
                this._dists[e] = VD(t[2 * e], t[2 * e + 1], k.x, k.y);
            QD(this._ids, this._dists, 0, o - 1),
            this._hullStart = h;
            let M = 3;
            n[h] = e[p] = d,
            ...
            for (let o, a, u = 0; u < this._ids.length; u++) {
                const s = this._ids[u]
                  , l = t[2 * s]
                  , c = t[2 * s + 1];
                if (u > 0 && Math.abs(l - o) <= WD && Math.abs(c - a) <= WD)
                    continue;
                if (o = l,
                a = c,
                s === h || s === d || s === p)
                    continue;
                let f = 0;
                for (let t = 0, e = this._hashKey(l, c); t < this._hashSize && (f = i[(e + t) % this._hashSize],
                -1 === f || f === n[f]); t++)
                    ;
                f = e[f];
                let g, m = f;
                for (; g = n[m],
                !XD(l, c, t[2 * m], t[2 * m + 1], t[2 * g], t[2 * g + 1]); )
                    if (m = g,
                    m === f) {
                        m = -1;
                        break
                ...
                let v = n[m];
                for (; g = n[v],
                XD(l, c, t[2 * v], t[2 * v + 1], t[2 * g], t[2 * g + 1]); )
                ...
                if (m === f)
                    for (; g = e[m],
                    XD(l, c, t[2 * g], t[2 * g + 1], t[2 * m], t[2 * m + 1]); )
    ...
    function QD(t, e, n, r) {
        if (r - n <= 20)
            ...
            let i = n + 1
              , o = r;
            KD(t, n + r >> 1, i),
            e[t[n]] > e[t[r]] && KD(t, n, r),
            e[t[i]] > e[t[r]] && KD(t, i, r),
            e[t[n]] > e[t[i]] && KD(t, n, i);
            const a = t[i]
              , u = e[a];
            for (; ; ) {
                do {
            ...
            t[n + 1] = t[o],
            t[o] = a,
            r - i + 1 >= o - n ? (QD(t, e, i, r),
            QD(t, e, n, o - 1)) : (QD(t, e, n, o - 1),
            QD(t, e, i, r))
        }
    }
    function KD(t, e, n) {
    ...
    class rC {
        ...
        arc(t, e, n) {
            ...
            null === this._x1 ? this._ += "M".concat(r, ",").concat(i) : (Math.abs(this._x1 - r) > nC || Math.abs(this._y1 - i) > nC) && (this._ += "L" + r + "," + i),
            n && (this._ += "A".concat(n, ",").concat(n, ",0,1,1,").concat(t - n, ",").concat(e, "A").concat(n, ",").concat(n, ",0,1,1,").concat(this._x1 = r, ",").concat(this._y1 = i))
        }
        rect(t, e, n, r) {
    ...
    class oC {
        ...
        _init() {
            ...
            for (let e, r, o = 0, a = 0, u = n.length; o < u; o += 3,
            a += 2) {
                const u = 2 * n[o]
                  , s = 2 * n[o + 1]
                  , l = 2 * n[o + 2]
        ...
        render(t) {
            const e = null == t ? t = new rC : void 0
              , {delaunay: {halfedges: n, inedges: r, hull: i}, circumcenters: o, vectors: a} = this;
            if (i.length <= 1)
                return null;
        ...
        renderCell(t, e) {
            const n = null == e ? e = new rC : void 0
              , r = this._clip(t);
            if (null === r || !r.length)
                return;
            e.moveTo(r[0], r[1]);
            ...
            for (; r[0] === r[i - 2] && r[1] === r[i - 1] && i > 1; )
                i -= 2;
            for (let t = 2; t < i; t += 2)
                r[t] === r[t - 2] && r[t + 1] === r[t - 1] || e.lineTo(r[t], r[t + 1]);
            return e.closePath(),
            n && n.value()
        }
        *cellPolygons() {
        ...
        _renderSegment(t, e, n, r, i) {
            ...
            0 === a && 0 === u ? (i.moveTo(t, e),
            i.lineTo(n, r)) : (o = this._clipSegment(t, e, n, r, a, u)) && (i.moveTo(o[0], o[1]),
            i.lineTo(o[2], o[3]))
        }
        contains(t, e, n) {
        ...
        *neighbors(t) {
                    ...
                    if (t)
                        t: for (let r = 0, i = e.length; r < i; r += 2)
                            for (let o = 0, a = t.length; o < a; o += 2)
                                if (e[r] == t[o] && e[r + 1] == t[o + 1] && e[(r + 2) % i] == t[(o + a - 2) % a] && e[(r + 3) % i] == t[(o + a - 1) % a]) {
                                    yield n;
                                    break t
                                }
                }
        ...
        _cell(t) {
            const {circumcenters: e, delaunay: {inedges: n, halfedges: r, triangles: i}} = this
              , o = n[t];
            if (-1 === o)
                return null;
            const a = [];
        ...
        _clipFinite(t, e) {
            ...
            for (let h = 0; h < n; h += 2)
                ...
                0 === o && 0 === f)
                    ...
                    let e, n, h, d, p;
                    if (0 === o) {
                        if (null === (e = this._clipSegment(r, i, l, c, o, f)))
                            continue;
                        [n,h,d,p] = e
                    } else {
                        if (null === (e = this._clipSegment(l, c, r, i, f, o)))
                            continue;
                        [d,p,n,h] = e,
                        a = u,
                        u = this._edgecode(n, h),
                        a && u && this._edge(t, a, u, s, s.length),
                        s ? s.push(n, h) : s = [n, h]
                    }
                    a = u,
        ...
        _clipSegment(t, e, n, r, i, o) {
            for (; ; ) {
                ...
                if (i & o)
                    return null;
                let a, u, s = i || o;
                8 & s ? (a = t + (n - t) * (this.ymax - e) / (r - e),
                u = this.ymax) : 4 & s ? (a = t + (n - t) * (this.ymin - e) / (r - e),
                u = this.ymin) : 2 & s ? (u = e + (r - e) * (this.xmax - t) / (n - t),
                a = this.xmax) : (u = e + (r - e) * (this.xmin - t) / (n - t),
                a = this.xmin),
                i ? (t = a,
                e = u,
                i = this._regioncode(t, e)) : (n = a,
                r = u,
                o = this._regioncode(n, r))
            }
        }
        _clipInfinite(t, e, n, r, i, o) {
            let a, u = Array.from(e);
            if ((a = this._project(u[0], u[1], n, r)) && u.unshift(a[0], a[1]),
            (a = this._project(u[u.length - 2], u[u.length - 1], i, o)) && u.push(a[0], a[1]),
            u = this._clipFinite(t, u))
                for (let e, n = 0, r = u.length, i = this._edgecode(u[r - 2], u[r - 1]); n < r; n += 2)
                    e = i,
                    i = this._edgecode(u[n], u[n + 1]),
                    e && i && (n = this._edge(t, e, i, u, n),
                    r = u.length);
            else
        ...
        _edge(t, e, n, r, i) {
            for (; e !== n; ) {
                ...
                r[i] === n && r[i + 1] === o || !this.contains(t, n, o) || (r.splice(i, 0, n, o),
                i += 2)
            }
            if (r.length > 4)
                for (let t = 0; t < r.length; t += 2) {
                    const e = (t + 2) % r.length
                      , n = (t + 4) % r.length;
                    (r[t] === r[e] && r[e] === r[n] || r[t + 1] === r[e + 1] && r[e + 1] === r[n + 1]) && (r.splice(e, 2),
                    t -= 2)
                }
            return i
        }
        _project(t, e, n, r) {
            ...
            if (r < 0) {
                if (e <= this.ymin)
                    return null;
                (i = (this.ymin - e) / r) < u && (a = this.ymin,
                o = t + (u = i) * n)
            } else if (r > 0) {
                if (e >= this.ymax)
                    return null;
                (i = (this.ymax - e) / r) < u && (a = this.ymax,
                o = t + (u = i) * n)
            }
            if (n > 0) {
                if (t >= this.xmax)
                    return null;
                (i = (this.xmax - t) / n) < u && (o = this.xmax,
                a = e + (u = i) * r)
            } else if (n < 0) {
                if (t <= this.xmin)
                    return null;
                (i = (this.xmin - t) / n) < u && (o = this.xmin,
                a = e + (u = i) * r)
            }
            return [o, a]
        }
    ...
    class fC {
            ...
            if (t.hull && t.hull.length > 2 && function(t) {
                ...
                for (let t = 0; t < e.length; t += 3) {
                    const r = 2 * e[t]
                      , i = 2 * e[t + 1]
                      , o = 2 * e[t + 2];
                    if ((n[o] - n[r]) * (n[i + 1] - n[r + 1]) - (n[i] - n[r]) * (n[o + 1] - n[r + 1]) > 1e-10)
                        return !1
                }
                return !0
            }(t)) {
        ...
        *neighbors(t) {
        ...
        find(t, e, n=0) {
            ...
            const r = n;
            let i;
            for (; (i = this._step(n, t, e)) >= 0 && i !== n && i !== r; )
                n = i;
            return i
        }
        _step(t, e, n) {
            ...
            if (-1 === r[t] || !s.length)
                return (t + 1) % (s.length >> 1);
            let l = t
              , c = uC(e - s[2 * t], 2) + uC(n - s[2 * t + 1], 2);
            const f = r[t];
            let h = f;
            do {
                let r = u[h];
                ...
                -1 === h) {
                    ...
                    h !== r && uC(e - s[2 * h], 2) + uC(n - s[2 * h + 1], 2) < c)
                        return h;
                    break
                }
            } while (h !== f);
        ...
        renderPoints(t, e=2) {
            const n = null == t ? t = new rC : void 0
              , {points: r} = this;
        ...
        *trianglePolygons() {
        ...
        trianglePolygon(t) {
            const e = new iC;
            return this.renderTriangle(t, e),
            e.value()
        }
    }
    function hC(t) {
    ...
    function vC() {
        ...
        function h(t, e, n) {
            for (var r, i, o, a = e.x, l = e.y, f = Math.sqrt(u[0] * u[0] + u[1] * u[1]), h = s(u), d = c() < .5 ? 1 : -1, p = -d; (r = h(p += d)) && (i = ~~r[0],
            o = ~~r[1],
            !(Math.min(Math.abs(i), Math.abs(o)) >= f)); )
                if (e.x = a + i,
                e.y = l + o,
                !(e.x + e.x0 < 0 || e.y + e.y0 < 0 || e.x + e.x1 > u[0] || e.y + e.y1 > u[1]) && (!n || !xC(e, t, u[0])) && (!n || wC(e, n))) {
                    for (var g, m = e.sprite, y = e.width >> 5, v = u[0] >> 5, _ = e.x - (y << 4), x = 127 & _, b = 32 - x, w = e.y1 - e.y0, k = (e.y + e.y0) * v + (_ >> 5), M = 0; M < w; M++) {
                        g = 0;
                        for (var A = 0; A <= y; A++)
                            t[k + A] |= g << b | (A < y ? (g = m[M * y + A]) >>> x : 0);
                        k += v
                    }
        ...
        ,
        f.size = function(t) {
            return arguments.length ? (u = [+t[0], +t[1]],
            f) : u
        }
        ,
        f.font = function(t) {
            return arguments.length ? (e = MC(t),
            f) : e
        }
        ,
        f.fontStyle = function(t) {
            return arguments.length ? (r = MC(t),
            f) : r
        }
        ,
        f.fontWeight = function(t) {
            return arguments.length ? (i = MC(t),
            f) : i
        }
        ,
        f.rotate = function(t) {
            return arguments.length ? (o = MC(t),
            f) : o
        }
        ,
        f.text = function(e) {
            return arguments.length ? (t = MC(e),
            f) : t
        }
        ,
        f.spiral = function(t) {
            return arguments.length ? (s = AC[t] || t,
            f) : s
        }
        ,
        f.fontSize = function(t) {
            return arguments.length ? (n = MC(t),
            f) : n
        }
        ,
        f.padding = function(t) {
            return arguments.length ? (a = MC(t),
            f) : a
        }
        ,
        f.random = function(t) {
    ...
    function _C(t, e, n, r) {
        if (!e.sprite) {
            ...
            for (--r; ++r < p; ) {
                if (e = n[r],
                i.save(),
                i.font = e.style + " " + e.weight + " " + ~~((e.size + 1) / o) + "px " + e.font,
                a = i.measureText(e.text + "m").width * o,
                s = e.size << 1,
                e.rotate) {
                    var g = Math.sin(e.rotate * mC)
                      , m = Math.cos(e.rotate * mC)
                      , y = a * m
                      , v = a * g
                      , _ = s * m
                      , x = s * g;
            ...
            for (var b = i.getImageData(0, 0, 2048 / o, yC / o).data, w = []; --r >= 0; )
                if ((e = n[r]).hasText) {
                    for (u = (a = e.width) >> 5,
                    s = e.y1 - e.y0,
                    l = 0; l < s * u; l++)
                    ...
                    for (c = 0; c < s; c++) {
                        for (l = 0; l < a; l++) {
                            var A = u * c + (l >> 5)
                              , E = b[2048 * (h + c) + (f + l) << 2] ? 1 << 31 - l % 32 : 0;
                            w[A] |= E,
                            k |= E
                        }
                        k ? M = c : (e.y0++,
                    ...
                    e.y1 = e.y0 + M,
                    e.sprite = w.slice(0, (e.y1 - e.y0) * u)
                }
        }
    }
    function xC(t, e, n) {
    ...
    ut(CC, pa, {
        transform(e, n) {
            ...
            if (H(l) ? s = e.fontSizeRange : l = Z(l),
            s) {
                const t = l
                  , e = pd("sqrt")().domain(tt(i, t)).range(s);
                l = n=>e(t(n))
            }
            i.forEach((t=>{
                t[a[0]] = NaN,
    ...
    const SC = t=>new Uint8Array(t)
      , BC = t=>new Uint16Array(t)
      , TC = t=>new Uint32Array(t);
    function zC(t, e, n) {
    ...
    function OC() {
        ...
        return {
            ...
            bisect: function(t, r) {
                let i;
                return r ? i = r.length : (r = e,
                i = n),
                [xe(r, t[0], 0, i), _e(r, t[1], 0, i)]
            },
            reindex: function(e) {
                for (let r = 0, i = n; r < i; ++r)
                    t[r] = e[t[r]]
            },
            index: ()=>t,
            size: ()=>n
        ...
        pa.call(this, function() {
            ...
            return {
                ...
                seen: ()=>n = function(t, e, n) {
                    return t.length >= e ? t : ((n = n || new t.constructor(e)).set(t),
                    n)
                }(n, e.length),
                add(t) {
    ...
    ut(RC, pa, {
        ...
        reinit(t, e) {
            ...
            for (b = 0; b < d; ++b)
                k = r[b],
                (!a[b] || t.modified("fields", b) || e.modified(k.fields)) && (y = k.fname,
                (g = p[y]) || (o[y] = m = OC(),
                p[y] = g = m.insert(k, e.source, 0)),
                a[b] = NC(m, b, i[b]).onAdd(g, s));
            for (b = 0,
            w = u.data().length; b < w; ++b)
        ...
        eval(t, e) {
            ...
            i |= (1 << r) - 1),
            t.modified("query") && !t.modified("fields") && (i |= this.update(t, e, n)),
            e.add.length && (this.insert(t, e, n),
            i |= (1 << r) - 1),
            e.mod.length && (this.modify(e, n),
            i |= (1 << r) - 1),
            this.value.mask = i,
            n
        },
        ...
        update(t, e, n) {
            ...
            for (n.filters = 0,
            s = 0; s < a; ++s)
                t.modified("query", s) && (u = s,
                ++l);
            if (1 === l)
                l = r[u].one,
                this.incrementOne(r[u], i[u], n.add, n.rem);
            else
                for (s = 0,
                l = 0; s < a; ++s)
                    t.modified("query", s) && (l |= r[s].one,
        ...
        incrementOne(t, e, n, r) {
            ...
            if (s < c)
                for (d = s,
                p = Math.min(c, l); d < p; ++d)
                    g = o[d],
                    i[g] ^= h,
                    n.push(g);
            else if (s > c)
                for (d = c,
                p = Math.min(s, f); d < p; ++d)
                    g = o[d],
                    i[g] ^= h,
                    r.push(g);
            if (l > f)
    ...
    ut(LC, pa, {
        transform(t, e) {
            ...
            const o = e.fork(e.ALL)
              ...
              , s = r.prev()
              , l = t=>u[t] & n ? null : a[t];
            return o.filter(o.MOD, l),
            i & i - 1 ? (o.filter(o.ADD, (t=>{
                const e = u[t] & n;
    ...
    const qC = "RawCode"
      ...
      , WC = "BinaryExpression"
      , HC = "CallExpression"
      , YC = "ConditionalExpression"
      , VC = "LogicalExpression"
      , GC = "MemberExpression"
      , XC = "ObjectExpression"
      , JC = "UnaryExpression";
    function ZC(t) {
    ...
    QC[7] = "Punctuator",
    QC[8] = "String",
    QC[9] = "RegularExpression";
    var rF = "Identifier"
      , iF = "Unexpected token %0"
      , oF = "Invalid regular expression"
      , aF = "Invalid regular expression: missing /"
      , uF = "Octal literals are not allowed in strict mode."
      , sF = "ILLEGAL"
      , lF = "Disabled."
    ...
    function wF(t) {
        ...
        for (n = "u" === t ? 4 : 2,
        e = 0; e < n; ++e)
            tF < eF && pF(KC[tF]) ? (r = KC[tF++],
            i = 16 * i + "0123456789abcdef".indexOf(r.toLowerCase())) : UF({}, iF, sF);
        return String.fromCharCode(i)
    }
    function kF() {
        var t, e, n, r;
        for (e = 0,
        "}" === (t = KC[tF]) && UF({}, iF, sF); tF < eF && pF(t = KC[tF++]); )
            e = 16 * e + "0123456789abcdef".indexOf(t.toLowerCase());
        return (e > 1114111 || "}" !== t) && UF({}, iF, sF),
    ...
    function MF() {
        var t, e;
        for (t = KC.charCodeAt(tF++),
        e = String.fromCharCode(t),
        92 === t && (117 !== KC.charCodeAt(tF) && UF({}, iF, sF),
        ++tF,
        (t = wF("u")) && "\\" !== t && vF(t.charCodeAt(0)) || UF({}, iF, sF),
        e = t); tF < eF && _F(t = KC.charCodeAt(tF)); )
            ++tF,
            e += String.fromCharCode(t),
            92 === t && (e = e.substr(0, e.length - 1),
            117 !== KC.charCodeAt(tF) && UF({}, iF, sF),
            ++tF,
            (t = wF("u")) && "\\" !== t && _F(t.charCodeAt(0)) || UF({}, iF, sF),
            e += t);
        return e
    }
    function AF() {
    ...
    function DF() {
        var t, e, n;
        if (hF(dF((n = KC[tF]).charCodeAt(0)) || "." === n, "Numeric literal must start with a decimal digit or a decimal point"),
        e = tF,
        t = "",
        "." !== n) {
            if (t = KC[tF++],
            ...
            "0" === t) {
                if ("x" === n || "X" === n)
                    ...
                    function(t) {
                        ...
                        for (; tF < eF && pF(KC[tF]); )
                            e += KC[tF++];
                        return 0 === e.length && UF({}, iF, sF),
                        vF(KC.charCodeAt(tF)) && UF({}, iF, sF),
                        {
                            type: 6,
            ...
            for (; dF(KC.charCodeAt(tF)); )
                t += KC[tF++];
            n = KC[tF]
        }
        if ("." === n) {
            for (t += KC[tF++]; dF(KC.charCodeAt(tF)); )
                t += KC[tF++];
            n = KC[tF]
        }
        if ("e" === n || "E" === n)
            ...
            dF(KC.charCodeAt(tF)))
                ...
                UF({}, iF, sF);
        return vF(KC.charCodeAt(tF)) && UF({}, iF, sF),
        {
            type: 6,
            value: parseFloat(t),
            start: e,
    ...
    function CF() {
        ...
        e = function() {
            var t, e, n, r;
            for (hF("/" === (t = KC[tF]), "Regular expression literal must start with a slash"),
            e = KC[tF++],
            n = !1,
            r = !1; tF < eF; )
                if (e += t = KC[tF++],
                "\\" === t)
                    yF((t = KC[tF++]).charCodeAt(0)) && UF({}, aF),
                    e += t;
                else if (yF(t.charCodeAt(0)))
                    UF({}, aF);
                else if (n)
                    "]" === t && (n = !1);
                else {
        ...
        n = function() {
            var t, e, n;
            for (e = "",
            n = ""; tF < eF && _F((t = KC[tF]).charCodeAt(0)); )
                ++tF,
                "\\" === t && tF < eF ? UF({}, iF, sF) : (n += t,
                e += t);
            return n.search(/[^gimuy]/g) >= 0 && UF({}, oF, n),
            {
                value: n,
                literal: e
            }
    ...
    function FF() {
        ...
        return vF(t) ? AF() : 40 === t || 41 === t || 59 === t ? EF() : 39 === t || 34 === t ? function() {
            var t, e, n, r, i = "", o = !1;
            for (hF("'" === (t = KC[tF]) || '"' === t, "String literal must starts with a quote"),
            e = tF,
            ++tF; tF < eF; ) {
                if ((n = KC[tF++]) === t) {
                    t = "";
                ...
                if ("\\" === n)
                    if ((n = KC[tF++]) && yF(n.charCodeAt(0)))
                        ...
                        case "v":
                            ...
                            break;
                        default:
                            gF(n) ? (0 !== (r = "01234567".indexOf(n)) && (o = !0),
                            tF < eF && gF(KC[tF]) && (o = !0,
                            r = 8 * r + "01234567".indexOf(KC[tF++]),
                            "0123".indexOf(n) >= 0 && tF < eF && gF(KC[tF]) && (r = 8 * r + "01234567".indexOf(KC[tF++]))),
                            i += String.fromCharCode(r)) : i += n
                        }
                else {
                    if (yF(n.charCodeAt(0)))
                        break;
                    i += n
                }
            }
    ...
    function UF(t, e) {
        var n, r = Array.prototype.slice.call(arguments, 2), i = e.replace(/%(\d)/g, ((t,e)=>(hF(e < r.length, "Message reference must be in range"),
        r[e])));
        throw (n = new Error(i)).index = tF,
        n.description = i,
        n
    }
    function qF(t) {
        2 === t.type && UF(t, "Unexpected end of input"),
        6 === t.type && UF(t, "Unexpected number"),
        8 === t.type && UF(t, "Unexpected string"),
        3 === t.type && UF(t, "Unexpected identifier"),
        4 === t.type && UF(t, "Unexpected reserved word"),
        UF(t, iF, t.value)
    }
    function PF(t) {
        const e = SF();
    ...
    function WF() {
        tF = nF.start;
        const t = SF();
        return 8 === t.type || 6 === t.type ? (t.octal && UF(t, uF),
        OF(t)) : NF(t.value)
    }
    function HF() {
        var t, e, n;
        ...
        3 === (t = nF).type ? (n = WF(),
        PF(":"),
        LF("init", n, eS())) : 2 !== t.type && 7 !== t.type ? (e = WF(),
        PF(":"),
        LF("init", e, eS())) : void qF(t)
    }
    function YF() {
        var t, e, n = [], r = {}, i = String;
        for (tF = nF.start,
        PF("{"); !jF("}"); )
            e = "$" + ((t = HF()).key.type === rF ? t.key.name : i(t.key.value)),
            Object.prototype.hasOwnProperty.call(r, e) ? UF({}, "Duplicate data property in object literal not allowed in strict mode") : r[e] = !0,
            n.push(t),
            jF("}") || PF(",");
        return PF("}"),
        function(t) {
    ...
    function GF() {
        ...
        3 === t || VF[nF.value])
            ...
            if (4 === t)
                throw new Error(lF);
            1 === t ? ((e = SF()).value = "true" === e.value,
            n = OF(e)) : 5 === t ? ((e = SF()).value = null,
            n = OF(e)) : jF("/") || jF("/=") ? (n = OF(CF()),
            BF()) : qF(SF())
        }
        return n
    }
    ...
    function KF() {
        ...
        if (7 !== nF.type && 4 !== nF.type)
            ...
            if (jF("+") || jF("-") || jF("~") || jF("!"))
                ...
                if (IF("delete") || IF("void") || IF("typeof"))
                    throw new Error(lF);
                e = QF()
            }
        }
    ...
    function eS() {
        ...
        return t = function() {
            ...
            for (n = o[l = o.length - 1],
            e.pop(); l > 1; )
                e.pop(),
                n = TF(o[l - 1].value, o[l - 2], n),
                l -= 2;
            return n
        }(),
        jF("?") && (SF(),
    ...
    function iS(t) {
        function e(e, n, r) {
            return i=>function(e, n, r, i) {
                ...
                o + "." + e + (i < 0 ? "" : 0 === i ? "()" : "(" + n.slice(1).map(t).join(",") + ")")
            }(e, i, n, r)
        }
        const n = "new Date"
          , r = "String"
    ...
    function sS(t, e) {
        for (var n, r, i = e.fields, o = e.values, a = i.length, u = 0; u < a; ++u)
            if ((r = i[u]).getter = l.getter || l(r.field),
            ct(n = r.getter(t)) && (n = A(n)),
            ct(o[u]) && (o[u] = A(o[u])),
            ct(o[u][0]) && (o[u] = o[u].map(A)),
            "E" === r.type) {
                if (v(o[u]) ? o[u].indexOf(n) < 0 : n !== o[u])
                    return !1
            } else if ("R" === r.type) {
                if (!st(n, o[u]))
                    return !1
                ...
                if (!st(n, o[u], !1, !1))
                    return !1
            } else if ("R-LE" === r.type && !st(n, o[u], !1, !0))
                return !1;
        return !0
    }
    var lS = {
        ...
        R_intersect: function(t, e) {
            ...
            return n > r && (n = e[1],
            r = e[0]),
            t.length ? r < t[0] || t[1] < n ? [] : (t[0] < n && (t[0] = n),
            t[1] > r && (t[1] = r),
            t) : [n, r]
        }
    };
    function cS(t, e, n, r) {
        ...
        const i = e[0].value
          ...
          , a = "@unit"
          , s = ":" + i;
        (e.length >= 2 && M(e).value) !== oS || rt(r, a) || (r["@unit"] = n.getData(i).indataRef(n, o)),
    ...
    const hS = t=>function(e, n) {
      ...
      , vS = new Date(2e3,0,1);
    function _S(t, e, n) {
        return Number.isInteger(t) && Number.isInteger(e) ? (vS.setYear(2e3),
        vS.setMonth(t),
        vS.setDate(e),
        pS.call(this, vS, n)) : ""
    }
    ...
    const ES = AS("area", (function(t) {
      ...
      , DS = AS("bounds", (function(t) {
        ...
        n = sb.length) {
            ...
            e = 1,
            o = [r = sb[0]]; e < n; ++e)
                Jb(r, (i = sb[e])[0]) || Jb(r, i[1]) ? (Gb(r[0], i[1]) > Gb(r[0], r[1]) && (r[1] = i[1]),
                Gb(i[0], r[1]) > Gb(r[0], r[1]) && (r[0] = i[0])) : o.push(r = i);
            for (a = -1 / 0,
            e = 0,
            r = o[n = o.length - 1]; e <= n; r = i,
            ++e)
                i = o[e],
                (u = Gb(r[1], i[0])) > a && (a = u,
                Kx = i[0],
        ...
        return sb = lb = null,
        Kx === 1 / 0 || tb === 1 / 0 ? [[NaN, NaN], [NaN, NaN]] : [[Kx, tb], [eb, nb]]
    }
    ))
      , CS = AS("centroid", (function(t) {
        Mb = Ab = Eb = Db = Cb = Fb = Sb = Bb = 0,
        Tb = new be,
        zb = new be,
        Nb = new be,
        Vx(t, Zb);
        ...
        n = Db,
        r = Cb),
        (i = Tx(e, n, r)) < _x) ? [NaN, NaN] : [Cx(n, e) * Mx, Px(r / i) * Mx]
    }
    ));
    function FS(t, e, n) {
        try {
    ...
    const US = {
        ...
        setdata: function(t, e) {
            ...
            return n.pulse(r, n.changeset().remove(p).insert(e)),
            1
        },
        ...
        modify: function(t, e, n, r, i, o) {
            const a = this.context.dataflow
              ...
              , l = a.stamp();
            let c, f, h = u.changes;
            if (!1 === a._trigger || !(s.value.length || e || r))
                return 0;
            if ((!h || h.stamp < l) && (u.changes = h = a.changeset(),
            h.stamp = l,
            a.runAfter((()=>{
                u.modified = !0,
                a.pulse(s, h).run()
            ...
            n && (c = !0 === n ? p : v(n) || No(n) ? n : NS(n),
            h.remove(c)),
            e && h.insert(e),
            r && (c = NS(r),
            s.value.some(c) ? h.remove(c) : h.insert(r)),
            i)
                for (f in o)
                    h.modify(i, f, o[f]);
            return 1
      ...
      , $S = function(t) {
        ...
        function h(t) {
            if (pt(t))
                return t;
            const e = d[t.type];
            return null == e && u("Unsupported type: " + t.type),
            e(t)
        }
        const d = {
            Literal: t=>t.raw,
            Identifier: t=>{
                const i = t.name;
                return f > 0 ? i : rt(n, i) ? u("Illegal identifier: " + i) : rt(r, i) ? r[i] : rt(e, i) ? i : (l[i] = 1,
                s(i))
            }
            ,
            MemberExpression: t=>{
            ...
            CallExpression: t=>{
                ...
                const e = t.callee.name
                  , n = t.arguments
                  , r = rt(i, e) && i[e];
                return r || u("Unrecognized function: " + e),
    ...
    function WS(t, e, n) {
        return 1 === arguments.length ? US[t] : (US[t] = e,
        n && (jS[t] = n),
        $S && ($S.functions[t] = PS + t),
        this)
    }
    function HS(t, e) {
        const n = {};
    ...
    WS("gradient", (function(t, e, n, r, i) {
        ...
        let a = t.domain()
          ...
          , s = M(a)
          , l = f;
        return s - u ? l = Dd(t, u, s) : t = (t.interpolator ? pd("sequential")().interpolator(t.interpolator()) : pd("linear")().interpolate(t.interpolate()).range(t.range())).domain([u = 0, s = 1]),
        t.ticks && (a = t.ticks(+r || 15),
        u !== a[0] && a.unshift(u),
        s !== M(a) && a.push(s)),
    ...
    WS("geoArea", ES, bS),
    WS("geoBounds", DS, bS),
    WS("geoCentroid", CS, bS),
    WS("geoShape", (function(t, e, n) {
        const r = kS(t, (n || this).context);
        return function(t) {
    ...
    WS("indata", (function(t, e, n) {
        const r = this.context.data[t]["index:" + e]
          , i = r ? r.value.get(n) : void 0;
        return i ? i.count : i
    }
    ), (function(t, e, n, r) {
        e[0].type !== PC && u("First argument to indata must be a string literal."),
        e[1].type !== PC && u("Second argument to indata must be a string literal.");
        const i = e[0].value
          , o = e[1].value
          , a = "@" + o;
    ...
    WS("treeAncestors", (function(t, e) {
        const n = RS(t, this)[e];
        return n ? n.ancestors().map(OS) : void 0
    }
    ), xS),
    WS("vlSelectionTest", (function(t, e, n) {
        for (var r, i, o, a, u, s = this.context.data[t], l = s ? s.values.value : [], c = s ? s[uS] && s[uS].value : void 0, f = n === oS, h = l.length, d = 0; d < h; ++d)
            if (r = l[d],
            c && f) {
                if (-1 === (o = (i = i || {})[a = r.unit] || 0))
                    continue;
                if (u = sS(e, r),
                i[a] = u ? -1 : ++o,
                u && 1 === c.size)
                    return !0;
                if (!u && o === c.get(a).count)
                    return !1
            } else if (f ^ (u = sS(e, r)))
                return u;
        return h && f
    ...
    WS("vlSelectionResolve", (function(t, e, n) {
        for (var r, i, o, a, u, s, l, c, f, h, d, p = this.context.data[t], g = p ? p.values.value : [], m = {}, y = {}, v = {}, _ = g.length, x = 0; x < _; ++x) {
            ...
            d = i.length; h < d; ++h)
                u = i[h],
                l = (s = m[u.field] || (m[u.field] = {}))[a] || (s[a] = []),
                v[u.field] = c = u.type.charAt(0),
                f = lS[c + "_union"],
                s[a] = f(l, $(o[h]));
            n && (l = y[a] || (y[a] = [])).push($(o).reduce(((t,e,n)=>(t[i[n].field] = e,
            t)), {}))
        }
        return e = e || aS,
        ...
        g = Object.keys(y),
        n && g.length && (m.vlMulti = e === aS ? {
            or: g.reduce(((t,e)=>(t.push(...y[e]),
            t)), [])
        } : {
            and: g.map((t=>({
                or: y[t]
    ...
    var JS = {
        ...
        encode: (t,e)=>{
            ...
            return i += function(t, e) {
                let n = "";
                return YS[e] || (t.x2 && (t.x ? (VS[e] && (n += "if(o.x>o.x2)$=o.x,o.x=o.x2,o.x2=$;"),
                n += "o.width=o.x2-o.x;") : n += "o.x=o.x2-(o.width||0);"),
                t.xc && (n += "o.x=o.xc-(o.width||0)/2;"),
                t.y2 && (t.y ? (VS[e] && (n += "if(o.y>o.y2)$=o.y,o.y=o.y2,o.y2=$;"),
        ...
        codegen: {
            ...
            comparator(t, e) {
                ...
                const r = Function("a", "b", "var u, v; return " + t.map(((t,r)=>{
                    const i = e[r];
                    let o, a;
                    return t.path ? (o = "a".concat(t.path),
                    a = "b".concat(t.path)) : ((n = n || {})["f" + r] = t,
                    o = "this.f".concat(r, "(a)"),
                    a = "this.f".concat(r, "(b)")),
                    function(t, e, n, r) {
    ...
    function ZS(t, e, n) {
        if (!t || !_(t))
            return t;
        for (let r, i = 0, o = QS.length; i < o; ++i)
            if (r = QS[i],
            rt(t, r.key))
    ...
    var QS = [{
        ...
        parse: function(t, e) {
            const n = "c:" + t.$compare + "_" + t.$order
              , r = $(t.$compare).map((t=>t && t.$tupleid ? Oo : t));
    ...
    function eB(t, e, n, r) {
        ...
        this.data = {},
        this.fn = {},
        n && (this.functions = Object.create(n),
    ...
    eB.prototype = nB.prototype = {
        fork() {
            const t = new nB(this);
            return (this.subcontext || (this.subcontext = [])).push(t),
            t
        },
        detach(t) {
        ...
        add(t, e) {
            ...
            function(t) {
                return "collect" === GS(t)
            }(t.type) && i && (i.$ingest ? r.ingest(e, i.$ingest, i.$format) : i.$request ? r.preload(e, i.$request, i.$format) : r.pulse(e, r.changeset().insert(i))),
            t.root && (n.root = e),
            t.parent) {
                let i = n.get(t.parent.$ref);
                i ? (r.connect(i, [e]),
                e.targets().add(i)) : (n.unresolved = n.unresolved || []).push((()=>{
                    i = n.get(t.parent.$ref),
                    r.connect(i, [e]),
                    e.targets().add(i)
                }
                ))
            }
            if (t.signal && (n.signals[t.signal] = e),
        ...
        resolve() {
            return (this.unresolved || []).forEach((t=>t())),
        ...
        parse: function(t) {
            const e = this
              , n = t.operators || [];
            return t.background && (e.background = t.background),
        ...
        parseStream: function(t) {
            var e, n = this, r = null != t.filter ? n.eventExpression(t.filter) : void 0, i = null != t.stream ? n.get(t.stream) : void 0;
            t.source ? i = n.events(t.source, t.type, r) : t.merge && (i = (e = t.merge.map((t=>n.get(t))))[0].merge.apply(e[0], e.slice(1))),
            t.between && (e = t.between.map((t=>n.get(t))),
            i = i.between(e[0], e[1])),
        ...
        parseUpdate: function(t) {
            ...
            e = t.target && t.target.$expr ? n.eventExpression(t.target.$expr) : n.get(t.target),
            o && o.$expr && (o.$params && (a = n.parseParameters(o.$params)),
        ...
        getState: function(t) {
            ...
            return e.subcontext && !1 !== t.recurse && (n.subcontext = e.subcontext.map((e=>e.getState(t)))),
            n
        },
        setState: function(t) {
            var e = this
    ...
    function oB(t, e) {
        ...
        if (n)
            return null == e ? n.style.removeProperty("cursor") : n.style.cursor = e
    }
    function aB(t, e) {
        var n = t._runtime.data;
        return rt(n, e) || u("Unrecognized data set: " + e),
        n[e]
    }
    function uB(t, e) {
    ...
    function fB(t, e, n) {
        ...
        return a && (i = cB(t),
        (r = uy(e.changedTouches ? e.changedTouches[0] : e, a))[0] -= i[0],
        r[1] -= i[1]),
        e.dataflow = t,
        e.item = n,
    ...
    function pB(t, e, n) {
        ...
        return !(!1 === r || _(r) && !r[n]) || (t.warn("Blocked ".concat(e, " ").concat(n, " event listener.")),
        !1)
    }
    function gB(t) {
        return t.item
    ...
    function bB(t, e, n) {
        ...
        function(t, e, n, r) {
            const i = vB("div", {
              ...
              , o = "radio" === n.input ? i : i.appendChild(vB("label"));
            o.appendChild(vB("span", {
                class: xB
            }, n.name || n.signal)),
            e.appendChild(i);
            let a = wB;
            ...
            a(t, o, n, r)
        }(i, e, r, t.signal(r.signal)),
        i.active || (t.on(t._signals[r.signal], null, (()=>{
    ...
    function wB(t, e, n, r) {
        const i = vB("input");
        for (const t in n)
            "signal" !== t && "element" !== t && i.setAttribute("input" === t ? "type" : t, n[t]);
    ...
    function MB(t, e, n, r) {
        ...
        n.options.forEach(((t,e)=>{
            ...
            DB(t, r) && (n.selected = !0),
            i.appendChild(vB("option", n, (o[e] || t) + ""))
        }
        )),
        e.appendChild(i),
    ...
    function SB(t, e) {
        if ("string" == typeof e) {
            if ("undefined" == typeof document)
                return t.error("DOM document instance not found."),
                null;
            if (!(e = document.querySelector(e)))
                return t.error("Signal bind element not found: " + e),
                null
        }
        if (e)
            try {
    ...
    async function zB(t, e, n, r) {
        const i = bv(e)
          , o = i && i.headless;
        return o || u("Unrecognized renderer type: " + e),
        await t.runAsync(),
        CB(t, null, null, o, n, r).renderAsync(t._scenegraph.root)
    }
    var NB = "width"
      , OB = "height"
      , RB = "padding"
    ...
    function IB(t, e, n, r) {
        ...
        i && i.setAttribute("title", function(t) {
            return null == t ? "" : v(t) ? $B(t) : _(t) && !ct(t) ? (e = t,
            Object.keys(e).map((t=>{
                const n = e[t];
    ...
    function HB(t, e) {
        ...
        n._el = null,
        n._elBind = null,
        n._renderType = e.renderer || _v.Canvas,
        n._scenegraph = new ty;
        const r = n._scenegraph.root;
        n._renderer = null,
        n._tooltip = e.tooltip || IB,
        n._redraw = !0,
        n._handler = (new Ey).scene(r),
        n._globalCursor = !1,
        n._preventDefault = !1,
        n._timers = [],
        n._eventListeners = [],
        ...
        n._eventConfig = function(t) {
            ...
            ;
            return n(e.defaults, ["prevent", "allow"]),
        ...
        n._width = n.width(),
        n._height = n.height(),
        n._viewWidth = UB(n, n._width),
        n._viewHeight = qB(n, n._height),
        n._origin = [0, 0],
        n._resize = 0,
        n._autosize = 1,
        function(t) {
        ...
        function(t) {
            t.add(null, (e=>(t._background = e.bg,
            t._resize = 1,
            e.bg)), {
    ...
    function XB(t, e, n) {
        const r = VB(e, n);
        return r && e._targets.remove(r),
        t
    }
    ut(HB, ha, {
        async evaluate(t, e, n) {
            if (await ha.prototype.evaluate.call(this, t, e),
        ...
        description(t) {
            if (arguments.length) {
                ...
                return e !== this._desc && rB(this._el, this._desc = e),
                this
            }
            return this._desc
        },
        ...
        renderer(t) {
            return arguments.length ? (bv(t) || u("Unrecognized renderer type: " + t),
            t !== this._renderType && (this._renderType = t,
            this._resetRenderer()),
            this) : this._renderType
        },
        tooltip(t) {
        ...
        loader(t) {
            return arguments.length ? (t !== this._loader && (ha.prototype.loader.call(this, t),
            this._resetRenderer()),
            this) : this._loader
        },
        resize() {
            return this._autosize = 1,
            this.touch(YB(this, "autosize"))
        },
        _resetRenderer() {
            this._renderer && (this._renderer = null,
        ...
        _resizeView: function(t, e, n, r, i, o) {
            this.runAfter((a=>{
                ...
                a.width() !== n && (u = 1,
                a.signal(NB, n, LB),
                a._resizeWidth.skip(!0)),
                a.height() !== r && (u = 1,
                a.signal(OB, r, LB),
                a._resizeHeight.skip(!0)),
                a._viewWidth !== t && (a._resize = 1,
                a._viewWidth = t),
                a._viewHeight !== e && (a._resize = 1,
                a._viewHeight = e),
                a._origin[0] === i[0] && a._origin[1] === i[1] || (a._resize = 1,
                a._origin = i),
                u && a.run("enter"),
        ...
        preventDefault(t) {
            return arguments.length ? (this._preventDefault = t,
            this) : this._preventDefault
        },
        timer: function(t, e) {
        ...
        events: function(t, e, n) {
            var r, i = this, o = new Zo(n), a = function(n, r) {
                i.runAsync(null, (()=>{
                    ...
                    }(i, e) && n.preventDefault(),
                    o.receive(fB(i, n, r))
                }
                ))
            };
            if ("timer" === t)
                pB(i, "timer", e) && i.timer(a, e);
            else if (t === hB)
                pB(i, "view", e) && i.addEventListener(e, a, dB);
            else if ("window" === t ? pB(i, "window", e) && "undefined" != typeof window && (r = [window]) : "undefined" != typeof document && pB(i, "selector", e) && (r = document.querySelectorAll(t)),
            r) {
                for (var u = 0, s = r.length; u < s; ++u)
                    r[u].addEventListener(e, a);
                i._eventListeners.push({
                    type: e,
                    sources: r,
                    handler: a
                })
        ...
        finalize: function() {
            ...
            return r && r.call(this, this._handler, null, null, null),
            this
        },
        hover: function(t, e) {
            return e = [e || "update", (t = [t || "hover"])[0]],
            this.on(this.events("view", "mouseover", gB), mB, yB(t)),
            this.on(this.events("view", "mouseout", gB), mB, yB(e)),
            this
        },
        data: function(t, e) {
        ...
        scale: function(t) {
            ...
            return rt(e, t) || u("Unrecognized scale or projection: " + t),
            e[t].value
        },
        initialize: function(t, e) {
            const n = this
              ...
              , o = bv(r);
            t = n._el = t ? SB(n, t) : null,
            function(t) {
                const e = t.container();
                e && (e.setAttribute("role", "graphics-document"),
                e.setAttribute("aria-roleDescription", "visualization"),
                rB(e, t.description()))
            }(n),
            o || n.error("Unrecognized renderer type: " + r);
            const a = o.handler || Ey
              , u = t ? o.renderer : o.headless;
            return n._renderer = u ? CB(n, n._renderer, t, u) : null,
            ...
            n._redraw = !0,
            t && "none" !== i && (e = e ? n._elBind = SB(n, e) : t.appendChild(vB("form", {
                class: "vega-bindings"
            })),
            n._bind.forEach((t=>{
    ...
    function iT(t) {
        return "[" === t[0] ? function(t) {
            const e = t.length;
            let n, r = 1;
            if (r = nT(t, r, ZB, JB, ZB),
            r === e)
                throw "Empty between selector: " + t;
            if (n = rT(t.substring(1, r)),
            2 !== n.length)
            ...
            "@" === t[0] && (a = ++l);
            r = nT(t, l, ":"),
            r < s && (n.push(t.substring(u, r).trim()),
            u = l = ++r);
            if (l = nT(t, l, JB),
            l === s)
                n.push(t.substring(u, s).trim());
            else if (n.push(t.substring(u, l).trim()),
            i = [],
            u = ++l,
            u === s)
            ...
            for (; l < s; ) {
                ...
                l === s)
                    throw "Unmatched left bracket: " + t;
                if (i.push(t.substring(u, l).trim()),
                l < s - 1 && t[++l] !== JB)
                    throw "Expected left bracket: " + t;
                u = ++l
            }
            if (!(s = n.length) || QB.test(n[s - 1]))
                throw "Invalid event selector: " + t;
            s > 1 ? (e.type = n[1],
            a ? e.markname = n[0].slice(1) : !function(t) {
                return eT[t]
            }(n[0]) ? e.source = n[0] : e.marktype = n[0]) : e.type = n[0];
            "!" === e.type.slice(-1) && (e.consume = !0,
    ...
    const sT = t=>_(t) && !v(t) ? K({}, t) : {
        value: t
    };
    function lT(t, e, n, r) {
        if (null != n) {
            return _(n) && !v(n) || v(n) && n.length && _(n[0]) ? t.update[e] = n : t[r || "enter"][e] = {
                value: n
            },
            1
        }
    ...
    function bT(t) {
        if (null != t.gradient)
            return function(t) {
                ...
                for (; e.length && null == M(e); )
                    e.pop();
                return e.unshift(xT(t.gradient)),
                "gradient(".concat(e.join(","), ")")
            }(t);
        ...
        return null != t.scale && (e = function(t, e) {
            const n = xT(t.scale);
            null != t.range ? e = "lerp(_range(".concat(n, "), ").concat(+t.range, ")") : (void 0 !== e && (e = "_scale(".concat(n, ", ").concat(e, ")")),
            t.band && (e = (e ? e + "+" : "") + "_bandwidth(".concat(n, ")") + (1 == +t.band ? "" : "*" + kT(t.band)),
            t.extra && (e = "(datum.extra ? _scale(".concat(n, ", datum.extra.value) : ").concat(e, ")"))),
            null == e && (e = "0"));
            return e
        }(t, e)),
        void 0 === e && (e = null),
        null != t.exponent && (e = "pow(".concat(e, ",").concat(kT(t.exponent), ")")),
        null != t.mult && (e += "*".concat(kT(t.mult))),
        null != t.offset && (e += "+".concat(kT(t.offset))),
    ...
    function AT(t) {
        ...
        if (t.signal)
            ...
            t.datum ? (e = "datum",
            r = t.datum) : u("Invalid field reference: " + wt(t));
        return t.signal || (r = pt(r) ? s(r).map(wt).join("][") : AT(r)),
        e + "[" + r + "]"
    }
    function ET(t, e, n, r, i, o) {
        ...
        t = function(t, e, n, r, i) {
            ...
            "text" !== e || null == i[s] || hT(s, t) || _T(o, s, i[s]),
            ("legend" == n || String(n).startsWith("axis")) && (n = null),
            c = n === pT ? i.group : n === dT ? K({}, i.mark, i[e]) : null,
            c)
                l = hT(s, t) || ("fill" === s || "stroke" === s) && (hT("fill", t) || hT("stroke", t)),
                l || _T(o, s, c[s]);
            ...
            o)
                c = o[s],
                c.signal ? (u = u || {})[s] = c : a[s] = c;
            return t.enter = K(a, t.enter),
            u && (t.update = K(u, t.update)),
            t
        }(t, e, n, r, i.config);
        for (const n in t)
            a[n] = DT(t[n], e, o, i);
    ...
    function CT(t, e, n, r) {
        const i = HS(t, e);
        return i.$fields.forEach((t=>r[t] = 1)),
        K(n, i.$params),
        i.$expr
    }
    ...
    function BT(t, e) {
        const n = t.name;
        if ("outer" === t.push)
            e.signals[n] || ST("No prior signal definition", n),
            FT.forEach((e=>{
    ...
    function OT(t) {
        ...
        return t.id < 0 && (t.refs = t.refs || []).push(e),
        e
    }
    function RT(t, e) {
        return e ? {
    ...
    function GT(t, e) {
        const n = ZT({
            merge: t.merge.map((t=>VT(t, e)))
        }, t, e);
        return e.addStream(n).id
    }
    function XT(t, e) {
        const n = ZT({
            stream: VT(t.stream, e)
        }, t, e);
        return e.addStream(n).id
    }
    function JT(t, e) {
        let n;
        t.type === YT ? (n = e.event(YT, t.throttle),
        t = {
            between: t.between,
            filter: t.filter
    ...
    function ZT(t, e, n) {
        let r = e.between;
        return r && (2 !== r.length && u('Stream "between" parameter must have 2 entries: ' + wt(e)),
        t.between = [VT(r[0], n), VT(r[1], n)]),
        r = e.filter ? [].concat(e.filter) : [],
        (e.marktype || e.markname || e.markrole) && r.push(function(t, e, n) {
            const r = "event.item";
            return r + (t && "*" !== t ? "&&" + r + ".mark.marktype==='" + t + "'" : "") + (n ? "&&" + r + ".mark.role==='" + n + "'" : "") + (e ? "&&" + r + ".mark.name==='" + e + "'" : "")
        }(e.marktype, e.markname, e.markrole)),
        e.source === PT && r.push("inScope(event.item)"),
        r.length && (t.filter = HS("(" + r.join(")&&(") + ")", n).$expr),
    ...
    function KT(t, e, n) {
        ...
        pt(o) && (o = function(t, e, n) {
            return tT = e || "view",
            eT = n || KB,
            rT(t.trim()).map(iT)
        }(o, e.isSubscope() ? PT : jT)),
        o = $(o).filter((t=>t.signal || t.scale ? (s.push(t),
        0) : 1)),
        s.length > 1 && (s = [tz(s)]),
        o.length && s.push(o.length > 1 ? {
            merge: o
        } : o[0]),
        null != r && (a && u("Signal encode and update are mutually exclusive."),
        a = "encode(item()," + wt(r) + ")"),
        i.update = pt(a) ? HS(a, e) : null != a.expr ? HS(a.expr, e) : null != a.value ? a.value : null != a.signal ? {
            $expr: QT,
            $params: {
        ...
        s.forEach((t=>e.addUpdate(K(function(t, e) {
            return {
                source: t.signal ? e.signalRef(t.signal) : t.scale ? e.scaleRef(t.scale) : VT(t, e)
            }
        }(t, e), i))))
    }
    function tz(t) {
    ...
    const ez = t=>(e,n,r)=>zT(t, n, e || void 0, r)
      , nz = ez("aggregate")
      , rz = ez("axisticks")
      , iz = ez("bound")
      , oz = ez("collect")
    ...
    function Tz(t, e) {
        ...
        let r;
        for (r in n.domain = Rz(t.domain, t, e),
        null != t.range && (n.range = Wz(t, e, n)),
        null != t.interpolate && function(t, e) {
            e.interpolate = zz(t.type || t),
            null != t.gamma && (e.interpolateGamma = zz(t.gamma))
        }(t.interpolate, n),
        null != t.nice && (n.nice = function(t) {
            return _(t) ? {
                interval: zz(t.interval),
                step: zz(t.step)
            } : zz(t)
        }(t.nice)),
        null != t.bins && (n.bins = function(t, e) {
    ...
    function Rz(t, e, n) {
        if (t)
            return t.signal ? n.signalRef(t.signal) : (v(t) ? Lz : t.fields ? qz : Uz)(t, e, n);
    ...
    function Uz(t, e, n) {
        ...
        return r || Oz(t.data),
        vd(e.type) ? r.valuesRef(n, t.field, jz(t.sort, !1)) : wd(e.type) ? r.domainRef(n, t.field) : r.extentRef(n, t.field)
    }
    function qz(t, e, n) {
        const r = t.data
          , i = t.fields.reduce(((t,e)=>(e = pt(e) ? {
            data: r,
            field: e
        } : v(e) || e.signal ? function(t, e) {
            const n = "_:vega:_" + Sz++
              , r = oz({});
            if (v(t))
                r.value = {
            ...
            return e.addDataPipeline(n, [r, Ez({})]),
            {
                data: n,
                field: "data"
            }
    ...
    function jz(t, e) {
        return t && (t.field || t.op ? t.field || "count" === t.op ? e && t.field && t.op && !Bz[t.op] && u("Multiple domain scales can not be sorted using " + t.op) : u("No field provided for sort aggregate op: " + t.op) : _(t) ? t.field = "key" : t = {
            field: "key"
        }),
        t
    }
    ...
    function Wz(t, e, n) {
        ...
        if (pt(i)) {
            ...
            "width" === i ? i = [0, {
                signal: "width"
            }] : "height" === i ? i = vd(t.type) ? [0, {
                signal: "height"
            }] : [{
                signal: "height"
            }, 0] : u("Unrecognized scale range value: " + wt(i))
        } else {
            if (i.scheme)
                return n.scheme = v(i.scheme) ? Nz(i.scheme, e) : zz(i.scheme, e),
                i.extent && (n.schemeExtent = Nz(i.extent, e)),
                void (i.count && (n.schemeCount = zz(i.count, e)));
            if (i.step)
                return void (n.rangeStep = zz(i.step, e));
            if (vd(t.type) && !v(i))
                return Rz(i, t, e);
    ...
    function yN(t) {
        return t.type = dN,
        t.interactive = t.interactive || !1,
        t
    }
    function vN(t, e) {
        const n = (n,r)=>WT(t[n], WT(e[n], r));
        return n.isVertical = n=>"vertical" === WT(t.direction, e.direction || (n ? e.symbolDirection : e.gradientDirection)),
        n.gradientLength = ()=>WT(t.gradientLength, e.gradientLength || e.gradientWidth),
        n.gradientThickness = ()=>WT(t.gradientThickness, e.gradientThickness || e.gradientHeight),
        n.entryColumns = ()=>WT(t.columns, WT(e.columns, +n.isVertical(!0))),
        n
    }
    function _N(t, e) {
    ...
    function wN(t, e) {
        return e ? t ? _(t) ? Object.assign({}, t, {
            offset: wN(t.offset, e)
        }) : {
            value: t,
            offset: e
        } : e : t
    ...
    function kN(t, e) {
        return e ? (t.name = e.name,
        t.style = e.style || t.style,
        t.interactive = !!e.interactive,
        t.encode = fT(t.encode, e, cN)) : t.interactive = !1,
        t
    }
    function MN(t, e, n, r) {
        const i = vN(t, n)
    ...
    function CN(t, e, n, r) {
        ...
        s[f] = l[f] = a,
        a.offset = WT(t.labelOffset, e.gradientLabelOffset) || 0,
        h = h ? {
    ...
    function FN(t, e, n, r, i) {
        const o = vN(t, e)
          ...
          , h = "(".concat(i, ") ? datum.").concat("offset", " : datum.").concat(sN)
          , d = l ? sT(l) : {
            field: sN
        }
          , p = "datum.".concat(Zz)
        ...
        let b = null
          , w = null;
        t.fill || (b = e.symbolBaseFillColor,
        ...
        o.isVertical(!0) ? (_ = "ceil(item.mark.items.length / ".concat(g, ")"),
        ...
        v.column.signal = "(".concat(i, ")?").concat(v.column.signal, ":").concat(p),
        yN({
            role: gT,
            from: r = {
                facet: {
    ...
    const SN = 'item.orient === "left"'
      , BN = 'item.orient === "right"'
      , TN = "(".concat(SN, " || ").concat(BN, ")")
      , zN = "datum.vgrad && ".concat(TN)
      , NN = xN('"top"', '"bottom"', '"middle"')
    ...
    function PN(t, e) {
        let n;
        return _(t) && (t.signal ? n = t.signal : t.path ? n = "pathShape(" + jN(t.path) + ")" : t.sphere && (n = "geoShape(" + jN(t.sphere) + ', {type: "Sphere"})')),
        n ? e.signalRef(n) : !!t
    }
    function jN(t) {
    ...
    function HN(t, e) {
        ...
        return t.signal && e.addSignal(t.signal, e.proxy(r)),
    ...
    function VN(t, e, n) {
        ...
        return "index" === r ? function(t, e, n) {
            ...
            const r = e[t.name];
            return t.array ? (v(r) || u("Expected an array of sub-parameters. Instead: " + wt(r)),
            r.map((e=>XN(t, e, n)))) : XN(t, r, n)
    ...
    function GN(t, e, n) {
        const r = t.type;
        if (IT(e))
            return KN(r) ? u("Expression references can not be signals.") : tO(r) ? n.fieldRef(e) : eO(r) ? n.compareRef(e) : n.signalRef(e.signal);
        {
            const i = t.expr || tO(r);
    ...
    function oO(t, e, n) {
        ...
        if (e.ops) {
            ...
            e.fields = [null],
            e.as = ["count"];
        n.op && (e.ops.push((i = n.op.signal) ? t.signalRef(i) : n.op),
    ...
    function aO(t, e, n, r, i, o, a) {
        ...
        !l) {
            const n = o ? {
                field: LT,
                pulse: e.countsRef(t, i, o)
            } : {
                field: t.fieldRef(i),
                pulse: OT(e.output)
            };
            s && (n.sort = t.sortRef(o)),
            c = t.add(zT(r, void 0, n)),
            a && (e.index[i] = c),
            l = OT(c),
            null != f && (u[f] = l)
        }
    ...
    function sO(t, e) {
        ...
        const g = n === dT || p || i
          , m = function(t, e, n) {
            let r, i, o, a, s;
            return t ? (r = t.facet) && (e || u("Only group marks can be faceted."),
            null != r.field ? a = s = nO(r, n) : (t.data ? s = OT(n.getData(t.data).aggregate) : (o = HN(K({
                type: "aggregate",
                groupby: $(r.groupby)
            }, r.aggregate), n),
            o.params.key = n.keyRef(r.groupby),
            o.params.pulse = nO(r, n),
            a = s = OT(n.add(o))),
            i = n.keyRef(r.groupby, !0))) : a = OT(n.add(oz(null, [{}]))),
            a || (a = nO(t, n)),
            {
                key: i,
                pulse: a,
        ...
        s = e.add(uz({
            key: m.key || (t.key ? RT(t.key) : void 0),
            pulse: m.pulse,
            clean: !r
        }));
        const y = OT(s);
        ...
        t.transform && t.transform.forEach((t=>{
            const n = HN(t, e)
              , r = n.metadata;
            (r.generates || r.changes) && u("Mark transforms should not generate new data."),
        ...
        o && (d = function(t, e, n) {
            ...
            if (i) {
                const t = i.tolerance;
                a.boundTolerance = IT(t) ? n.signalRef(t.signal) : +t,
        ...
        null != t.name && (f = t.name,
        e.addData(f, new rO(e,l,b,w)),
        t.on && t.on.forEach((t=>{
            (t.insert || t.remove || t.toggle) && u("Marks only support modify triggers."),
            uO(t, e, f)
        }
        )))
    }
    function lO(t, e) {
        ...
        return g === aN ? (d = [MN(t, p, n, r.gradient), CN(t, n, r.labels, v)],
        h.count = h.count || e.signalRef("max(2,2*floor((".concat(HT(i.gradientLength()), ")/100))"))) : g === uN ? d = [AN(t, p, n, r.gradient, v), CN(t, n, r.labels, v)] : (f = function(t, e) {
            const n = vN(t, e);
            return {
                align: n("gridAlign"),
        ...
        d = [FN(t, n, r, v, HT(f.columns))],
        h.size = function(t, e, n) {
            const r = HT(fO("size", t, n))
              , i = HT(fO("strokeWidth", t, n))
              , o = HT(function(t, e, n) {
    ...
    rO.fromEntries = function(t, e) {
        ...
        let o = e[0]
          , a = null
          , u = 1;
        for (o && "load" === o.type && (o = e[1]),
        t.add(e[0]); u < n; ++u)
            e[u].params.pulse = OT(e[u - 1]),
            t.add(e[u]),
    ...
    rO.prototype = {
        countsRef(t, e, n) {
            const r = this
              ...
              , o = iO(e);
            let a, u, s;
            return null != o && (t = r.scope,
            a = i[o]),
            a ? n && n.field && oO(t, a.agg.params, n) : (s = {
    ...
    function dO(t, e) {
        ...
        t.subtitle && s.push(function(t, e, n, r) {
            const i = {
                value: 0
            }
              , o = t.subtitle
    ...
    function gO(t, e) {
        ...
        e.addDataPipeline(t.name, function(t, e, n) {
            ...
            t.values ? $T(t.values) || $T(t.format) ? (r.push(yO(e, t)),
            r.push(l = mO())) : r.push(l = mO({
                $ingest: t.values,
                $format: t.format
            })) : t.url ? $T(t.url) || $T(t.format) ? (r.push(yO(e, t)),
            r.push(l = mO())) : r.push(l = mO({
                $request: t.url,
                $format: t.format
            })) : t.source && (l = i = $(t.source).map((t=>OT(e.getData(t).output))),
            r.push(null));
            for (o = 0,
            a = n.length; o < a; ++o)
                u = n[o],
                s = u.metadata,
                l || s.source || r.push(l = mO()),
                r.push(u),
                s.generates && (f = !0),
                s.modifies && !f && (c = !0),
    ...
    const vO = t=>t === Xz || t === Yz
      , _O = (t,e,n)=>IT(t) ? AO(t.signal, e, n) : t === Vz || t === Yz ? e : n
      , xO = (t,e,n)=>IT(t) ? kO(t.signal, e, n) : vO(t) ? e : n
      , bO = (t,e,n)=>IT(t) ? MO(t.signal, e, n) : vO(t) ? n : e
      , wO = (t,e,n)=>IT(t) ? EO(t.signal, e, n) : t === Yz ? {
        value: e
    } : {
        value: n
    }
      ...
      , CO = (t,e,n)=>(e = null != e ? sT(e) : e,
    n = null != n ? sT(n) : n,
    FO(e) && FO(n) ? (e = e ? e.signal || wt(e.value) : null,
    n = n ? n.signal || wt(n.value) : null,
    {
      ...
      , SO = (t,e,n)=>({
        signal: "".concat(t, " ? (").concat(TO(e), ") : (").concat(TO(n), ")")
    })
      , BO = (t,e,n,r,i)=>({
        signal: (null != r ? "".concat(t, " === '").concat(Vz, "' ? (").concat(TO(r), ") : ") : "") + (null != n ? "".concat(t, " === '").concat(Xz, "' ? (").concat(TO(n), ") : ") : "") + (null != i ? "".concat(t, " === '").concat(Gz, "' ? (").concat(TO(i), ") : ") : "") + (null != e ? "".concat(t, " === '").concat(Yz, "' ? (").concat(TO(e), ") : ") : "") + "(null)"
    })
      , TO = t=>IT(t) ? t.signal : null == t ? null : wt(t)
      , zO = (t,e)=>{
        const n = t.signal;
    ...
    function qO(t, e, n, r, i, o) {
        const a = vN(t, e)
          ...
          , l = _O(u, -1, 1)
          , c = HT(a("labelFlush"))
          , f = HT(a("labelFlushOffset"))
          , h = a("labelAlign")
          , d = a("labelBaseline");
        let p, g = 0 === c || !!c;
        const m = sT(i);
        m.mult = l,
        m.offset = sT(a("labelPadding") || 0),
        m.offset.mult = l;
        const y = {
            scale: s,
            field: tN,
            band: .5,
            offset: wN(o.offset, a("labelOffset"))
        }
          , v = xO(u, g ? UO(s, c, '"left"', '"right"', '"center"') : {
            value: "center"
        }, ((t,e,n)=>IT(t) ? DO(t.signal, e, n) : t === Gz ? {
            value: e
        } : {
            value: n
        })(u, "left", "right"))
          , _ = xO(u, wO(u, "bottom", "top"), g ? UO(s, c, '"top"', '"bottom"', '"middle"') : {
            value: "middle"
        })
        ...
        p.align !== v && (p.align = zO(p.align, v)),
        p.baseline !== _ && (p.baseline = zO(p.baseline, _)),
        kN({
            type: mN,
            role: "axis-label",
            style: eN,
    ...
    function PO(t, e, n, r) {
        ...
        const l = {
          ...
          , c = {
            signal: 'lerp(range("'.concat(t.scale, '"), ').concat(xN(0, 1, .5), ")")
        };
        return s.x = xO(o, c),
        s.y = bO(o, c),
        u.angle = xO(o, fN, ((t,e)=>0 === e ? 0 : IT(t) ? {
            signal: "(".concat(t.signal, ") * ").concat(e)
        } : {
            value: t * e
        })(a, 90)),
        u.baseline = xO(o, wO(o, Xz, Yz), {
            value: Xz
        }),
        s.angle = u.angle,
        ...
        function(t, e, n, r) {
            const i = (t,e)=>null != t ? (n.update[e] = zO(sT(t), n.update[e]),
            !1) : !hT(e, r)
              , o = i(t("titleX"), "x")
              , a = i(t("titleY"), "y");
            n.enter.auto = a === o ? sT(a) : xO(e, sT(a), sT(o))
        }(i, o, l, n),
        l.update.align = zO(l.update.align, u.align),
        l.update.angle = zO(l.update.angle, u.angle),
        l.update.baseline = zO(l.update.baseline, u.baseline),
        kN({
            type: mN,
            role: "axis-title",
            style: nN,
    ...
    function jO(t, e) {
        const n = function(t, e) {
            var n, r, i, o = e.config, a = o.style, u = o.axis, s = "band" === e.scaleType(t.scale) && o.axisBand, l = t.orient;
            if (IT(l)) {
                const t = OO([o.axisX, o.axisY])
                  , e = OO([o.axisTop, o.axisBottom, o.axisLeft, o.axisRight]);
                for (i of (n = {},
                t))
                    n[i] = xO(l, NO(i, o.axisX, u, a), NO(i, o.axisY, u, a));
                for (i of (r = {},
                e))
                    r[i] = BO(l.signal, NO(i, o.axisTop, u, a), NO(i, o.axisBottom, u, a), NO(i, o.axisLeft, u, a), NO(i, o.axisRight, u, a))
            } else
                n = l === Yz || l === Xz ? o.axisX : o.axisY,
          ...
          , l = function(t) {
            ...
            _(i) || (i = {
                signal: "(".concat(e.signal, ") === 'extent' ? 0 : ").concat(i)
            })) : "extent" === e ? (n = 1,
            r = !0,
            i = 0) : (n = .5,
            r = !1) : (n = t("bandPosition"),
            r = t("tickExtra")),
            {
                extra: r,
                band: n,
          ...
          , d = [];
        let p;
        return c.grid && d.push(LO(t, n, r.grid, h, l)),
        c.ticks && (p = s("tickSize"),
        d.push(function(t, e, n, r, i, o) {
            const a = vN(t, e)
              , u = t.orient
              , s = _O(u, -1, 1);
            let l, c, f;
        ...
        c.labels && (p = c.ticks ? p : 0,
        d.push(qO(t, n, r.labels, h, p, l))),
        c.domain && d.push(function(t, e, n, r) {
            const i = vN(t, e)
              , o = t.orient;
            let a, u;
            const s = {
        ...
        c.title && d.push(PO(t, n, r.title, f)),
        sO(yN({
            role: "axis",
            from: f,
    ...
    function $O(t, e, n) {
        const r = $(t.signals)
          , i = $(t.scales);
        return n || r.forEach((t=>BT(t, e))),
        $(t.projections).forEach((t=>function(t, e) {
            const n = e.config.projection || {}
              , r = {};
            for (const n in t)
                "name" !== n && (r[n] = Hz(t[n], n, e));
            for (const t in n)
                null == r[t] && (r[t] = Hz(n[t], t, e));
            e.addProjection(t.name, r)
        }(t, e))),
        i.forEach((t=>function(t, e) {
            const n = t.type || "linear";
            gd(n) || u("Unrecognized scale type: " + wt(n)),
            e.addScale(t.name, {
                type: n,
                domain: void 0
            })
        }(t, e))),
        $(t.data).forEach((t=>gO(t, e))),
        i.forEach((t=>Tz(t, e))),
        (n || r).forEach((t=>function(t, e) {
            const n = e.getSignal(t.name);
            let r = t.update;
            t.init && (r ? u("Signals can not include both init and update expressions.") : (r = t.init,
            n.initonly = !0)),
            r && (r = HS(r, e),
            n.update = r.$expr,
            n.params = r.$params),
            t.on && t.on.forEach((t=>KT(t, e, n.id)))
        }(t, e))),
        $(t.axes).forEach((t=>jO(t, e))),
        $(t.marks).forEach((t=>sO(t, e))),
        $(t.legends).forEach((t=>lO(t, e))),
        t.title && dO(t.title, e),
        e.parseLambdas(),
        e
    }
    function WO(t, e) {
        const n = e.config
          , r = OT(e.root = e.add(NT()))
          , i = function(t, e) {
            const n = n=>WT(t[n], e[n])
              ...
              , i = r.reduce(((t,e)=>(t[e.name] = e,
            t)), {})
              , o = {};
            return $(t.signals).forEach((t=>{
                rt(i, t.name) ? t = K(i[t.name], t) : r.push(t),
                o[t.name] = t
            }
            )),
            $(e.signals).forEach((t=>{
    ...
    function JO(t) {
        ...
        for (e in t)
            n = t[e],
            r += (++i > 1 ? "," : "") + wt(e) + ":" + (_(n) ? n.signal || GO(n) : wt(n));
        return r + "}"
    }
    YO.prototype = VO.prototype = {
        ...
        addStream(t) {
            return this.streams.push(t),
            t.id = this.id(),
            t
        },
        addUpdate(t) {
            return this.updates.push(t),
            t
        },
        finish() {
            let t, e;
            for (t in this.root && (this.root.root = !0),
            this.signals)
            ...
            for (t in this.data) {
                ...
                n(e.output, t, "output"),
                n(e.values, t, "values");
                for (const r in e.index)
                    n(e.index[r], t, "index:" + r)
            }
            return this
        },
        pushState(t, e, n) {
            this._encode.push(OT(this.add(Ez({
                pulse: t
            })))),
            this._parent.push(e),
            this._lookup.push(n ? OT(this.proxy(n)) : null),
        ...
        fieldRef(t, e) {
            ...
            if (!r) {
                ...
                e && (t.as = e),
                this.field[n] = r = OT(this.add(fz(t)))
            }
            return r
        },
        compareRef(t) {
            let e = !1;
            const n = t=>IT(t) ? (e = !0,
            this.signalRef(t.signal)) : function(t) {
                return t && t.expr
            }(t) ? (e = !0,
            this.exprRef(t.expr)) : t
              , r = $(t.field).map(n)
              , i = $(t.order).map(n);
            return e ? OT(this.add(az({
                fields: r,
                orders: i
            }))) : UT(r, i)
        },
        ...
        sortRef(t) {
            if (!t)
                return t;
            const e = qT(t.op, t.field)
              , n = t.order || "ascending";
            return n.signal ? OT(this.add(az({
                fields: e,
        ...
        getSignal(t) {
            return this.signals[t] || u("Unrecognized signal name: " + wt(t)),
            this.signals[t]
        },
        signalRef(t) {
            return this.signals[t] ? OT(this.signals[t]) : (rt(this.lambdas, t) || (this.lambdas[t] = this.add(NT(null))),
            OT(this.lambdas[t]))
        },
        parseLambdas() {
        ...
        getScale(t) {
            return this.scales[t] || u("Unrecognized scale name: " + wt(t)),
            this.scales[t]
        },
        scaleRef(t) {
        ...
        addData(t, e) {
            return rt(this.data, t) && u("Duplicate data set name: " + wt(t)),
            this.data[t] = e
        },
        getData(t) {
            return this.data[t] || u("Undefined data set name: " + wt(t)),
            this.data[t]
        },
        addDataPipeline(t, e) {
            return rt(this.data, t) && u("Duplicate data set name: " + wt(t)),
            this.addData(t, rO.fromEntries(this, e))
        }
    },
    K(ga, Ns, P_, yx, iA, rE, UD, yD, $D, gC, FC, UC),
    t.Bounds = Zp,
    t.CanvasHandler = Ey,
    t.CanvasRenderer = By,
    t.DATE = On,
    ...
    t.compare = Y,
    t.constant = Z,
    t.cumulativeLogNormal = Ra,
    t.cumulativeNormal = Sa,
    t.cumulativeUniform = Ia,
    t.dayofyear = Xn,
    t.debounce = Q,
    t.defaultLocale = Do,
    t.definition = ma,
    t.densityLogNormal = Oa,
    t.densityNormal = Fa,
    t.densityUniform = ja,
    t.domChild = iy,
    t.domClear = oy,
    ...
    t.inrange = st,
    t.interpolate = Cd,
    t.interpolateColors = Ad,
    t.interpolateRange = Md,
    t.intersect = wv,
    t.intersectBoxLine = Tg,
    t.intersectPath = Cg,
    t.intersectPoint = Fg,
    t.intersectRule = Bg,
    t.isArray = v,
    ...
    t.parse = function(t, e, n) {
        return _(t) || u("Input Vega specification must be an object."),
        WO(t, new YO(e = b(function() {
            const t = "sans-serif"
              , e = "#4c78a8"
              , n = "#000"
              , r = "#888"
    ...
    t.point = uy,
    t.projection = EM,
    t.quantileLogNormal = La,
    t.quantileNormal = Ba,
    t.quantileUniform = $a,
    t.quantiles = _a,
    t.quantizeInterpolator = Ed,
    t.quarter = j,
    t.quartiles = xa,
    ...
    ,
    t.randomLogNormal = Ua,
    t.randomMixture = qa,
    t.randomNormal = Ta,
    t.randomUniform = Wa,
    t.read = Co,
    t.regressionExp = Za,
    t.regressionLinear = Xa,
    t.regressionLoess = nu,
    t.regressionLog = Ja,
    t.regressionPoly = tu,
    t.regressionPow = Qa,
    t.regressionQuad = Ka,
    ...
    t.timeBin = qr,
    t.timeFloor = fr,
    t.timeFormatLocale = Mo,
    t.timeInterval = yr,
    t.timeOffset = xr,
    t.timeSequence = kr,
    t.timeUnitSpecifier = Yn,
    t.timeUnits = Wn,
    t.toBoolean = kt,
    t.toDate = At,
    t.toNumber = A,
