...
class FillPermissionsForLbLevel extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForLbLevel constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.lb-level.create',
            'admin.lb-level.show',
            'admin.lb-level.edit',
            'admin.lb-level.delete',
            'admin.lb-level.bulk-delete',
        ]);
