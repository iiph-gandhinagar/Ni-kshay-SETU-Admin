...
class FillPermissionsForUserFeedbackDetail extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForUserFeedbackDetail constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.user-feedback-detail',
            'admin.user-feedback-detail.index',
            'admin.user-feedback-detail.create',
            'admin.user-feedback-detail.show',
            'admin.user-feedback-detail.edit',
            'admin.user-feedback-detail.delete',
            'admin.user-feedback-detail.bulk-delete',
        ]);
