...
class FillPermissionsForLbSubscriberRankingHistory extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForLbSubscriberRankingHistory constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.lb-subscriber-ranking-history',
            'admin.lb-subscriber-ranking-history.index',
            'admin.lb-subscriber-ranking-history.create',
            'admin.lb-subscriber-ranking-history.show',
            'admin.lb-subscriber-ranking-history.edit',
            'admin.lb-subscriber-ranking-history.delete',
            'admin.lb-subscriber-ranking-history.bulk-delete',
        ]);
