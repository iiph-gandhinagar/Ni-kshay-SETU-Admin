...
class FillPermissionsForUserAppVersion extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForUserAppVersion constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.user-app-version',
            'admin.user-app-version.index',
            'admin.user-app-version.create',
            'admin.user-app-version.show',
            'admin.user-app-version.edit',
            'admin.user-app-version.delete',
            'admin.user-app-version.bulk-delete',
        ]);
