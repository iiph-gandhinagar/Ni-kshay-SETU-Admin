...
class FillPermissionsForSurveyMaster extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForSurveyMaster constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.survey-master.create',
            'admin.survey-master.show',
            'admin.survey-master.edit',
            'admin.survey-master.delete',
            'admin.survey-master.bulk-delete',
        ]);
