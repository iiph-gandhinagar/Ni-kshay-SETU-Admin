...
class FillPermissionsForChatbotActivity extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForChatbotActivity constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.chatbot-activity',
            'admin.chatbot-activity.index',
            'admin.chatbot-activity.create',
            'admin.chatbot-activity.show',
            'admin.chatbot-activity.edit',
            'admin.chatbot-activity.delete',
            'admin.chatbot-activity.bulk-delete',
        ]);
