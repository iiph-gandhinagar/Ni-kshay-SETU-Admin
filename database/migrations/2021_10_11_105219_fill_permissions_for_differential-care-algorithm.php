...
class FillPermissionsForDifferentialCareAlgorithm extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForDifferentialCareAlgorithm constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.differential-care-algorithm',
            'admin.differential-care-algorithm.index',
            'admin.differential-care-algorithm.create',
            'admin.differential-care-algorithm.show',
            'admin.differential-care-algorithm.edit',
            'admin.differential-care-algorithm.delete',
            'admin.differential-care-algorithm.bulk-delete',
        ]);
