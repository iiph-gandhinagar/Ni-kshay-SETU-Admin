...
class UpdateGuidanceOnAdverseDrugReaction extends TranslatableFormRequest
{
    /**
    ...
    {
        return Gate::allows('admin.guidance-on-adverse-drug-reaction.edit', $this->guidanceOnAdverseDrugReaction);
    }
