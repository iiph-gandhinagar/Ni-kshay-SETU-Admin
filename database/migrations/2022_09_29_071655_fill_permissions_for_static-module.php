...
class FillPermissionsForStaticModule extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForStaticModule constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.static-module.create',
            'admin.static-module.show',
            'admin.static-module.edit',
            'admin.static-module.delete',
            'admin.static-module.bulk-delete',
        ]);
