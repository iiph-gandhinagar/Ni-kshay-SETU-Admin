...
class FillPermissionsForLatentTbInfection extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForLatentTbInfection constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.latent-tb-infection',
            'admin.latent-tb-infection.index',
            'admin.latent-tb-infection.create',
            'admin.latent-tb-infection.show',
            'admin.latent-tb-infection.edit',
            'admin.latent-tb-infection.delete',
            'admin.latent-tb-infection.bulk-delete',
        ]);
