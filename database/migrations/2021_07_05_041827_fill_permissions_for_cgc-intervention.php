...
class FillPermissionsForCgcIntervention extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCgcIntervention constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.cgc-intervention',
            'admin.cgc-intervention.index',
            'admin.cgc-intervention.create',
            'admin.cgc-intervention.show',
            'admin.cgc-intervention.edit',
            'admin.cgc-intervention.delete',
            'admin.cgc-intervention.bulk-delete',
        ]);
