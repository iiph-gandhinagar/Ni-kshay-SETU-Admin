...
class FillPermissionsForUserAssessment extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForUserAssessment constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.user-assessment.create',
            'admin.user-assessment.show',
            'admin.user-assessment.edit',
            'admin.user-assessment.delete',
            'admin.user-assessment.bulk-delete',
        ]);
