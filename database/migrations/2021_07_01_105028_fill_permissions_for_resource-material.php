...
class FillPermissionsForResourceMaterial extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForResourceMaterial constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.resource-material',
            'admin.resource-material.index',
            'admin.resource-material.create',
            'admin.resource-material.show',
            'admin.resource-material.edit',
            'admin.resource-material.delete',
            'admin.resource-material.bulk-delete',
        ]);
