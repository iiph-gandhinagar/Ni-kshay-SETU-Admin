...
class FillPermissionsForStaticEnquiry extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForStaticEnquiry constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.static-enquiry',
            'admin.static-enquiry.index',
            'admin.static-enquiry.create',
            'admin.static-enquiry.show',
            'admin.static-enquiry.edit',
            'admin.static-enquiry.delete',
            'admin.static-enquiry.bulk-delete',
        ]);
