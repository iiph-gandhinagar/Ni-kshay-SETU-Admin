...
class FillPermissionsForTSubModuleMaster extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTSubModuleMaster constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.t-sub-module-master',
            'admin.t-sub-module-master.index',
            'admin.t-sub-module-master.create',
            'admin.t-sub-module-master.show',
            'admin.t-sub-module-master.edit',
            'admin.t-sub-module-master.delete',
            'admin.t-sub-module-master.bulk-delete',
        ]);
