...
class FillPermissionsForSurveyMasterHistory extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForSurveyMasterHistory constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.survey-master-history',
            'admin.survey-master-history.index',
            'admin.survey-master-history.create',
            'admin.survey-master-history.show',
            'admin.survey-master-history.edit',
            'admin.survey-master-history.delete',
            'admin.survey-master-history.bulk-delete',
        ]);
